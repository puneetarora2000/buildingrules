...
/**
 * This is a default implementation of the entity IfcInterceptor<br><br>
 *<br><br>
 ...
 */
public class IfcInterceptor extends IfcFlowTreatmentDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcInterceptorTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcInterceptor object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcInterceptorTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcInterceptor object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcInterceptorTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcInterceptorTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcInterceptorTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcInterceptor.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCINTERCEPTOR(");
	...
	**/
	public Object clone()
	{
		IfcInterceptor ifcInterceptor = new IfcInterceptor();
		if(this.GlobalId != null)
			ifcInterceptor.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcInterceptor.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcInterceptor.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcInterceptor.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcInterceptor.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcInterceptor.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcInterceptor.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcInterceptor.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcInterceptor.setPredefinedType((IfcInterceptorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcInterceptor ifcInterceptor = new IfcInterceptor();
		if(this.GlobalId != null)
			ifcInterceptor.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcInterceptor.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcInterceptor.setName(this.Name);
		if(this.Description != null)
			ifcInterceptor.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcInterceptor.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcInterceptor.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcInterceptor.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcInterceptor.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcInterceptor.setPredefinedType(this.PredefinedType);
		return ifcInterceptor;
	}
