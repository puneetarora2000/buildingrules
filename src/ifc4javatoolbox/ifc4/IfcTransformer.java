...
/**
 * This is a default implementation of the entity IfcTransformer<br><br>
 *<br><br>
 ...
 */
public class IfcTransformer extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcTransformerTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcTransformer object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcTransformerTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcTransformer object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcTransformerTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcTransformerTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcTransformerTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcTransformer.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCTRANSFORMER(");
	...
	**/
	public Object clone()
	{
		IfcTransformer ifcTransformer = new IfcTransformer();
		if(this.GlobalId != null)
			ifcTransformer.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcTransformer.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcTransformer.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcTransformer.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcTransformer.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcTransformer.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcTransformer.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcTransformer.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcTransformer.setPredefinedType((IfcTransformerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcTransformer ifcTransformer = new IfcTransformer();
		if(this.GlobalId != null)
			ifcTransformer.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcTransformer.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcTransformer.setName(this.Name);
		if(this.Description != null)
			ifcTransformer.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcTransformer.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcTransformer.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcTransformer.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcTransformer.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcTransformer.setPredefinedType(this.PredefinedType);
		return ifcTransformer;
	}
