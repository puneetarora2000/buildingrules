...
/**
 * This is a default implementation of the entity IfcGeographicElementType<br><br>
 *<br><br>
 ...
 */
public class IfcGeographicElementType extends IfcElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcGeographicElementTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcGeographicElementType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcGeographicElementTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcGeographicElementType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcGeographicElementTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcGeographicElementType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCGEOGRAPHICELEMENTTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcGeographicElementTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcGeographicElementType ifcGeographicElementType = new IfcGeographicElementType();
		if(this.GlobalId != null)
			ifcGeographicElementType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcGeographicElementType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcGeographicElementType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcGeographicElementType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcGeographicElementType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcGeographicElementType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcGeographicElementType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcGeographicElementType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcGeographicElementType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcGeographicElementType.setPredefinedType((IfcGeographicElementTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcGeographicElementType ifcGeographicElementType = new IfcGeographicElementType();
		if(this.GlobalId != null)
			ifcGeographicElementType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcGeographicElementType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcGeographicElementType.setName(this.Name);
		if(this.Description != null)
			ifcGeographicElementType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcGeographicElementType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcGeographicElementType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcGeographicElementType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcGeographicElementType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcGeographicElementType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcGeographicElementType.setPredefinedType(this.PredefinedType);
		return ifcGeographicElementType;
	}
