...
/**
 * This is a default implementation of the entity IfcAlarm<br><br>
 *<br><br>
 ...
 */
public class IfcAlarm extends IfcDistributionControlElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcAlarmTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcAlarm object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcAlarmTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcAlarm object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcAlarmTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcAlarmTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcAlarmTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcAlarm.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCALARM(");
	...
	**/
	public Object clone()
	{
		IfcAlarm ifcAlarm = new IfcAlarm();
		if(this.GlobalId != null)
			ifcAlarm.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcAlarm.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcAlarm.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcAlarm.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcAlarm.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcAlarm.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcAlarm.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcAlarm.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcAlarm.setPredefinedType((IfcAlarmTypeEnum)this.PredefinedType.clone());
		return ifcAlarm;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcAlarm ifcAlarm = new IfcAlarm();
		if(this.GlobalId != null)
			ifcAlarm.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcAlarm.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcAlarm.setName(this.Name);
		if(this.Description != null)
			ifcAlarm.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcAlarm.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcAlarm.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcAlarm.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcAlarm.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcAlarm.setPredefinedType(this.PredefinedType);
		return ifcAlarm;
	}
