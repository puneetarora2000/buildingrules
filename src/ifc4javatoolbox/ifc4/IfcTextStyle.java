...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcLabel","IfcTextStyleForDefinedFont","IfcTextStyleTextModel","IfcTextFontSelect","BOOLEAN"};
	...
	/** ModelOrDraughting is an OPTIONAL attribute**/
	...
	* @param TextCharacterAppearance OPTIONAL parameter of type IfcTextStyleForDefinedFont
	* @param TextStyle OPTIONAL parameter of type IfcTextStyleTextModel
	* @param TextFontStyle DEMANDED parameter of type IfcTextFontSelect - may not be null.
	* @param ModelOrDraughting OPTIONAL parameter of type BOOLEAN
	**/
	public IfcTextStyle(IfcLabel Name, IfcTextStyleForDefinedFont TextCharacterAppearance, IfcTextStyleTextModel TextStyle, IfcTextFontSelect TextFontStyle, BOOLEAN ModelOrDraughting)
	{
		this.Name = Name;
	...
	* @param ModelOrDraughting OPTIONAL parameter of type BOOLEAN
	**/
	public void setParameters(IfcLabel Name, IfcTextStyleForDefinedFont TextCharacterAppearance, IfcTextStyleTextModel TextStyle, IfcTextFontSelect TextFontStyle, BOOLEAN ModelOrDraughting)
	{
		this.Name = Name;
		this.TextCharacterAppearance = TextCharacterAppearance;
		this.TextStyle = TextStyle;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.TextCharacterAppearance = (IfcTextStyleForDefinedFont) parameters.get(1);
		this.TextStyle = (IfcTextStyleTextModel) parameters.get(2);
		this.TextFontStyle = (IfcTextFontSelect) parameters.get(3);
		this.ModelOrDraughting = (BOOLEAN) parameters.get(4);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.TextCharacterAppearance != null)		stepString = stepString.concat(((RootInterface)this.TextCharacterAppearance).getStepParameter(IfcTextStyleForDefinedFont.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
		if(getRedefinedDerivedAttributeTypes().contains("TextStyle")) stepString = stepString.concat("*,");
		else{
		if(this.TextStyle != null)		stepString = stepString.concat(((RootInterface)this.TextStyle).getStepParameter(IfcTextStyleTextModel.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
		...
		if(getRedefinedDerivedAttributeTypes().contains("ModelOrDraughting")) stepString = stepString.concat("*);");
		else{
		if(this.ModelOrDraughting != null)		stepString = stepString.concat(((RootInterface)this.ModelOrDraughting).getStepParameter(BOOLEAN.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	* @return the value of TextFontStyle
	...
	/**
	* This method sets the ModelOrDraughting attribute to the given value.
	*
	* @param ModelOrDraughting DEMANDED value to set - may not be null
	**/
	...
	/**
	* This method returns the value of the ModelOrDraughting attribute.
	*
	* @return the value of ModelOrDraughting
	/**/
	...
	**/
	public Object clone()
	{
		...
		if(this.TextCharacterAppearance != null)
			ifcTextStyle.setTextCharacterAppearance((IfcTextStyleForDefinedFont)this.TextCharacterAppearance.clone());
		if(this.TextStyle != null)
			ifcTextStyle.setTextStyle((IfcTextStyleTextModel)this.TextStyle.clone());
		if(this.TextFontStyle != null)
			ifcTextStyle.setTextFontStyle((IfcTextFontSelect)this.TextFontStyle.clone());
		if(this.ModelOrDraughting != null)
			ifcTextStyle.setModelOrDraughting((BOOLEAN)this.ModelOrDraughting.clone());
		return ifcTextStyle;
	}
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.ModelOrDraughting != null)
			ifcTextStyle.setModelOrDraughting(this.ModelOrDraughting);
		return ifcTextStyle;
	}
