...
/**
 * This is a default implementation of the entity IfcVoidingFeature<br><br>
 *<br><br>
 ...
 */
public class IfcVoidingFeature extends IfcFeatureElementSubtraction implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcVoidingFeatureTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcVoidingFeature object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcVoidingFeatureTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcVoidingFeature object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcVoidingFeatureTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcVoidingFeatureTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcVoidingFeatureTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcVoidingFeature.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCVOIDINGFEATURE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcVoidingFeatureTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	public Object clone()
	{
		IfcVoidingFeature ifcVoidingFeature = new IfcVoidingFeature();
		if(this.GlobalId != null)
			ifcVoidingFeature.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcVoidingFeature.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcVoidingFeature.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcVoidingFeature.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcVoidingFeature.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcVoidingFeature.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcVoidingFeature.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcVoidingFeature.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcVoidingFeature.setPredefinedType((IfcVoidingFeatureTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcVoidingFeature ifcVoidingFeature = new IfcVoidingFeature();
		if(this.GlobalId != null)
			ifcVoidingFeature.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcVoidingFeature.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcVoidingFeature.setName(this.Name);
		if(this.Description != null)
			ifcVoidingFeature.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcVoidingFeature.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcVoidingFeature.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcVoidingFeature.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcVoidingFeature.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcVoidingFeature.setPredefinedType(this.PredefinedType);
		return ifcVoidingFeature;
	}
