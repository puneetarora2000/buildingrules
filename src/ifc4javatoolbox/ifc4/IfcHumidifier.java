...
/**
 * This is a default implementation of the entity IfcHumidifier<br><br>
 *<br><br>
 ...
 */
public class IfcHumidifier extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcHumidifierTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcHumidifier object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcHumidifierTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcHumidifier object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcHumidifierTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcHumidifierTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcHumidifierTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcHumidifier.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCHUMIDIFIER(");
	...
	**/
	public Object clone()
	{
		IfcHumidifier ifcHumidifier = new IfcHumidifier();
		if(this.GlobalId != null)
			ifcHumidifier.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcHumidifier.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcHumidifier.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcHumidifier.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcHumidifier.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcHumidifier.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcHumidifier.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcHumidifier.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcHumidifier.setPredefinedType((IfcHumidifierTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcHumidifier ifcHumidifier = new IfcHumidifier();
		if(this.GlobalId != null)
			ifcHumidifier.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcHumidifier.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcHumidifier.setName(this.Name);
		if(this.Description != null)
			ifcHumidifier.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcHumidifier.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcHumidifier.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcHumidifier.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcHumidifier.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcHumidifier.setPredefinedType(this.PredefinedType);
		return ifcHumidifier;
	}
