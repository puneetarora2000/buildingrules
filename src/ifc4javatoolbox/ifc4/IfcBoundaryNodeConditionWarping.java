...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcLabel","IfcTranslationalStiffnessSelect","IfcTranslationalStiffnessSelect","IfcTranslationalStiffnessSelect","IfcRotationalStiffnessSelect","IfcRotationalStiffnessSelect","IfcRotationalStiffnessSelect","IfcWarpingStiffnessSelect"};
	...
	* @param WarpingStiffness OPTIONAL parameter of type IfcWarpingStiffnessSelect
	**/
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.WarpingStiffness = (IfcWarpingStiffnessSelect) parameters.get(7);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.WarpingStiffness != null)		stepString = stepString.concat(((RootInterface)this.WarpingStiffness).getStepParameter(IfcWarpingStiffnessSelect.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	public Object clone()
	{
		...
		if(this.TranslationalStiffnessX != null)
			ifcBoundaryNodeConditionWarping.setTranslationalStiffnessX((IfcTranslationalStiffnessSelect)this.TranslationalStiffnessX.clone());
		if(this.TranslationalStiffnessY != null)
			ifcBoundaryNodeConditionWarping.setTranslationalStiffnessY((IfcTranslationalStiffnessSelect)this.TranslationalStiffnessY.clone());
		if(this.TranslationalStiffnessZ != null)
			ifcBoundaryNodeConditionWarping.setTranslationalStiffnessZ((IfcTranslationalStiffnessSelect)this.TranslationalStiffnessZ.clone());
		if(this.RotationalStiffnessX != null)
			ifcBoundaryNodeConditionWarping.setRotationalStiffnessX((IfcRotationalStiffnessSelect)this.RotationalStiffnessX.clone());
		if(this.RotationalStiffnessY != null)
			ifcBoundaryNodeConditionWarping.setRotationalStiffnessY((IfcRotationalStiffnessSelect)this.RotationalStiffnessY.clone());
		if(this.RotationalStiffnessZ != null)
			ifcBoundaryNodeConditionWarping.setRotationalStiffnessZ((IfcRotationalStiffnessSelect)this.RotationalStiffnessZ.clone());
		if(this.WarpingStiffness != null)
			ifcBoundaryNodeConditionWarping.setWarpingStiffness((IfcWarpingStiffnessSelect)this.WarpingStiffness.clone());
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.TranslationalStiffnessX != null)
			ifcBoundaryNodeConditionWarping.setTranslationalStiffnessX(this.TranslationalStiffnessX);
		if(this.TranslationalStiffnessY != null)
			ifcBoundaryNodeConditionWarping.setTranslationalStiffnessY(this.TranslationalStiffnessY);
		if(this.TranslationalStiffnessZ != null)
			ifcBoundaryNodeConditionWarping.setTranslationalStiffnessZ(this.TranslationalStiffnessZ);
		if(this.RotationalStiffnessX != null)
