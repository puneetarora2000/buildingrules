...
/**
 * This is a default implementation of the entity IfcElectricGenerator<br><br>
 *<br><br>
 ...
 */
public class IfcElectricGenerator extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcElectricGeneratorTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcElectricGenerator object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcElectricGeneratorTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcElectricGenerator object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcElectricGeneratorTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcElectricGeneratorTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcElectricGeneratorTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcElectricGenerator.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCELECTRICGENERATOR(");
	...
	**/
	public Object clone()
	{
		IfcElectricGenerator ifcElectricGenerator = new IfcElectricGenerator();
		if(this.GlobalId != null)
			ifcElectricGenerator.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcElectricGenerator.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcElectricGenerator.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcElectricGenerator.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcElectricGenerator.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcElectricGenerator.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcElectricGenerator.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcElectricGenerator.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcElectricGenerator.setPredefinedType((IfcElectricGeneratorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcElectricGenerator ifcElectricGenerator = new IfcElectricGenerator();
		if(this.GlobalId != null)
			ifcElectricGenerator.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcElectricGenerator.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcElectricGenerator.setName(this.Name);
		if(this.Description != null)
			ifcElectricGenerator.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcElectricGenerator.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcElectricGenerator.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcElectricGenerator.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcElectricGenerator.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcElectricGenerator.setPredefinedType(this.PredefinedType);
		return ifcElectricGenerator;
	}
