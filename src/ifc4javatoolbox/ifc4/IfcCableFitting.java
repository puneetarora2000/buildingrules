...
/**
 * This is a default implementation of the entity IfcCableFitting<br><br>
 *<br><br>
 ...
 */
public class IfcCableFitting extends IfcFlowFitting implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcCableFittingTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcCableFitting object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCableFittingTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcCableFitting object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCableFittingTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcCableFittingTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCableFittingTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCableFitting.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCABLEFITTING(");
	...
	**/
	public Object clone()
	{
		IfcCableFitting ifcCableFitting = new IfcCableFitting();
		if(this.GlobalId != null)
			ifcCableFitting.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCableFitting.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCableFitting.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCableFitting.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcCableFitting.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcCableFitting.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcCableFitting.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcCableFitting.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcCableFitting.setPredefinedType((IfcCableFittingTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCableFitting ifcCableFitting = new IfcCableFitting();
		if(this.GlobalId != null)
			ifcCableFitting.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCableFitting.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCableFitting.setName(this.Name);
		if(this.Description != null)
			ifcCableFitting.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcCableFitting.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcCableFitting.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcCableFitting.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcCableFitting.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcCableFitting.setPredefinedType(this.PredefinedType);
		return ifcCableFitting;
	}
