...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","SET<IfcObjectDefinition>","IfcObjectTypeEnum","IfcProductSelect"};
	...
	* @param RelatingProduct DEMANDED parameter of type IfcProductSelect - may not be null.
	**/
	public IfcRelAssignsToProduct(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, SET<IfcObjectDefinition> RelatedObjects, IfcObjectTypeEnum RelatedObjectsType, IfcProductSelect RelatingProduct)
	{
	...
	* @param RelatingProduct DEMANDED parameter of type IfcProductSelect - may not be null.
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, SET<IfcObjectDefinition> RelatedObjects, IfcObjectTypeEnum RelatedObjectsType, IfcProductSelect RelatingProduct)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.RelatingProduct = (IfcProductSelect) parameters.get(6);
		resolveInverses();
	}
	...
	**/
	...
	private void resolveInverses()
	{
		...
		{
				if(RelatingProduct instanceof IfcProduct)
				{
				if(((IfcProduct)RelatingProduct).ReferencedBy_Inverse == null)
				{
					((IfcProduct)RelatingProduct).ReferencedBy_Inverse = new SET<IfcRelAssignsToProduct>();
				}
				((IfcProduct)RelatingProduct).ReferencedBy_Inverse.add(this);
				}
				else if(RelatingProduct instanceof IfcTypeProduct)
				{
				if(((IfcTypeProduct)RelatingProduct).ReferencedBy_Inverse == null)
				{
					((IfcTypeProduct)RelatingProduct).ReferencedBy_Inverse = new SET<IfcRelAssignsToProduct>();
				}
				((IfcTypeProduct)RelatingProduct).ReferencedBy_Inverse.add(this);
				}
		}
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.RelatingProduct != null)		stepString = stepString.concat(((RootInterface)this.RelatingProduct).getStepParameter(IfcProductSelect.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	* @return the value of RelatingProduct
	...
	private void synchronizeInversesAddRelatingProduct(IfcProductSelect RelatingProduct)
	{
		if(RelatingProduct != null)
		{
				if(RelatingProduct instanceof IfcProduct)
	...
	private void synchronizeInversesRemoveRelatingProduct(IfcProductSelect RelatingProduct)
	{
		if(RelatingProduct != null)
		{
				if(RelatingProduct instanceof IfcProduct)
				...
				if(((IfcProduct)RelatingProduct).ReferencedBy_Inverse != null)
				{
				((IfcProduct)RelatingProduct).ReferencedBy_Inverse.remove(this);
				}
				}
				else if(RelatingProduct instanceof IfcTypeProduct)
				{
				if(((IfcTypeProduct)RelatingProduct).ReferencedBy_Inverse != null)
				{
				((IfcTypeProduct)RelatingProduct).ReferencedBy_Inverse.remove(this);
				}
				}
		}
	}
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.RelatingProduct != null)
			ifcRelAssignsToProduct.setRelatingProduct((IfcProductSelect)this.RelatingProduct.clone());
