...
/**
 * This is a default implementation of the entity IfcController<br><br>
 *<br><br>
 ...
 */
public class IfcController extends IfcDistributionControlElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcControllerTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcController object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcControllerTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcController object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcControllerTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcControllerTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcControllerTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcController.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCONTROLLER(");
	...
	**/
	public Object clone()
	{
		IfcController ifcController = new IfcController();
		if(this.GlobalId != null)
			ifcController.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcController.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcController.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcController.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcController.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcController.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcController.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcController.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcController.setPredefinedType((IfcControllerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcController ifcController = new IfcController();
		if(this.GlobalId != null)
			ifcController.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcController.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcController.setName(this.Name);
		if(this.Description != null)
			ifcController.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcController.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcController.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcController.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcController.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcController.setPredefinedType(this.PredefinedType);
		return ifcController;
	}
