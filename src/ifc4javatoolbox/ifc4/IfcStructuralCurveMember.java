...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcStructuralCurveMemberTypeEnum","IfcDirection"};
	...
	* @param PredefinedType DEMANDED parameter of type IfcStructuralCurveMemberTypeEnum - may not be null.
	* @param Axis DEMANDED parameter of type IfcDirection - may not be null.
	**/
	...
	* @param Axis DEMANDED parameter of type IfcDirection - may not be null.
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcStructuralCurveMemberTypeEnum PredefinedType, IfcDirection Axis)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcStructuralCurveMemberTypeEnum) parameters.get(7);
		this.Axis = (IfcDirection) parameters.get(8);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcStructuralCurveMemberTypeEnum.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
	...
	**/
	public Object clone()
	{
		...
		if(this.PredefinedType != null)
			ifcStructuralCurveMember.setPredefinedType((IfcStructuralCurveMemberTypeEnum)this.PredefinedType.clone());
		if(this.Axis != null)
			ifcStructuralCurveMember.setAxis((IfcDirection)this.Axis.clone());
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.Axis != null)
			ifcStructuralCurveMember.setAxis(this.Axis);
		return ifcStructuralCurveMember;
	}
