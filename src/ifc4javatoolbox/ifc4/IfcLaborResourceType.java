...
/**
 * This is a default implementation of the entity IfcLaborResourceType<br><br>
 *<br><br>
 ...
 */
public class IfcLaborResourceType extends IfcConstructionResourceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","IfcIdentifier","IfcText","IfcLabel","LIST<IfcAppliedValue>","IfcPhysicalQuantity","IfcLaborResourceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcLaborResourceType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcLaborResourceTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcLaborResourceType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcLaborResourceTypeEnum) parameters.get(11);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcLaborResourceType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCLABORRESOURCETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcLaborResourceTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcLaborResourceType ifcLaborResourceType = new IfcLaborResourceType();
		if(this.GlobalId != null)
			ifcLaborResourceType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcLaborResourceType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcLaborResourceType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcLaborResourceType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcLaborResourceType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcLaborResourceType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.Identification != null)
			ifcLaborResourceType.setIdentification((IfcIdentifier)this.Identification.clone());
		if(this.LongDescription != null)
			ifcLaborResourceType.setLongDescription((IfcText)this.LongDescription.clone());
		if(this.ResourceType != null)
			ifcLaborResourceType.setResourceType((IfcLabel)this.ResourceType.clone());
		if(this.BaseCosts != null)
			ifcLaborResourceType.setBaseCosts((LIST<IfcAppliedValue>)this.BaseCosts.clone());
		if(this.BaseQuantity != null)
			ifcLaborResourceType.setBaseQuantity((IfcPhysicalQuantity)this.BaseQuantity.clone());
		if(this.PredefinedType != null)
			ifcLaborResourceType.setPredefinedType((IfcLaborResourceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcLaborResourceType ifcLaborResourceType = new IfcLaborResourceType();
		if(this.GlobalId != null)
			ifcLaborResourceType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcLaborResourceType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcLaborResourceType.setName(this.Name);
		if(this.Description != null)
			ifcLaborResourceType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcLaborResourceType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcLaborResourceType.setHasPropertySets(this.HasPropertySets);
		if(this.Identification != null)
			ifcLaborResourceType.setIdentification(this.Identification);
		if(this.LongDescription != null)
			ifcLaborResourceType.setLongDescription(this.LongDescription);
		if(this.ResourceType != null)
			ifcLaborResourceType.setResourceType(this.ResourceType);
		if(this.BaseCosts != null)
			ifcLaborResourceType.setBaseCosts(this.BaseCosts);
		if(this.BaseQuantity != null)
			ifcLaborResourceType.setBaseQuantity(this.BaseQuantity);
		if(this.PredefinedType != null)
			ifcLaborResourceType.setPredefinedType(this.PredefinedType);
		return ifcLaborResourceType;
	}
