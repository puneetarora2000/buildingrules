...
/**
 * This is a default implementation of the entity IfcCooledBeam<br><br>
 *<br><br>
 ...
 */
public class IfcCooledBeam extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcCooledBeamTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcCooledBeam object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCooledBeamTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcCooledBeam object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCooledBeamTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcCooledBeamTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCooledBeamTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCooledBeam.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCOOLEDBEAM(");
	...
	**/
	public Object clone()
	{
		IfcCooledBeam ifcCooledBeam = new IfcCooledBeam();
		if(this.GlobalId != null)
			ifcCooledBeam.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCooledBeam.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCooledBeam.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCooledBeam.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcCooledBeam.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcCooledBeam.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcCooledBeam.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcCooledBeam.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcCooledBeam.setPredefinedType((IfcCooledBeamTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCooledBeam ifcCooledBeam = new IfcCooledBeam();
		if(this.GlobalId != null)
			ifcCooledBeam.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCooledBeam.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCooledBeam.setName(this.Name);
		if(this.Description != null)
			ifcCooledBeam.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcCooledBeam.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcCooledBeam.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcCooledBeam.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcCooledBeam.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcCooledBeam.setPredefinedType(this.PredefinedType);
		return ifcCooledBeam;
	}
