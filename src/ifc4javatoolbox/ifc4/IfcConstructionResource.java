...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcIdentifier","IfcText","IfcResourceTime","LIST<IfcAppliedValue>","IfcPhysicalQuantity"};
	...
	* @param BaseQuantity OPTIONAL parameter of type IfcPhysicalQuantity
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcIdentifier Identification, IfcText LongDescription, IfcResourceTime Usage, LIST<IfcAppliedValue> BaseCosts, IfcPhysicalQuantity BaseQuantity)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
