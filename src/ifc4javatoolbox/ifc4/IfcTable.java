...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcLabel","LIST<IfcTableRow>","LIST<IfcTableColumn>"};
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** Name is an OPTIONAL attribute**/
	protected IfcLabel Name;
	/** Rows is an OPTIONAL attribute**/
	protected LIST<IfcTableRow> Rows;
	/** Columns is an OPTIONAL attribute**/
	...
	* @param Rows OPTIONAL parameter of type LIST<IfcTableRow>
	* @param Columns OPTIONAL parameter of type LIST<IfcTableColumn>
	**/
	...
	* @param Columns OPTIONAL parameter of type LIST<IfcTableColumn>
	**/
	public void setParameters(IfcLabel Name, LIST<IfcTableRow> Rows, LIST<IfcTableColumn> Columns)
	{
		this.Name = Name;
		this.Rows = Rows;
		this.Columns = Columns;
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.Columns = (LIST<IfcTableColumn>) parameters.get(2);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	*
	* @param Rows DEMANDED value to set - may not be null
	**/
	...
	**/
	...
	/**
	* This method sets the Columns attribute to the given value.
	*
	* @param Columns DEMANDED value to set - may not be null
	**/
	...
	/**
	* This method returns a copy of the list of the Columns attribute.
	*
	* @return a copy of the Columns list
	**/
	public LIST<IfcTableColumn> getColumns()
	{
		if(this.Columns != null)
			return new LIST<IfcTableColumn>(this.Columns);
		return null;
	}

	/**
	* This method adds an IfcTableColumn object to the Columns list.
	* @param Columns element to be appended to this list.
	**/
	...
	/**
	* This method adds a collection of IfcTableColumn objects to the Columns list.
	* @param Columns collection containing elements to be added to this list.
	**/
	public void addAllColumns(java.util.Collection<IfcTableColumn> Columns)
	{
		if(this.Columns == null)
			this.Columns = new LIST<IfcTableColumn>();
	...
	/**
	* This method removes all elements from the Columns list.
	**/
	...
	/**
	* This method removes an IfcTableColumn object from the Columns list.
	* @param Columns element to be removed from this list.
	**/
	public void removeColumns(IfcTableColumn Columns)
	{
		if(this.Columns != null)
		{
			this.Columns.remove(Columns);
			fireChangeEvent();
		}
	}

	/**
	* This method removes a collection of IfcTableColumn objects from the Columns list.
	* @param Columns collection containing elements to be removed from this list.
	**/
	public void removeAllColumns(java.util.Collection<IfcTableColumn> Columns)
	{
		if(this.Columns != null)
		{
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.Columns != null)
			ifcTable.setColumns((LIST<IfcTableColumn>)this.Columns.clone());
		return ifcTable;
	}
