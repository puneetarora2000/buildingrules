...
/**
 * This is a default implementation of the entity IfcEngine<br><br>
 *<br><br>
 ...
 */
public class IfcEngine extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcEngineTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcEngine object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcEngineTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcEngine object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcEngineTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcEngineTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcEngineTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcEngine.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCENGINE(");
	...
	**/
	public Object clone()
	{
		...
		if(this.GlobalId != null)
			ifcEngine.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcEngine.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcEngine.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcEngine.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcEngine.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcEngine.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcEngine.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcEngine.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcEngine.setPredefinedType((IfcEngineTypeEnum)this.PredefinedType.clone());
		return ifcEngine;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcEngine ifcEngine = new IfcEngine();
		if(this.GlobalId != null)
			ifcEngine.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcEngine.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcEngine.setName(this.Name);
		if(this.Description != null)
			ifcEngine.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcEngine.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcEngine.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcEngine.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcEngine.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcEngine.setPredefinedType(this.PredefinedType);
		return ifcEngine;
	}
