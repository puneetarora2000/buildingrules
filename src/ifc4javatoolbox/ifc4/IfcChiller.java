...
/**
 * This is a default implementation of the entity IfcChiller<br><br>
 *<br><br>
 ...
 */
public class IfcChiller extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcChillerTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcChiller object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcChillerTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcChiller object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcChillerTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcChillerTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcChillerTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcChiller.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCHILLER(");
	...
	**/
	public Object clone()
	{
		IfcChiller ifcChiller = new IfcChiller();
		if(this.GlobalId != null)
			ifcChiller.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcChiller.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcChiller.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcChiller.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcChiller.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcChiller.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcChiller.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcChiller.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcChiller.setPredefinedType((IfcChillerTypeEnum)this.PredefinedType.clone());
		return ifcChiller;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcChiller ifcChiller = new IfcChiller();
		if(this.GlobalId != null)
			ifcChiller.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcChiller.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcChiller.setName(this.Name);
		if(this.Description != null)
			ifcChiller.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcChiller.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcChiller.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcChiller.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcChiller.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcChiller.setPredefinedType(this.PredefinedType);
		return ifcChiller;
	}
