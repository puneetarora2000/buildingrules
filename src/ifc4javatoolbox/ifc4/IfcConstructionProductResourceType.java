...
/**
 * This is a default implementation of the entity IfcConstructionProductResourceType<br><br>
 *<br><br>
 ...
 */
public class IfcConstructionProductResourceType extends IfcConstructionResourceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","IfcIdentifier","IfcText","IfcLabel","LIST<IfcAppliedValue>","IfcPhysicalQuantity","IfcConstructionProductResourceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcConstructionProductResourceType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcConstructionProductResourceTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcConstructionProductResourceType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcConstructionProductResourceTypeEnum) parameters.get(11);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcConstructionProductResourceType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCONSTRUCTIONPRODUCTRESOURCETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcConstructionProductResourceTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcConstructionProductResourceType ifcConstructionProductResourceType = new IfcConstructionProductResourceType();
		if(this.GlobalId != null)
			ifcConstructionProductResourceType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcConstructionProductResourceType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcConstructionProductResourceType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcConstructionProductResourceType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcConstructionProductResourceType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcConstructionProductResourceType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.Identification != null)
			ifcConstructionProductResourceType.setIdentification((IfcIdentifier)this.Identification.clone());
		if(this.LongDescription != null)
			ifcConstructionProductResourceType.setLongDescription((IfcText)this.LongDescription.clone());
		if(this.ResourceType != null)
			ifcConstructionProductResourceType.setResourceType((IfcLabel)this.ResourceType.clone());
		if(this.BaseCosts != null)
			ifcConstructionProductResourceType.setBaseCosts((LIST<IfcAppliedValue>)this.BaseCosts.clone());
		if(this.BaseQuantity != null)
			ifcConstructionProductResourceType.setBaseQuantity((IfcPhysicalQuantity)this.BaseQuantity.clone());
		if(this.PredefinedType != null)
			ifcConstructionProductResourceType.setPredefinedType((IfcConstructionProductResourceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcConstructionProductResourceType ifcConstructionProductResourceType = new IfcConstructionProductResourceType();
		if(this.GlobalId != null)
			ifcConstructionProductResourceType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcConstructionProductResourceType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcConstructionProductResourceType.setName(this.Name);
		if(this.Description != null)
			ifcConstructionProductResourceType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcConstructionProductResourceType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcConstructionProductResourceType.setHasPropertySets(this.HasPropertySets);
		if(this.Identification != null)
			ifcConstructionProductResourceType.setIdentification(this.Identification);
		if(this.LongDescription != null)
			ifcConstructionProductResourceType.setLongDescription(this.LongDescription);
		if(this.ResourceType != null)
			ifcConstructionProductResourceType.setResourceType(this.ResourceType);
		if(this.BaseCosts != null)
			ifcConstructionProductResourceType.setBaseCosts(this.BaseCosts);
		if(this.BaseQuantity != null)
			ifcConstructionProductResourceType.setBaseQuantity(this.BaseQuantity);
		if(this.PredefinedType != null)
			ifcConstructionProductResourceType.setPredefinedType(this.PredefinedType);
		return ifcConstructionProductResourceType;
	}
