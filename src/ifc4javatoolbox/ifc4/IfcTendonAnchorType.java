...
/**
 * This is a default implementation of the entity IfcTendonAnchorType<br><br>
 *<br><br>
 ...
 */
public class IfcTendonAnchorType extends IfcReinforcingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcTendonAnchorTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcTendonAnchorType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcTendonAnchorTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcTendonAnchorType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcTendonAnchorTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcTendonAnchorType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCTENDONANCHORTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcTendonAnchorTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcTendonAnchorType ifcTendonAnchorType = new IfcTendonAnchorType();
		if(this.GlobalId != null)
			ifcTendonAnchorType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcTendonAnchorType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcTendonAnchorType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcTendonAnchorType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcTendonAnchorType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcTendonAnchorType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcTendonAnchorType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcTendonAnchorType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcTendonAnchorType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcTendonAnchorType.setPredefinedType((IfcTendonAnchorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcTendonAnchorType ifcTendonAnchorType = new IfcTendonAnchorType();
		if(this.GlobalId != null)
			ifcTendonAnchorType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcTendonAnchorType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcTendonAnchorType.setName(this.Name);
		if(this.Description != null)
			ifcTendonAnchorType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcTendonAnchorType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcTendonAnchorType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcTendonAnchorType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcTendonAnchorType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcTendonAnchorType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcTendonAnchorType.setPredefinedType(this.PredefinedType);
		return ifcTendonAnchorType;
	}
