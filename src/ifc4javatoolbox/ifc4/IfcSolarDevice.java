...
/**
 * This is a default implementation of the entity IfcSolarDevice<br><br>
 *<br><br>
 ...
 */
public class IfcSolarDevice extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcSolarDeviceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcSolarDevice object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSolarDeviceTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcSolarDevice object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSolarDeviceTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcSolarDeviceTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSolarDeviceTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSolarDevice.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSOLARDEVICE(");
	...
	**/
	public Object clone()
	{
		IfcSolarDevice ifcSolarDevice = new IfcSolarDevice();
		if(this.GlobalId != null)
			ifcSolarDevice.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSolarDevice.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSolarDevice.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSolarDevice.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcSolarDevice.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcSolarDevice.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcSolarDevice.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcSolarDevice.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcSolarDevice.setPredefinedType((IfcSolarDeviceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcSolarDevice ifcSolarDevice = new IfcSolarDevice();
		if(this.GlobalId != null)
			ifcSolarDevice.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSolarDevice.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSolarDevice.setName(this.Name);
		if(this.Description != null)
			ifcSolarDevice.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcSolarDevice.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcSolarDevice.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcSolarDevice.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcSolarDevice.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcSolarDevice.setPredefinedType(this.PredefinedType);
		return ifcSolarDevice;
	}
