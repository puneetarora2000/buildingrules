...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcOutletTypeEnum"};
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.ApplicableOccurrence != null)
			ifcOutletType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
