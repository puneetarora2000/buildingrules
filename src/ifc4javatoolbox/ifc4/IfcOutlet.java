...
/**
 * This is a default implementation of the entity IfcOutlet<br><br>
 *<br><br>
 ...
 */
public class IfcOutlet extends IfcFlowTerminal implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcOutletTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcOutlet object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcOutletTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcOutlet object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcOutletTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcOutletTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcOutletTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcOutlet.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCOUTLET(");
	...
	**/
	public Object clone()
	{
		IfcOutlet ifcOutlet = new IfcOutlet();
		if(this.GlobalId != null)
			ifcOutlet.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcOutlet.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcOutlet.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcOutlet.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcOutlet.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcOutlet.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcOutlet.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcOutlet.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcOutlet.setPredefinedType((IfcOutletTypeEnum)this.PredefinedType.clone());
		return ifcOutlet;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcOutlet ifcOutlet = new IfcOutlet();
		if(this.GlobalId != null)
			ifcOutlet.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcOutlet.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcOutlet.setName(this.Name);
		if(this.Description != null)
			ifcOutlet.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcOutlet.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcOutlet.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcOutlet.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcOutlet.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcOutlet.setPredefinedType(this.PredefinedType);
		return ifcOutlet;
	}
