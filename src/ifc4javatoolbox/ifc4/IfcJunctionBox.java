...
/**
 * This is a default implementation of the entity IfcJunctionBox<br><br>
 *<br><br>
 ...
 */
public class IfcJunctionBox extends IfcFlowFitting implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcJunctionBoxTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcJunctionBox object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcJunctionBoxTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcJunctionBox object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcJunctionBoxTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcJunctionBoxTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcJunctionBoxTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcJunctionBox.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCJUNCTIONBOX(");
	...
	**/
	public Object clone()
	{
		IfcJunctionBox ifcJunctionBox = new IfcJunctionBox();
		if(this.GlobalId != null)
			ifcJunctionBox.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcJunctionBox.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcJunctionBox.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcJunctionBox.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcJunctionBox.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcJunctionBox.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcJunctionBox.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcJunctionBox.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcJunctionBox.setPredefinedType((IfcJunctionBoxTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcJunctionBox ifcJunctionBox = new IfcJunctionBox();
		if(this.GlobalId != null)
			ifcJunctionBox.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcJunctionBox.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcJunctionBox.setName(this.Name);
		if(this.Description != null)
			ifcJunctionBox.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcJunctionBox.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcJunctionBox.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcJunctionBox.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcJunctionBox.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcJunctionBox.setPredefinedType(this.PredefinedType);
		return ifcJunctionBox;
	}
