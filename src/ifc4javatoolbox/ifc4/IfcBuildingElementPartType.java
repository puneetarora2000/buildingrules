...
/**
 * This is a default implementation of the entity IfcBuildingElementPartType<br><br>
 *<br><br>
 ...
 */
public class IfcBuildingElementPartType extends IfcElementComponentType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcBuildingElementPartTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcBuildingElementPartType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcBuildingElementPartTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcBuildingElementPartType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcBuildingElementPartTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcBuildingElementPartType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCBUILDINGELEMENTPARTTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcBuildingElementPartTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcBuildingElementPartType ifcBuildingElementPartType = new IfcBuildingElementPartType();
		if(this.GlobalId != null)
			ifcBuildingElementPartType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcBuildingElementPartType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcBuildingElementPartType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcBuildingElementPartType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcBuildingElementPartType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcBuildingElementPartType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcBuildingElementPartType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcBuildingElementPartType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcBuildingElementPartType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcBuildingElementPartType.setPredefinedType((IfcBuildingElementPartTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcBuildingElementPartType ifcBuildingElementPartType = new IfcBuildingElementPartType();
		if(this.GlobalId != null)
			ifcBuildingElementPartType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcBuildingElementPartType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcBuildingElementPartType.setName(this.Name);
		if(this.Description != null)
			ifcBuildingElementPartType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcBuildingElementPartType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcBuildingElementPartType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcBuildingElementPartType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcBuildingElementPartType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcBuildingElementPartType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcBuildingElementPartType.setPredefinedType(this.PredefinedType);
		return ifcBuildingElementPartType;
	}
