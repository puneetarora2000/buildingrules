...
/**
 * This is a default implementation of the entity IfcStairType<br><br>
 *<br><br>
 ...
 */
public class IfcStairType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcStairTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcStairType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcStairTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcStairType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcStairTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcStairType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSTAIRTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcStairTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcStairType ifcStairType = new IfcStairType();
		if(this.GlobalId != null)
			ifcStairType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcStairType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcStairType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcStairType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcStairType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcStairType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcStairType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcStairType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcStairType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcStairType.setPredefinedType((IfcStairTypeEnum)this.PredefinedType.clone());
		return ifcStairType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcStairType ifcStairType = new IfcStairType();
		if(this.GlobalId != null)
			ifcStairType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcStairType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcStairType.setName(this.Name);
		if(this.Description != null)
			ifcStairType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcStairType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcStairType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcStairType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcStairType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcStairType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcStairType.setPredefinedType(this.PredefinedType);
		return ifcStairType;
	}
