...
/**
 * This is a default implementation of the entity IfcPlateStandardCase<br><br>
 *<br><br>
 ...
 */
public class IfcPlateStandardCase extends IfcPlate implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcPlateTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcPlateStandardCase object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcPlateTypeEnum
	**/
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcPlateTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcPlateStandardCase.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPLATESTANDARDCASE(");
	...
	**/
	public Object clone()
	{
		IfcPlateStandardCase ifcPlateStandardCase = new IfcPlateStandardCase();
		if(this.GlobalId != null)
			ifcPlateStandardCase.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcPlateStandardCase.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcPlateStandardCase.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcPlateStandardCase.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcPlateStandardCase.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcPlateStandardCase.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcPlateStandardCase.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcPlateStandardCase.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcPlateStandardCase.setPredefinedType((IfcPlateTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcPlateStandardCase ifcPlateStandardCase = new IfcPlateStandardCase();
		if(this.GlobalId != null)
			ifcPlateStandardCase.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcPlateStandardCase.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcPlateStandardCase.setName(this.Name);
		if(this.Description != null)
			ifcPlateStandardCase.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcPlateStandardCase.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcPlateStandardCase.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcPlateStandardCase.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcPlateStandardCase.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcPlateStandardCase.setPredefinedType(this.PredefinedType);
		return ifcPlateStandardCase;
	}
