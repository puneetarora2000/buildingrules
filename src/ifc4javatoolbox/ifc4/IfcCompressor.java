...
/**
 * This is a default implementation of the entity IfcCompressor<br><br>
 *<br><br>
 ...
 */
public class IfcCompressor extends IfcFlowMovingDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcCompressorTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcCompressor object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCompressorTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcCompressor object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCompressorTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcCompressorTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCompressorTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCompressor.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCOMPRESSOR(");
	...
	**/
	public Object clone()
	{
		IfcCompressor ifcCompressor = new IfcCompressor();
		if(this.GlobalId != null)
			ifcCompressor.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCompressor.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCompressor.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCompressor.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcCompressor.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcCompressor.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcCompressor.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcCompressor.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcCompressor.setPredefinedType((IfcCompressorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCompressor ifcCompressor = new IfcCompressor();
		if(this.GlobalId != null)
			ifcCompressor.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCompressor.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCompressor.setName(this.Name);
		if(this.Description != null)
			ifcCompressor.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcCompressor.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcCompressor.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcCompressor.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcCompressor.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcCompressor.setPredefinedType(this.PredefinedType);
		return ifcCompressor;
	}
