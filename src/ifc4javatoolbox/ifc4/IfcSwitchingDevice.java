...
/**
 * This is a default implementation of the entity IfcSwitchingDevice<br><br>
 *<br><br>
 ...
 */
public class IfcSwitchingDevice extends IfcFlowController implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcSwitchingDeviceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcSwitchingDevice object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSwitchingDeviceTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcSwitchingDevice object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSwitchingDeviceTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcSwitchingDeviceTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSwitchingDeviceTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSwitchingDevice.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSWITCHINGDEVICE(");
	...
	**/
	public Object clone()
	{
		IfcSwitchingDevice ifcSwitchingDevice = new IfcSwitchingDevice();
		if(this.GlobalId != null)
			ifcSwitchingDevice.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSwitchingDevice.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSwitchingDevice.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSwitchingDevice.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcSwitchingDevice.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcSwitchingDevice.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcSwitchingDevice.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcSwitchingDevice.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcSwitchingDevice.setPredefinedType((IfcSwitchingDeviceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcSwitchingDevice ifcSwitchingDevice = new IfcSwitchingDevice();
		if(this.GlobalId != null)
			ifcSwitchingDevice.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSwitchingDevice.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSwitchingDevice.setName(this.Name);
		if(this.Description != null)
			ifcSwitchingDevice.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcSwitchingDevice.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcSwitchingDevice.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcSwitchingDevice.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcSwitchingDevice.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcSwitchingDevice.setPredefinedType(this.PredefinedType);
		return ifcSwitchingDevice;
	}
