...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcLabel","IfcText","IfcDateTime","IfcDateTime","IfcTimeSeriesDataTypeEnum","IfcDataOriginEnum","IfcLabel","IfcUnit","IfcTimeMeasure","LIST<IfcTimeSeriesValue>"};
	...
	* @param Values DEMANDED parameter of type LIST<IfcTimeSeriesValue> - may not be null.
	**/
	public void setParameters(IfcLabel Name, IfcText Description, IfcDateTime StartTime, IfcDateTime EndTime, IfcTimeSeriesDataTypeEnum TimeSeriesDataType, IfcDataOriginEnum DataOrigin, IfcLabel UserDefinedDataOrigin, IfcUnit Unit, IfcTimeMeasure TimeStep, LIST<IfcTimeSeriesValue> Values)
	{
		this.Name = Name;
		this.Description = Description;
		this.StartTime = StartTime;
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.StartTime != null)
			ifcRegularTimeSeries.setStartTime((IfcDateTime)this.StartTime.clone());
		if(this.EndTime != null)
			ifcRegularTimeSeries.setEndTime((IfcDateTime)this.EndTime.clone());
