...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcIdentifier","IfcText","IfcResourceTime","LIST<IfcAppliedValue>","IfcPhysicalQuantity","IfcLaborResourceTypeEnum"};
	...
	* @param PredefinedType OPTIONAL parameter of type IfcLaborResourceTypeEnum
	**/
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcLaborResourceTypeEnum) parameters.get(10);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.Identification != null)
			ifcLaborResource.setIdentification((IfcIdentifier)this.Identification.clone());
		if(this.LongDescription != null)
			ifcLaborResource.setLongDescription((IfcText)this.LongDescription.clone());
		if(this.Usage != null)
			ifcLaborResource.setUsage((IfcResourceTime)this.Usage.clone());
		if(this.BaseCosts != null)
			ifcLaborResource.setBaseCosts((LIST<IfcAppliedValue>)this.BaseCosts.clone());
		if(this.BaseQuantity != null)
			ifcLaborResource.setBaseQuantity((IfcPhysicalQuantity)this.BaseQuantity.clone());
		if(this.PredefinedType != null)
			ifcLaborResource.setPredefinedType((IfcLaborResourceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.Identification != null)
			ifcLaborResource.setIdentification(this.Identification);
		if(this.LongDescription != null)
			ifcLaborResource.setLongDescription(this.LongDescription);
		if(this.Usage != null)
			ifcLaborResource.setUsage(this.Usage);
		if(this.BaseCosts != null)
			ifcLaborResource.setBaseCosts(this.BaseCosts);
		if(this.BaseQuantity != null)
			ifcLaborResource.setBaseQuantity(this.BaseQuantity);
		if(this.PredefinedType != null)
			ifcLaborResource.setPredefinedType(this.PredefinedType);
		return ifcLaborResource;
	}
