...
/**
 * This is a default implementation of the entity IfcElementAssemblyType<br><br>
 *<br><br>
 ...
 */
public class IfcElementAssemblyType extends IfcElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcElementAssemblyTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcElementAssemblyType object using the given parameters.
	*
	...
	**/
	...
	/**
	 * This method initializes the IfcElementAssemblyType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	{
		return IfcElementAssemblyType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCELEMENTASSEMBLYTYPE(");
	...
	**/
	...
	public Object clone()
	{
		IfcElementAssemblyType ifcElementAssemblyType = new IfcElementAssemblyType();
		if(this.GlobalId != null)
			ifcElementAssemblyType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcElementAssemblyType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcElementAssemblyType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcElementAssemblyType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcElementAssemblyType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcElementAssemblyType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcElementAssemblyType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcElementAssemblyType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcElementAssemblyType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcElementAssemblyType.setPredefinedType((IfcElementAssemblyTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcElementAssemblyType ifcElementAssemblyType = new IfcElementAssemblyType();
		if(this.GlobalId != null)
			ifcElementAssemblyType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcElementAssemblyType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcElementAssemblyType.setName(this.Name);
		if(this.Description != null)
			ifcElementAssemblyType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcElementAssemblyType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcElementAssemblyType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcElementAssemblyType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcElementAssemblyType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcElementAssemblyType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcElementAssemblyType.setPredefinedType(this.PredefinedType);
		return ifcElementAssemblyType;
	}
