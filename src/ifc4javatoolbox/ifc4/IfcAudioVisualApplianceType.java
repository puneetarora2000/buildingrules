...
/**
 * This is a default implementation of the entity IfcAudioVisualApplianceType<br><br>
 *<br><br>
 ...
 */
public class IfcAudioVisualApplianceType extends IfcFlowTerminalType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcAudioVisualApplianceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcAudioVisualApplianceType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcAudioVisualApplianceTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcAudioVisualApplianceType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcAudioVisualApplianceTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcAudioVisualApplianceType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCAUDIOVISUALAPPLIANCETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcAudioVisualApplianceTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcAudioVisualApplianceType ifcAudioVisualApplianceType = new IfcAudioVisualApplianceType();
		if(this.GlobalId != null)
			ifcAudioVisualApplianceType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcAudioVisualApplianceType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcAudioVisualApplianceType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcAudioVisualApplianceType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcAudioVisualApplianceType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcAudioVisualApplianceType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcAudioVisualApplianceType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcAudioVisualApplianceType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcAudioVisualApplianceType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcAudioVisualApplianceType.setPredefinedType((IfcAudioVisualApplianceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcAudioVisualApplianceType ifcAudioVisualApplianceType = new IfcAudioVisualApplianceType();
		if(this.GlobalId != null)
			ifcAudioVisualApplianceType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcAudioVisualApplianceType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcAudioVisualApplianceType.setName(this.Name);
		if(this.Description != null)
			ifcAudioVisualApplianceType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcAudioVisualApplianceType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcAudioVisualApplianceType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcAudioVisualApplianceType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcAudioVisualApplianceType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcAudioVisualApplianceType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcAudioVisualApplianceType.setPredefinedType(this.PredefinedType);
		return ifcAudioVisualApplianceType;
	}
