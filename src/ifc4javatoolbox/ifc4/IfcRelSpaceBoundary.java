...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcSpaceBoundarySelect","IfcElement","IfcConnectionGeometry","IfcPhysicalOrVirtualEnum","IfcInternalOrExternalEnum"};
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	* @return the value of RelatingSpace
	...
	private void synchronizeInversesAddRelatingSpace(IfcSpaceBoundarySelect RelatingSpace)
	{
		if(RelatingSpace != null)
		{
				if(RelatingSpace instanceof IfcExternalSpatialElement)
	...
	private void synchronizeInversesRemoveRelatingSpace(IfcSpaceBoundarySelect RelatingSpace)
	{
		if(RelatingSpace != null)
		{
				if(RelatingSpace instanceof IfcExternalSpatialElement)
				...
				if(((IfcExternalSpatialElement)RelatingSpace).BoundedBy_Inverse != null)
				{
				((IfcExternalSpatialElement)RelatingSpace).BoundedBy_Inverse.remove(this);
				}
				}
				else if(RelatingSpace instanceof IfcSpace)
				{
				if(((IfcSpace)RelatingSpace).BoundedBy_Inverse != null)
				{
				((IfcSpace)RelatingSpace).BoundedBy_Inverse.remove(this);
				}
				}
		}
	}
	...
	**/
	public Object clone()
	{
		...
		if(this.RelatingSpace != null)
			ifcRelSpaceBoundary.setRelatingSpace((IfcSpaceBoundarySelect)this.RelatingSpace.clone());
