...
/**
 * This is a default implementation of the entity IfcMotorConnection<br><br>
 *<br><br>
 ...
 */
public class IfcMotorConnection extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcMotorConnectionTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcMotorConnection object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcMotorConnectionTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcMotorConnection object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcMotorConnectionTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcMotorConnectionTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcMotorConnectionTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcMotorConnection.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCMOTORCONNECTION(");
	...
	**/
	public Object clone()
	{
		IfcMotorConnection ifcMotorConnection = new IfcMotorConnection();
		if(this.GlobalId != null)
			ifcMotorConnection.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcMotorConnection.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcMotorConnection.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcMotorConnection.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcMotorConnection.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcMotorConnection.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcMotorConnection.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcMotorConnection.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcMotorConnection.setPredefinedType((IfcMotorConnectionTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcMotorConnection ifcMotorConnection = new IfcMotorConnection();
		if(this.GlobalId != null)
			ifcMotorConnection.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcMotorConnection.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcMotorConnection.setName(this.Name);
		if(this.Description != null)
			ifcMotorConnection.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcMotorConnection.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcMotorConnection.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcMotorConnection.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcMotorConnection.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcMotorConnection.setPredefinedType(this.PredefinedType);
		return ifcMotorConnection;
	}
