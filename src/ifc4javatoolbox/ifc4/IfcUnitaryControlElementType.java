...
/**
 * This is a default implementation of the entity IfcUnitaryControlElementType<br><br>
 *<br><br>
 ...
 */
public class IfcUnitaryControlElementType extends IfcDistributionControlElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcUnitaryControlElementTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcUnitaryControlElementType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcUnitaryControlElementTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcUnitaryControlElementType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcUnitaryControlElementTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcUnitaryControlElementType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCUNITARYCONTROLELEMENTTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcUnitaryControlElementTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcUnitaryControlElementType ifcUnitaryControlElementType = new IfcUnitaryControlElementType();
		if(this.GlobalId != null)
			ifcUnitaryControlElementType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcUnitaryControlElementType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcUnitaryControlElementType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcUnitaryControlElementType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcUnitaryControlElementType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcUnitaryControlElementType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcUnitaryControlElementType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcUnitaryControlElementType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcUnitaryControlElementType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcUnitaryControlElementType.setPredefinedType((IfcUnitaryControlElementTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcUnitaryControlElementType ifcUnitaryControlElementType = new IfcUnitaryControlElementType();
		if(this.GlobalId != null)
			ifcUnitaryControlElementType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcUnitaryControlElementType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcUnitaryControlElementType.setName(this.Name);
		if(this.Description != null)
			ifcUnitaryControlElementType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcUnitaryControlElementType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcUnitaryControlElementType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcUnitaryControlElementType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcUnitaryControlElementType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcUnitaryControlElementType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcUnitaryControlElementType.setPredefinedType(this.PredefinedType);
		return ifcUnitaryControlElementType;
	}
