...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcLabel","IfcText","SET<IfcLayeredItem>","IfcIdentifier","LOGICAL","LOGICAL","LOGICAL","SET<IfcPresentationStyle>"};
	...
	protected SET<IfcPresentationStyle> LayerStyles;
	/**
	...
	* @param LayerStyles DEMANDED parameter of type SET<IfcPresentationStyle> - may not be null.
	**/
	public IfcPresentationLayerWithStyle(IfcLabel Name, IfcText Description, SET<IfcLayeredItem> AssignedItems, IfcIdentifier Identifier, LOGICAL LayerOn, LOGICAL LayerFrozen, LOGICAL LayerBlocked, SET<IfcPresentationStyle> LayerStyles)
	{
		this.Name = Name;
	...
	* @param LayerStyles DEMANDED parameter of type SET<IfcPresentationStyle> - may not be null.
	**/
	public void setParameters(IfcLabel Name, IfcText Description, SET<IfcLayeredItem> AssignedItems, IfcIdentifier Identifier, LOGICAL LayerOn, LOGICAL LayerFrozen, LOGICAL LayerBlocked, SET<IfcPresentationStyle> LayerStyles)
	{
		this.Name = Name;
		this.Description = Description;
		this.AssignedItems = AssignedItems;
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.LayerStyles = (SET<IfcPresentationStyle>) parameters.get(7);
		resolveInverses();
	}
	...
	private void resolveInverses()
	{
		if(AssignedItems != null)
		{
			for(IfcLayeredItem AssignedItems$ : AssignedItems)
			{
				...
				{
				if(((IfcRepresentationItem)AssignedItems$).LayerAssignment_Inverse == null)
				{
					((IfcRepresentationItem)AssignedItems$).LayerAssignment_Inverse = new SET<IfcPresentationLayerAssignment>();
				}
				((IfcRepresentationItem)AssignedItems$).LayerAssignment_Inverse.add(this);
				}
			}
		}
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.LayerStyles != null)		stepString = stepString.concat(((RootInterface)this.LayerStyles).getStepParameter(IfcPresentationStyle.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	public void setLayerStyles(SET<IfcPresentationStyle> LayerStyles)
	{
		this.LayerStyles = LayerStyles;
		fireChangeEvent();
	}
	...
	**/
	public SET<IfcPresentationStyle> getLayerStyles()
	{
		if(this.LayerStyles != null)
			return new SET<IfcPresentationStyle>(this.LayerStyles);
		return null;
	}

	/**
	* This method adds an IfcPresentationStyle object to the LayerStyles set.
	* @param LayerStyles element to be appended to this set.
	**/
	public void addLayerStyles(IfcPresentationStyle LayerStyles)
	{
		if(this.LayerStyles == null)
			this.LayerStyles = new SET<IfcPresentationStyle>();
		this.LayerStyles.add(LayerStyles);
		fireChangeEvent();
	}

	/**
	* This method adds a collection of IfcPresentationStyle objects to the LayerStyles set.
	* @param LayerStyles collection containing elements to be added to this set.
	**/
	public void addAllLayerStyles(java.util.Collection<IfcPresentationStyle> LayerStyles)
	{
		if(this.LayerStyles == null)
			this.LayerStyles = new SET<IfcPresentationStyle>();
	...
	**/
	...
	/**
	* This method removes an IfcPresentationStyle object from the LayerStyles set.
	* @param LayerStyles element to be removed from this set.
	**/
	public void removeLayerStyles(IfcPresentationStyle LayerStyles)
	{
		if(this.LayerStyles != null)
		{
	...
	/**
	* This method removes a collection of IfcPresentationStyle objects from the LayerStyles set.
	* @param LayerStyles collection containing elements to be removed from this set.
	**/
	public void removeAllLayerStyles(java.util.Collection<IfcPresentationStyle> LayerStyles)
	{
		if(this.LayerStyles != null)
		{
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.LayerStyles != null)
			ifcPresentationLayerWithStyle.setLayerStyles((SET<IfcPresentationStyle>)this.LayerStyles.clone());
