...
/**
 * This is a default implementation of the entity IfcFlowMeter<br><br>
 *<br><br>
 ...
 */
public class IfcFlowMeter extends IfcFlowController implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcFlowMeterTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcFlowMeter object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcFlowMeterTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcFlowMeter object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcFlowMeterTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcFlowMeterTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcFlowMeterTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcFlowMeter.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFLOWMETER(");
	...
	**/
	public Object clone()
	{
		IfcFlowMeter ifcFlowMeter = new IfcFlowMeter();
		if(this.GlobalId != null)
			ifcFlowMeter.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFlowMeter.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFlowMeter.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFlowMeter.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFlowMeter.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFlowMeter.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFlowMeter.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFlowMeter.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcFlowMeter.setPredefinedType((IfcFlowMeterTypeEnum)this.PredefinedType.clone());
		return ifcFlowMeter;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcFlowMeter ifcFlowMeter = new IfcFlowMeter();
		if(this.GlobalId != null)
			ifcFlowMeter.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFlowMeter.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFlowMeter.setName(this.Name);
		if(this.Description != null)
			ifcFlowMeter.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFlowMeter.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFlowMeter.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFlowMeter.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFlowMeter.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcFlowMeter.setPredefinedType(this.PredefinedType);
		return ifcFlowMeter;
	}
