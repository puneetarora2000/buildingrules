...
/**
 * This is a default implementation of the entity IfcValve<br><br>
 *<br><br>
 ...
 */
public class IfcValve extends IfcFlowController implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcValveTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcValve object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcValveTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcValve object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcValveTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcValveTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcValveTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcValve.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCVALVE(");
	...
	**/
	public Object clone()
	{
		IfcValve ifcValve = new IfcValve();
		if(this.GlobalId != null)
			ifcValve.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcValve.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcValve.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcValve.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcValve.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcValve.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcValve.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcValve.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcValve.setPredefinedType((IfcValveTypeEnum)this.PredefinedType.clone());
		return ifcValve;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcValve ifcValve = new IfcValve();
		if(this.GlobalId != null)
			ifcValve.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcValve.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcValve.setName(this.Name);
		if(this.Description != null)
			ifcValve.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcValve.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcValve.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcValve.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcValve.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcValve.setPredefinedType(this.PredefinedType);
		return ifcValve;
	}
