...
/**
 * This is a default implementation of the entity IfcProtectiveDeviceTrippingUnitType<br><br>
 *<br><br>
 ...
 */
public class IfcProtectiveDeviceTrippingUnitType extends IfcDistributionControlElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcProtectiveDeviceTrippingUnitTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcProtectiveDeviceTrippingUnitType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcProtectiveDeviceTrippingUnitTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcProtectiveDeviceTrippingUnitType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcProtectiveDeviceTrippingUnitTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcProtectiveDeviceTrippingUnitType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPROTECTIVEDEVICETRIPPINGUNITTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcProtectiveDeviceTrippingUnitTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcProtectiveDeviceTrippingUnitType ifcProtectiveDeviceTrippingUnitType = new IfcProtectiveDeviceTrippingUnitType();
		if(this.GlobalId != null)
			ifcProtectiveDeviceTrippingUnitType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcProtectiveDeviceTrippingUnitType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcProtectiveDeviceTrippingUnitType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcProtectiveDeviceTrippingUnitType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcProtectiveDeviceTrippingUnitType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcProtectiveDeviceTrippingUnitType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcProtectiveDeviceTrippingUnitType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcProtectiveDeviceTrippingUnitType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcProtectiveDeviceTrippingUnitType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcProtectiveDeviceTrippingUnitType.setPredefinedType((IfcProtectiveDeviceTrippingUnitTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcProtectiveDeviceTrippingUnitType ifcProtectiveDeviceTrippingUnitType = new IfcProtectiveDeviceTrippingUnitType();
		if(this.GlobalId != null)
			ifcProtectiveDeviceTrippingUnitType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcProtectiveDeviceTrippingUnitType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcProtectiveDeviceTrippingUnitType.setName(this.Name);
		if(this.Description != null)
			ifcProtectiveDeviceTrippingUnitType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcProtectiveDeviceTrippingUnitType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcProtectiveDeviceTrippingUnitType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcProtectiveDeviceTrippingUnitType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcProtectiveDeviceTrippingUnitType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcProtectiveDeviceTrippingUnitType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcProtectiveDeviceTrippingUnitType.setPredefinedType(this.PredefinedType);
		return ifcProtectiveDeviceTrippingUnitType;
	}
