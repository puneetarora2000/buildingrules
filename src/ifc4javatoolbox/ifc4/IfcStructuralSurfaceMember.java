...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcStructuralSurfaceMemberTypeEnum","IfcPositiveLengthMeasure"};
	...
	* @param PredefinedType DEMANDED parameter of type IfcStructuralSurfaceMemberTypeEnum - may not be null.
	...
	* @param Thickness OPTIONAL parameter of type IfcPositiveLengthMeasure
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcStructuralSurfaceMemberTypeEnum PredefinedType, IfcPositiveLengthMeasure Thickness)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcStructuralSurfaceMemberTypeEnum) parameters.get(7);
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcStructuralSurfaceMemberTypeEnum.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
	...
	**/
	public Object clone()
	{
		...
		if(this.PredefinedType != null)
			ifcStructuralSurfaceMember.setPredefinedType((IfcStructuralSurfaceMemberTypeEnum)this.PredefinedType.clone());
