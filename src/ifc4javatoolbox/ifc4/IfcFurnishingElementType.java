...
public class IfcFurnishingElementType extends IfcElementType implements ClassInterface
{
	...
	**/
	public IfcFurnishingElementType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcIdentifier ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType)
	{
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.ApplicableOccurrence != null)
			ifcFurnishingElementType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
