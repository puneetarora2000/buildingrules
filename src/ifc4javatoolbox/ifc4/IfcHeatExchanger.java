...
/**
 * This is a default implementation of the entity IfcHeatExchanger<br><br>
 *<br><br>
 ...
 */
public class IfcHeatExchanger extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcHeatExchangerTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcHeatExchanger object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcHeatExchangerTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcHeatExchanger object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcHeatExchangerTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcHeatExchangerTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcHeatExchangerTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcHeatExchanger.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCHEATEXCHANGER(");
	...
	**/
	public Object clone()
	{
		IfcHeatExchanger ifcHeatExchanger = new IfcHeatExchanger();
		if(this.GlobalId != null)
			ifcHeatExchanger.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcHeatExchanger.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcHeatExchanger.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcHeatExchanger.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcHeatExchanger.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcHeatExchanger.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcHeatExchanger.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcHeatExchanger.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcHeatExchanger.setPredefinedType((IfcHeatExchangerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcHeatExchanger ifcHeatExchanger = new IfcHeatExchanger();
		if(this.GlobalId != null)
			ifcHeatExchanger.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcHeatExchanger.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcHeatExchanger.setName(this.Name);
		if(this.Description != null)
			ifcHeatExchanger.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcHeatExchanger.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcHeatExchanger.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcHeatExchanger.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcHeatExchanger.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcHeatExchanger.setPredefinedType(this.PredefinedType);
		return ifcHeatExchanger;
	}
