...
/**
 * This is a default implementation of the entity IfcMedicalDeviceType<br><br>
 *<br><br>
 ...
 */
public class IfcMedicalDeviceType extends IfcFlowTerminalType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcMedicalDeviceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcMedicalDeviceType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcMedicalDeviceTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcMedicalDeviceType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcMedicalDeviceTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcMedicalDeviceType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCMEDICALDEVICETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcMedicalDeviceTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcMedicalDeviceType ifcMedicalDeviceType = new IfcMedicalDeviceType();
		if(this.GlobalId != null)
			ifcMedicalDeviceType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcMedicalDeviceType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcMedicalDeviceType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcMedicalDeviceType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcMedicalDeviceType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcMedicalDeviceType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcMedicalDeviceType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcMedicalDeviceType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcMedicalDeviceType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcMedicalDeviceType.setPredefinedType((IfcMedicalDeviceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcMedicalDeviceType ifcMedicalDeviceType = new IfcMedicalDeviceType();
		if(this.GlobalId != null)
			ifcMedicalDeviceType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcMedicalDeviceType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcMedicalDeviceType.setName(this.Name);
		if(this.Description != null)
			ifcMedicalDeviceType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcMedicalDeviceType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcMedicalDeviceType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcMedicalDeviceType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcMedicalDeviceType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcMedicalDeviceType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcMedicalDeviceType.setPredefinedType(this.PredefinedType);
		return ifcMedicalDeviceType;
	}
