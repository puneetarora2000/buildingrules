...
/**
 * This is a default implementation of the entity IfcSpatialZone<br><br>
 *<br><br>
 ...
 */
public class IfcSpatialZone extends IfcSpatialElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcLabel","IfcSpatialZoneTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcSpatialZone object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSpatialZoneTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcSpatialZone object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSpatialZoneTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcLabel LongName, IfcSpatialZoneTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSpatialZoneTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSpatialZone.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSPATIALZONE(");
	...
	**/
	public Object clone()
	{
		IfcSpatialZone ifcSpatialZone = new IfcSpatialZone();
		if(this.GlobalId != null)
			ifcSpatialZone.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSpatialZone.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSpatialZone.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSpatialZone.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcSpatialZone.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcSpatialZone.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcSpatialZone.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.LongName != null)
			ifcSpatialZone.setLongName((IfcLabel)this.LongName.clone());
		if(this.PredefinedType != null)
			ifcSpatialZone.setPredefinedType((IfcSpatialZoneTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcSpatialZone ifcSpatialZone = new IfcSpatialZone();
		if(this.GlobalId != null)
			ifcSpatialZone.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSpatialZone.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSpatialZone.setName(this.Name);
		if(this.Description != null)
			ifcSpatialZone.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcSpatialZone.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcSpatialZone.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcSpatialZone.setRepresentation(this.Representation);
		if(this.LongName != null)
			ifcSpatialZone.setLongName(this.LongName);
		if(this.PredefinedType != null)
			ifcSpatialZone.setPredefinedType(this.PredefinedType);
		return ifcSpatialZone;
	}
