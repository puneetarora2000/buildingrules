...
/**
 * This is a default implementation of the entity IfcRationalBSplineCurveWithKnots<br><br>
 *<br><br>
 ...
 */
public class IfcRationalBSplineCurveWithKnots extends IfcBSplineCurveWithKnots implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"INTEGER","LIST<IfcCartesianPoint>","IfcBSplineCurveForm","LOGICAL","LOGICAL","LIST<INTEGER>","LIST<IfcParameterValue>","IfcKnotType","LIST<DOUBLE>"};
	...
	**/
	...
	/**
	* Constructs a new IfcRationalBSplineCurveWithKnots object using the given parameters.
	*
	...
	**/
	public IfcRationalBSplineCurveWithKnots(INTEGER Degree, LIST<IfcCartesianPoint> ControlPointsList, IfcBSplineCurveForm CurveForm, LOGICAL ClosedCurve, LOGICAL SelfIntersect, LIST<INTEGER> KnotMultiplicities, LIST<IfcParameterValue> Knots, IfcKnotType KnotSpec, LIST<DOUBLE> WeightsData)
	{
		this.Degree = Degree;
	...
	/**
	 * This method initializes the IfcRationalBSplineCurveWithKnots object using the given parameters.
	*
	* @param Degree DEMANDED parameter of type INTEGER - may not be null.
	* @param ControlPointsList DEMANDED parameter of type LIST<IfcCartesianPoint> - may not be null.
	* @param CurveForm DEMANDED parameter of type IfcBSplineCurveForm - may not be null.
	...
	* @param WeightsData DEMANDED parameter of type LIST<DOUBLE> - may not be null.
	**/
	public void setParameters(INTEGER Degree, LIST<IfcCartesianPoint> ControlPointsList, IfcBSplineCurveForm CurveForm, LOGICAL ClosedCurve, LOGICAL SelfIntersect, LIST<INTEGER> KnotMultiplicities, LIST<IfcParameterValue> Knots, IfcKnotType KnotSpec, LIST<DOUBLE> WeightsData)
	{
		this.Degree = Degree;
		this.ControlPointsList = ControlPointsList;
		this.CurveForm = CurveForm;
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.WeightsData = (LIST<DOUBLE>) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcRationalBSplineCurveWithKnots.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCRATIONALBSPLINECURVEWITHKNOTS(");
	...
	**/
	...
	public Object clone()
	{
		IfcRationalBSplineCurveWithKnots ifcRationalBSplineCurveWithKnots = new IfcRationalBSplineCurveWithKnots();
		if(this.Degree != null)
			ifcRationalBSplineCurveWithKnots.setDegree((INTEGER)this.Degree.clone());
		if(this.ControlPointsList != null)
			ifcRationalBSplineCurveWithKnots.setControlPointsList((LIST<IfcCartesianPoint>)this.ControlPointsList.clone());
		if(this.CurveForm != null)
			ifcRationalBSplineCurveWithKnots.setCurveForm((IfcBSplineCurveForm)this.CurveForm.clone());
		if(this.ClosedCurve != null)
			ifcRationalBSplineCurveWithKnots.setClosedCurve((LOGICAL)this.ClosedCurve.clone());
		if(this.SelfIntersect != null)
			ifcRationalBSplineCurveWithKnots.setSelfIntersect((LOGICAL)this.SelfIntersect.clone());
		if(this.KnotMultiplicities != null)
			ifcRationalBSplineCurveWithKnots.setKnotMultiplicities((LIST<INTEGER>)this.KnotMultiplicities.clone());
		if(this.Knots != null)
			ifcRationalBSplineCurveWithKnots.setKnots((LIST<IfcParameterValue>)this.Knots.clone());
		if(this.KnotSpec != null)
			ifcRationalBSplineCurveWithKnots.setKnotSpec((IfcKnotType)this.KnotSpec.clone());
		if(this.WeightsData != null)
			ifcRationalBSplineCurveWithKnots.setWeightsData((LIST<DOUBLE>)this.WeightsData.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcRationalBSplineCurveWithKnots ifcRationalBSplineCurveWithKnots = new IfcRationalBSplineCurveWithKnots();
		if(this.Degree != null)
			ifcRationalBSplineCurveWithKnots.setDegree(this.Degree);
		if(this.ControlPointsList != null)
			ifcRationalBSplineCurveWithKnots.setControlPointsList(this.ControlPointsList);
		if(this.CurveForm != null)
			ifcRationalBSplineCurveWithKnots.setCurveForm(this.CurveForm);
		if(this.ClosedCurve != null)
			ifcRationalBSplineCurveWithKnots.setClosedCurve(this.ClosedCurve);
		if(this.SelfIntersect != null)
			ifcRationalBSplineCurveWithKnots.setSelfIntersect(this.SelfIntersect);
		if(this.KnotMultiplicities != null)
			ifcRationalBSplineCurveWithKnots.setKnotMultiplicities(this.KnotMultiplicities);
		if(this.Knots != null)
			ifcRationalBSplineCurveWithKnots.setKnots(this.Knots);
		if(this.KnotSpec != null)
			ifcRationalBSplineCurveWithKnots.setKnotSpec(this.KnotSpec);
		if(this.WeightsData != null)
			ifcRationalBSplineCurveWithKnots.setWeightsData(this.WeightsData);
		return ifcRationalBSplineCurveWithKnots;
	}
