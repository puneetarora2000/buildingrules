...
/**
 * This is a default implementation of the entity IfcOpeningStandardCase<br><br>
 *<br><br>
 ...
 */
public class IfcOpeningStandardCase extends IfcOpeningElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcOpeningElementTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcOpeningStandardCase object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcOpeningElementTypeEnum
	**/
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcOpeningElementTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcOpeningStandardCase.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCOPENINGSTANDARDCASE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcOpeningElementTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	public Object clone()
	{
		IfcOpeningStandardCase ifcOpeningStandardCase = new IfcOpeningStandardCase();
		if(this.GlobalId != null)
			ifcOpeningStandardCase.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcOpeningStandardCase.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcOpeningStandardCase.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcOpeningStandardCase.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcOpeningStandardCase.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcOpeningStandardCase.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcOpeningStandardCase.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcOpeningStandardCase.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcOpeningStandardCase.setPredefinedType((IfcOpeningElementTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcOpeningStandardCase ifcOpeningStandardCase = new IfcOpeningStandardCase();
		if(this.GlobalId != null)
			ifcOpeningStandardCase.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcOpeningStandardCase.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcOpeningStandardCase.setName(this.Name);
		if(this.Description != null)
			ifcOpeningStandardCase.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcOpeningStandardCase.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcOpeningStandardCase.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcOpeningStandardCase.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcOpeningStandardCase.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcOpeningStandardCase.setPredefinedType(this.PredefinedType);
		return ifcOpeningStandardCase;
	}
