...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","SET<IfcObjectDefinition>","IfcObjectTypeEnum","IfcProcessSelect","IfcMeasureWithUnit"};
	...
	* @param RelatingProcess DEMANDED parameter of type IfcProcessSelect - may not be null.
	* @param QuantityInProcess OPTIONAL parameter of type IfcMeasureWithUnit
	**/
	public IfcRelAssignsToProcess(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, SET<IfcObjectDefinition> RelatedObjects, IfcObjectTypeEnum RelatedObjectsType, IfcProcessSelect RelatingProcess, IfcMeasureWithUnit QuantityInProcess)
	{
	...
	* @param QuantityInProcess OPTIONAL parameter of type IfcMeasureWithUnit
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, SET<IfcObjectDefinition> RelatedObjects, IfcObjectTypeEnum RelatedObjectsType, IfcProcessSelect RelatingProcess, IfcMeasureWithUnit QuantityInProcess)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.RelatingProcess = (IfcProcessSelect) parameters.get(6);
	...
	**/
	...
	private void resolveInverses()
	{
		...
		{
				if(RelatingProcess instanceof IfcProcess)
				{
				if(((IfcProcess)RelatingProcess).OperatesOn_Inverse == null)
				{
					((IfcProcess)RelatingProcess).OperatesOn_Inverse = new SET<IfcRelAssignsToProcess>();
				}
				((IfcProcess)RelatingProcess).OperatesOn_Inverse.add(this);
				}
				else if(RelatingProcess instanceof IfcTypeProcess)
				{
				if(((IfcTypeProcess)RelatingProcess).OperatesOn_Inverse == null)
				{
					((IfcTypeProcess)RelatingProcess).OperatesOn_Inverse = new SET<IfcRelAssignsToProcess>();
				}
				((IfcTypeProcess)RelatingProcess).OperatesOn_Inverse.add(this);
				}
		}
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.RelatingProcess != null)		stepString = stepString.concat(((RootInterface)this.RelatingProcess).getStepParameter(IfcProcessSelect.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
	...
	* @return the value of RelatingProcess
	...
	private void synchronizeInversesAddRelatingProcess(IfcProcessSelect RelatingProcess)
	{
		if(RelatingProcess != null)
		{
				if(RelatingProcess instanceof IfcProcess)
	...
	private void synchronizeInversesRemoveRelatingProcess(IfcProcessSelect RelatingProcess)
	{
		if(RelatingProcess != null)
		{
				if(RelatingProcess instanceof IfcProcess)
				...
				if(((IfcProcess)RelatingProcess).OperatesOn_Inverse != null)
				{
				((IfcProcess)RelatingProcess).OperatesOn_Inverse.remove(this);
				}
				}
				else if(RelatingProcess instanceof IfcTypeProcess)
				{
				if(((IfcTypeProcess)RelatingProcess).OperatesOn_Inverse != null)
				{
				((IfcTypeProcess)RelatingProcess).OperatesOn_Inverse.remove(this);
				}
				}
		}
	}
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.RelatingProcess != null)
			ifcRelAssignsToProcess.setRelatingProcess((IfcProcessSelect)this.RelatingProcess.clone());
