...
/**
 * This is a default implementation of the entity IfcDuctSegment<br><br>
 *<br><br>
 ...
 */
public class IfcDuctSegment extends IfcFlowSegment implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcDuctSegmentTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcDuctSegment object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcDuctSegmentTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcDuctSegment object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcDuctSegmentTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcDuctSegmentTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcDuctSegmentTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcDuctSegment.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCDUCTSEGMENT(");
	...
	**/
	public Object clone()
	{
		IfcDuctSegment ifcDuctSegment = new IfcDuctSegment();
		if(this.GlobalId != null)
			ifcDuctSegment.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcDuctSegment.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcDuctSegment.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcDuctSegment.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcDuctSegment.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcDuctSegment.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcDuctSegment.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcDuctSegment.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcDuctSegment.setPredefinedType((IfcDuctSegmentTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcDuctSegment ifcDuctSegment = new IfcDuctSegment();
		if(this.GlobalId != null)
			ifcDuctSegment.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcDuctSegment.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcDuctSegment.setName(this.Name);
		if(this.Description != null)
			ifcDuctSegment.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcDuctSegment.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcDuctSegment.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcDuctSegment.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcDuctSegment.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcDuctSegment.setPredefinedType(this.PredefinedType);
		return ifcDuctSegment;
	}
