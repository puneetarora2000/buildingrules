...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","SET<IfcDefinitionSelect>","IfcLibrarySelect"};
	...
	**/
	public IfcRelAssociatesLibrary(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, SET<IfcDefinitionSelect> RelatedObjects, IfcLibrarySelect RelatingLibrary)
	{
	...
	* @param RelatingLibrary DEMANDED parameter of type IfcLibrarySelect - may not be null.
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, SET<IfcDefinitionSelect> RelatedObjects, IfcLibrarySelect RelatingLibrary)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	...
	private void resolveInverses()
	{
		...
		{
				if(RelatingLibrary instanceof IfcLibraryInformation)
				{
				if(((IfcLibraryInformation)RelatingLibrary).LibraryInfoForObjects_Inverse == null)
				{
					((IfcLibraryInformation)RelatingLibrary).LibraryInfoForObjects_Inverse = new SET<IfcRelAssociatesLibrary>();
				}
				((IfcLibraryInformation)RelatingLibrary).LibraryInfoForObjects_Inverse.add(this);
				}
		}
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	...
	{
		synchronizeInversesRemoveRelatingLibrary(this.RelatingLibrary);
		this.RelatingLibrary = RelatingLibrary;
		synchronizeInversesAddRelatingLibrary(this.RelatingLibrary);
		fireChangeEvent();
	}
	...
	* @return the value of RelatingLibrary
	...
	private void synchronizeInversesAddRelatingLibrary(IfcLibrarySelect RelatingLibrary)
	{
		if(RelatingLibrary != null)
		{
				if(RelatingLibrary instanceof IfcLibraryInformation)
	...
	private void synchronizeInversesRemoveRelatingLibrary(IfcLibrarySelect RelatingLibrary)
	{
		if(RelatingLibrary != null)
		{
				if(RelatingLibrary instanceof IfcLibraryInformation)
				...
				if(((IfcLibraryInformation)RelatingLibrary).LibraryInfoForObjects_Inverse != null)
				{
				((IfcLibraryInformation)RelatingLibrary).LibraryInfoForObjects_Inverse.remove(this);
				}
				}
		}
	}
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.RelatedObjects != null)
			ifcRelAssociatesLibrary.setRelatedObjects((SET<IfcDefinitionSelect>)this.RelatedObjects.clone());
