...
/**
 * This is a default implementation of the entity IfcFurniture<br><br>
 *<br><br>
 ...
 */
public class IfcFurniture extends IfcFurnishingElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcFurnitureTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcFurniture object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcFurnitureTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcFurniture object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcFurnitureTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcFurnitureTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcFurnitureTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcFurniture.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFURNITURE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcFurnitureTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	public Object clone()
	{
		IfcFurniture ifcFurniture = new IfcFurniture();
		if(this.GlobalId != null)
			ifcFurniture.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFurniture.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFurniture.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFurniture.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFurniture.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFurniture.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFurniture.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFurniture.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcFurniture.setPredefinedType((IfcFurnitureTypeEnum)this.PredefinedType.clone());
		return ifcFurniture;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcFurniture ifcFurniture = new IfcFurniture();
		if(this.GlobalId != null)
			ifcFurniture.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFurniture.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFurniture.setName(this.Name);
		if(this.Description != null)
			ifcFurniture.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFurniture.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFurniture.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFurniture.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFurniture.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcFurniture.setPredefinedType(this.PredefinedType);
		return ifcFurniture;
	}
