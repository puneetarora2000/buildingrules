...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcFastenerTypeEnum"};
	...
	* @param PredefinedType DEMANDED parameter of type IfcFastenerTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcFastenerType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcFastenerTypeEnum) parameters.get(9);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.ApplicableOccurrence != null)
			ifcFastenerType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		...
		if(this.PredefinedType != null)
			ifcFastenerType.setPredefinedType((IfcFastenerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.PredefinedType != null)
			ifcFastenerType.setPredefinedType(this.PredefinedType);
		return ifcFastenerType;
	}
