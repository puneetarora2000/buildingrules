...
/**
 * This is a default implementation of the entity IfcPump<br><br>
 *<br><br>
 ...
 */
public class IfcPump extends IfcFlowMovingDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcPumpTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcPump object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcPumpTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcPump object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcPumpTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcPumpTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcPumpTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcPump.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPUMP(");
	...
	**/
	public Object clone()
	{
		IfcPump ifcPump = new IfcPump();
		if(this.GlobalId != null)
			ifcPump.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcPump.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcPump.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcPump.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcPump.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcPump.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcPump.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcPump.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcPump.setPredefinedType((IfcPumpTypeEnum)this.PredefinedType.clone());
		return ifcPump;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcPump ifcPump = new IfcPump();
		if(this.GlobalId != null)
			ifcPump.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcPump.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcPump.setName(this.Name);
		if(this.Description != null)
			ifcPump.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcPump.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcPump.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcPump.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcPump.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcPump.setPredefinedType(this.PredefinedType);
		return ifcPump;
	}
