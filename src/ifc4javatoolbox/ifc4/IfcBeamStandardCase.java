...
/**
 * This is a default implementation of the entity IfcBeamStandardCase<br><br>
 *<br><br>
 ...
 */
public class IfcBeamStandardCase extends IfcBeam implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcBeamTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcBeamStandardCase object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcBeamTypeEnum
	**/
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcBeamTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcBeamStandardCase.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCBEAMSTANDARDCASE(");
	...
	**/
	public Object clone()
	{
		IfcBeamStandardCase ifcBeamStandardCase = new IfcBeamStandardCase();
		if(this.GlobalId != null)
			ifcBeamStandardCase.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcBeamStandardCase.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcBeamStandardCase.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcBeamStandardCase.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcBeamStandardCase.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcBeamStandardCase.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcBeamStandardCase.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcBeamStandardCase.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcBeamStandardCase.setPredefinedType((IfcBeamTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcBeamStandardCase ifcBeamStandardCase = new IfcBeamStandardCase();
		if(this.GlobalId != null)
			ifcBeamStandardCase.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcBeamStandardCase.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcBeamStandardCase.setName(this.Name);
		if(this.Description != null)
			ifcBeamStandardCase.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcBeamStandardCase.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcBeamStandardCase.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcBeamStandardCase.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcBeamStandardCase.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcBeamStandardCase.setPredefinedType(this.PredefinedType);
		return ifcBeamStandardCase;
	}
