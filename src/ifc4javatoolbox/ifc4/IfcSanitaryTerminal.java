...
/**
 * This is a default implementation of the entity IfcSanitaryTerminal<br><br>
 *<br><br>
 ...
 */
public class IfcSanitaryTerminal extends IfcFlowTerminal implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcSanitaryTerminalTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcSanitaryTerminal object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSanitaryTerminalTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcSanitaryTerminal object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSanitaryTerminalTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcSanitaryTerminalTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSanitaryTerminalTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSanitaryTerminal.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSANITARYTERMINAL(");
	...
	**/
	public Object clone()
	{
		IfcSanitaryTerminal ifcSanitaryTerminal = new IfcSanitaryTerminal();
		if(this.GlobalId != null)
			ifcSanitaryTerminal.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSanitaryTerminal.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSanitaryTerminal.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSanitaryTerminal.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcSanitaryTerminal.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcSanitaryTerminal.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcSanitaryTerminal.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcSanitaryTerminal.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcSanitaryTerminal.setPredefinedType((IfcSanitaryTerminalTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcSanitaryTerminal ifcSanitaryTerminal = new IfcSanitaryTerminal();
		if(this.GlobalId != null)
			ifcSanitaryTerminal.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSanitaryTerminal.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSanitaryTerminal.setName(this.Name);
		if(this.Description != null)
			ifcSanitaryTerminal.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcSanitaryTerminal.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcSanitaryTerminal.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcSanitaryTerminal.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcSanitaryTerminal.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcSanitaryTerminal.setPredefinedType(this.PredefinedType);
		return ifcSanitaryTerminal;
	}
