 ...
 */
public class IfcVibrationIsolatorType extends IfcElementComponentType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcVibrationIsolatorTypeEnum"};
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.ApplicableOccurrence != null)
			ifcVibrationIsolatorType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
