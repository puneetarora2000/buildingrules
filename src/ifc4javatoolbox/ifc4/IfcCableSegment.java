...
/**
 * This is a default implementation of the entity IfcCableSegment<br><br>
 *<br><br>
 ...
 */
public class IfcCableSegment extends IfcFlowSegment implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcCableSegmentTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcCableSegment object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCableSegmentTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcCableSegment object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCableSegmentTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcCableSegmentTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCableSegmentTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCableSegment.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCABLESEGMENT(");
	...
	**/
	public Object clone()
	{
		IfcCableSegment ifcCableSegment = new IfcCableSegment();
		if(this.GlobalId != null)
			ifcCableSegment.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCableSegment.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCableSegment.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCableSegment.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcCableSegment.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcCableSegment.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcCableSegment.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcCableSegment.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcCableSegment.setPredefinedType((IfcCableSegmentTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCableSegment ifcCableSegment = new IfcCableSegment();
		if(this.GlobalId != null)
			ifcCableSegment.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCableSegment.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCableSegment.setName(this.Name);
		if(this.Description != null)
			ifcCableSegment.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcCableSegment.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcCableSegment.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcCableSegment.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcCableSegment.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcCableSegment.setPredefinedType(this.PredefinedType);
		return ifcCableSegment;
	}
