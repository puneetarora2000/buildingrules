...
/**
 * This is a default implementation of the entity IfcCylindricalSurface<br><br>
 *<br><br>
 ...
 */
public class IfcCylindricalSurface extends IfcElementarySurface implements ClassInterface
{
	...
	**/
	...
	/**
	* Constructs a new IfcCylindricalSurface object using the given parameters.
	*
	...
	**/
	...
	/**
	 * This method initializes the IfcCylindricalSurface object using the given parameters.
	*
	* @param Position DEMANDED parameter of type IfcAxis2Placement3D - may not be null.
	* @param Radius DEMANDED parameter of type IfcPositiveLengthMeasure - may not be null.
	**/
	...
	**/
	...
	{
		return IfcCylindricalSurface.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCYLINDRICALSURFACE(");
	...
	**/
	public Object clone()
	{
		IfcCylindricalSurface ifcCylindricalSurface = new IfcCylindricalSurface();
		if(this.Position != null)
			ifcCylindricalSurface.setPosition((IfcAxis2Placement3D)this.Position.clone());
		if(this.Radius != null)
			ifcCylindricalSurface.setRadius((IfcPositiveLengthMeasure)this.Radius.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCylindricalSurface ifcCylindricalSurface = new IfcCylindricalSurface();
		if(this.Position != null)
			ifcCylindricalSurface.setPosition(this.Position);
		if(this.Radius != null)
			ifcCylindricalSurface.setRadius(this.Radius);
		return ifcCylindricalSurface;
	}
