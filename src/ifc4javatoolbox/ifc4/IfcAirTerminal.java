...
/**
 * This is a default implementation of the entity IfcAirTerminal<br><br>
 *<br><br>
 ...
 */
public class IfcAirTerminal extends IfcFlowTerminal implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcAirTerminalTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcAirTerminal object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcAirTerminalTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcAirTerminal object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcAirTerminalTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcAirTerminalTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcAirTerminalTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcAirTerminal.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCAIRTERMINAL(");
	...
	**/
	public Object clone()
	{
		IfcAirTerminal ifcAirTerminal = new IfcAirTerminal();
		if(this.GlobalId != null)
			ifcAirTerminal.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcAirTerminal.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcAirTerminal.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcAirTerminal.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcAirTerminal.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcAirTerminal.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcAirTerminal.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcAirTerminal.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcAirTerminal.setPredefinedType((IfcAirTerminalTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcAirTerminal ifcAirTerminal = new IfcAirTerminal();
		if(this.GlobalId != null)
			ifcAirTerminal.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcAirTerminal.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcAirTerminal.setName(this.Name);
		if(this.Description != null)
			ifcAirTerminal.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcAirTerminal.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcAirTerminal.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcAirTerminal.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcAirTerminal.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcAirTerminal.setPredefinedType(this.PredefinedType);
		return ifcAirTerminal;
	}
