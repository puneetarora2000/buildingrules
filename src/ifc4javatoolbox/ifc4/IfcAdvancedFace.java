...
/**
 * This is a default implementation of the entity IfcAdvancedFace<br><br>
 *<br><br>
 ...
 */
public class IfcAdvancedFace extends IfcFaceSurface implements ClassInterface
{
	...
	**/
	...
	/**
	* Constructs a new IfcAdvancedFace object using the given parameters.
	*
	...
	**/
	public IfcAdvancedFace(SET<IfcFaceBound> Bounds, IfcSurface FaceSurface, BOOLEAN SameSense)
	{
		this.Bounds = Bounds;
	...
	**/
	...
	{
		return IfcAdvancedFace.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCADVANCEDFACE(");
	...
	**/
	...
	public Object clone()
	{
		IfcAdvancedFace ifcAdvancedFace = new IfcAdvancedFace();
		if(this.Bounds != null)
			ifcAdvancedFace.setBounds((SET<IfcFaceBound>)this.Bounds.clone());
		if(this.FaceSurface != null)
			ifcAdvancedFace.setFaceSurface((IfcSurface)this.FaceSurface.clone());
		if(this.SameSense != null)
			ifcAdvancedFace.setSameSense((BOOLEAN)this.SameSense.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcAdvancedFace ifcAdvancedFace = new IfcAdvancedFace();
		if(this.Bounds != null)
			ifcAdvancedFace.setBounds(this.Bounds);
		if(this.FaceSurface != null)
			ifcAdvancedFace.setFaceSurface(this.FaceSurface);
		if(this.SameSense != null)
			ifcAdvancedFace.setSameSense(this.SameSense);
		return ifcAdvancedFace;
	}
