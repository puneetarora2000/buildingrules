...
/**
 * This is a default implementation of the entity IfcAudioVisualAppliance<br><br>
 *<br><br>
 ...
 */
public class IfcAudioVisualAppliance extends IfcFlowTerminal implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcAudioVisualApplianceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcAudioVisualAppliance object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcAudioVisualApplianceTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcAudioVisualAppliance object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcAudioVisualApplianceTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcAudioVisualApplianceTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcAudioVisualApplianceTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcAudioVisualAppliance.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCAUDIOVISUALAPPLIANCE(");
	...
	**/
	public Object clone()
	{
		IfcAudioVisualAppliance ifcAudioVisualAppliance = new IfcAudioVisualAppliance();
		if(this.GlobalId != null)
			ifcAudioVisualAppliance.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcAudioVisualAppliance.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcAudioVisualAppliance.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcAudioVisualAppliance.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcAudioVisualAppliance.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcAudioVisualAppliance.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcAudioVisualAppliance.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcAudioVisualAppliance.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcAudioVisualAppliance.setPredefinedType((IfcAudioVisualApplianceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcAudioVisualAppliance ifcAudioVisualAppliance = new IfcAudioVisualAppliance();
		if(this.GlobalId != null)
			ifcAudioVisualAppliance.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcAudioVisualAppliance.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcAudioVisualAppliance.setName(this.Name);
		if(this.Description != null)
			ifcAudioVisualAppliance.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcAudioVisualAppliance.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcAudioVisualAppliance.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcAudioVisualAppliance.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcAudioVisualAppliance.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcAudioVisualAppliance.setPredefinedType(this.PredefinedType);
		return ifcAudioVisualAppliance;
	}
