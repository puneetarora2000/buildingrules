...
/**
 * This is a default implementation of the entity IfcCableCarrierFitting<br><br>
 *<br><br>
 ...
 */
public class IfcCableCarrierFitting extends IfcFlowFitting implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcCableCarrierFittingTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcCableCarrierFitting object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCableCarrierFittingTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcCableCarrierFitting object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCableCarrierFittingTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcCableCarrierFittingTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCableCarrierFittingTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCableCarrierFitting.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCABLECARRIERFITTING(");
	...
	**/
	public Object clone()
	{
		IfcCableCarrierFitting ifcCableCarrierFitting = new IfcCableCarrierFitting();
		if(this.GlobalId != null)
			ifcCableCarrierFitting.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCableCarrierFitting.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCableCarrierFitting.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCableCarrierFitting.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcCableCarrierFitting.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcCableCarrierFitting.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcCableCarrierFitting.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcCableCarrierFitting.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcCableCarrierFitting.setPredefinedType((IfcCableCarrierFittingTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCableCarrierFitting ifcCableCarrierFitting = new IfcCableCarrierFitting();
		if(this.GlobalId != null)
			ifcCableCarrierFitting.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCableCarrierFitting.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCableCarrierFitting.setName(this.Name);
		if(this.Description != null)
			ifcCableCarrierFitting.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcCableCarrierFitting.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcCableCarrierFitting.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcCableCarrierFitting.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcCableCarrierFitting.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcCableCarrierFitting.setPredefinedType(this.PredefinedType);
		return ifcCableCarrierFitting;
	}
