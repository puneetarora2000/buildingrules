...
/**
 * This is a default implementation of the entity IfcCoordinateOperation<br><br>
 *<br><br>
 ...
 */
public abstract class IfcCoordinateOperation extends InternalAccessClass implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcCoordinateReferenceSystemSelect","IfcCoordinateReferenceSystem"};
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** SourceCRS is an DEMANDED attribute - may not be null**/
	protected IfcCoordinateReferenceSystemSelect SourceCRS;
	/** TargetCRS is an DEMANDED attribute - may not be null**/
	...
	**/
	...
	/**
	* Constructs a new IfcCoordinateOperation object using the given parameters.
	*
	...
	**/
	...
	/**
	 * This method initializes the IfcCoordinateOperation object using the given parameters.
	*
	* @param SourceCRS DEMANDED parameter of type IfcCoordinateReferenceSystemSelect - may not be null.
	* @param TargetCRS DEMANDED parameter of type IfcCoordinateReferenceSystem - may not be null.
	**/
	public void setParameters(IfcCoordinateReferenceSystemSelect SourceCRS, IfcCoordinateReferenceSystem TargetCRS)
	{
		this.SourceCRS = SourceCRS;
		this.TargetCRS = TargetCRS;
		resolveInverses();
	...
	**/
	...
	{
		return IfcCoordinateOperation.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCOORDINATEOPERATION(");
	...
	**/
	...
	/**
	* This method sets the SourceCRS attribute to the given value.
	*
	* @param SourceCRS OPTIONAL value to set
	**/
	...
	/**
	* This method returns the value of the SourceCRS attribute.
	*
	* @return the value of SourceCRS
	/**/
	...
	/**
	* This method sets the TargetCRS attribute to the given value.
	*
	* @param TargetCRS OPTIONAL value to set
	**/
	...
	/**
	* This method returns the value of the TargetCRS attribute.
	*
	* @return the value of TargetCRS
	/**/
