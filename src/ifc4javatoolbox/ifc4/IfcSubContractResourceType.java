...
/**
 * This is a default implementation of the entity IfcSubContractResourceType<br><br>
 *<br><br>
 ...
 */
public class IfcSubContractResourceType extends IfcConstructionResourceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","IfcIdentifier","IfcText","IfcLabel","LIST<IfcAppliedValue>","IfcPhysicalQuantity","IfcSubContractResourceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcSubContractResourceType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcSubContractResourceTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcSubContractResourceType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSubContractResourceTypeEnum) parameters.get(11);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSubContractResourceType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSUBCONTRACTRESOURCETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcSubContractResourceTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcSubContractResourceType ifcSubContractResourceType = new IfcSubContractResourceType();
		if(this.GlobalId != null)
			ifcSubContractResourceType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSubContractResourceType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSubContractResourceType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSubContractResourceType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcSubContractResourceType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcSubContractResourceType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.Identification != null)
			ifcSubContractResourceType.setIdentification((IfcIdentifier)this.Identification.clone());
		if(this.LongDescription != null)
			ifcSubContractResourceType.setLongDescription((IfcText)this.LongDescription.clone());
		if(this.ResourceType != null)
			ifcSubContractResourceType.setResourceType((IfcLabel)this.ResourceType.clone());
		if(this.BaseCosts != null)
			ifcSubContractResourceType.setBaseCosts((LIST<IfcAppliedValue>)this.BaseCosts.clone());
		if(this.BaseQuantity != null)
			ifcSubContractResourceType.setBaseQuantity((IfcPhysicalQuantity)this.BaseQuantity.clone());
		if(this.PredefinedType != null)
			ifcSubContractResourceType.setPredefinedType((IfcSubContractResourceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcSubContractResourceType ifcSubContractResourceType = new IfcSubContractResourceType();
		if(this.GlobalId != null)
			ifcSubContractResourceType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSubContractResourceType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSubContractResourceType.setName(this.Name);
		if(this.Description != null)
			ifcSubContractResourceType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcSubContractResourceType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcSubContractResourceType.setHasPropertySets(this.HasPropertySets);
		if(this.Identification != null)
			ifcSubContractResourceType.setIdentification(this.Identification);
		if(this.LongDescription != null)
			ifcSubContractResourceType.setLongDescription(this.LongDescription);
		if(this.ResourceType != null)
			ifcSubContractResourceType.setResourceType(this.ResourceType);
		if(this.BaseCosts != null)
			ifcSubContractResourceType.setBaseCosts(this.BaseCosts);
		if(this.BaseQuantity != null)
			ifcSubContractResourceType.setBaseQuantity(this.BaseQuantity);
		if(this.PredefinedType != null)
			ifcSubContractResourceType.setPredefinedType(this.PredefinedType);
		return ifcSubContractResourceType;
	}
