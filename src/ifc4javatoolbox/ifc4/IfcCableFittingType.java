...
/**
 * This is a default implementation of the entity IfcCableFittingType<br><br>
 *<br><br>
 ...
 */
public class IfcCableFittingType extends IfcFlowFittingType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcCableFittingTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcCableFittingType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcCableFittingTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcCableFittingType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCableFittingTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCableFittingType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCABLEFITTINGTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcCableFittingTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcCableFittingType ifcCableFittingType = new IfcCableFittingType();
		if(this.GlobalId != null)
			ifcCableFittingType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCableFittingType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCableFittingType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCableFittingType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcCableFittingType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcCableFittingType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcCableFittingType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcCableFittingType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcCableFittingType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcCableFittingType.setPredefinedType((IfcCableFittingTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCableFittingType ifcCableFittingType = new IfcCableFittingType();
		if(this.GlobalId != null)
			ifcCableFittingType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCableFittingType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCableFittingType.setName(this.Name);
		if(this.Description != null)
			ifcCableFittingType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcCableFittingType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcCableFittingType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcCableFittingType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcCableFittingType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcCableFittingType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcCableFittingType.setPredefinedType(this.PredefinedType);
		return ifcCableFittingType;
	}
