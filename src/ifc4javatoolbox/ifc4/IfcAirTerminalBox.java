...
/**
 * This is a default implementation of the entity IfcAirTerminalBox<br><br>
 *<br><br>
 ...
 */
public class IfcAirTerminalBox extends IfcFlowController implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcAirTerminalBoxTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcAirTerminalBox object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcAirTerminalBoxTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcAirTerminalBox object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcAirTerminalBoxTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcAirTerminalBoxTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcAirTerminalBoxTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcAirTerminalBox.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCAIRTERMINALBOX(");
	...
	**/
	public Object clone()
	{
		IfcAirTerminalBox ifcAirTerminalBox = new IfcAirTerminalBox();
		if(this.GlobalId != null)
			ifcAirTerminalBox.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcAirTerminalBox.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcAirTerminalBox.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcAirTerminalBox.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcAirTerminalBox.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcAirTerminalBox.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcAirTerminalBox.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcAirTerminalBox.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcAirTerminalBox.setPredefinedType((IfcAirTerminalBoxTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcAirTerminalBox ifcAirTerminalBox = new IfcAirTerminalBox();
		if(this.GlobalId != null)
			ifcAirTerminalBox.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcAirTerminalBox.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcAirTerminalBox.setName(this.Name);
		if(this.Description != null)
			ifcAirTerminalBox.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcAirTerminalBox.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcAirTerminalBox.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcAirTerminalBox.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcAirTerminalBox.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcAirTerminalBox.setPredefinedType(this.PredefinedType);
		return ifcAirTerminalBox;
	}
