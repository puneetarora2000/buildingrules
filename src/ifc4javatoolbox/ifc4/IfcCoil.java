...
/**
 * This is a default implementation of the entity IfcCoil<br><br>
 *<br><br>
 ...
 */
public class IfcCoil extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcCoilTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcCoil object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCoilTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcCoil object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCoilTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcCoilTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCoilTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCoil.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCOIL(");
	...
	**/
	public Object clone()
	{
		IfcCoil ifcCoil = new IfcCoil();
		if(this.GlobalId != null)
			ifcCoil.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCoil.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCoil.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCoil.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcCoil.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcCoil.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcCoil.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcCoil.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcCoil.setPredefinedType((IfcCoilTypeEnum)this.PredefinedType.clone());
		return ifcCoil;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcCoil ifcCoil = new IfcCoil();
		if(this.GlobalId != null)
			ifcCoil.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCoil.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCoil.setName(this.Name);
		if(this.Description != null)
			ifcCoil.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcCoil.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcCoil.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcCoil.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcCoil.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcCoil.setPredefinedType(this.PredefinedType);
		return ifcCoil;
	}
