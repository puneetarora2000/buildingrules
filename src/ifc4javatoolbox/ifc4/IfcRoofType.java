...
/**
 * This is a default implementation of the entity IfcRoofType<br><br>
 *<br><br>
 ...
 */
public class IfcRoofType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcRoofTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcRoofType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcRoofTypeEnum - may not be null.
	**/
	public IfcRoofType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcIdentifier ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcRoofTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcRoofType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcRoofTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcRoofType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCROOFTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcRoofTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcRoofType ifcRoofType = new IfcRoofType();
		if(this.GlobalId != null)
			ifcRoofType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcRoofType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcRoofType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcRoofType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcRoofType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcRoofType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcRoofType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcRoofType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcRoofType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcRoofType.setPredefinedType((IfcRoofTypeEnum)this.PredefinedType.clone());
		return ifcRoofType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcRoofType ifcRoofType = new IfcRoofType();
		if(this.GlobalId != null)
			ifcRoofType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcRoofType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcRoofType.setName(this.Name);
		if(this.Description != null)
			ifcRoofType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcRoofType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcRoofType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcRoofType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcRoofType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcRoofType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcRoofType.setPredefinedType(this.PredefinedType);
		return ifcRoofType;
	}
