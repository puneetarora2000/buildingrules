...
/**
 * This is a default implementation of the entity IfcInterceptorType<br><br>
 *<br><br>
 ...
 */
public class IfcInterceptorType extends IfcFlowTreatmentDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcInterceptorTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcInterceptorType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcInterceptorTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcInterceptorType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcInterceptorTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcInterceptorType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCINTERCEPTORTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcInterceptorTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcInterceptorType ifcInterceptorType = new IfcInterceptorType();
		if(this.GlobalId != null)
			ifcInterceptorType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcInterceptorType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcInterceptorType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcInterceptorType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcInterceptorType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcInterceptorType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcInterceptorType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcInterceptorType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcInterceptorType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcInterceptorType.setPredefinedType((IfcInterceptorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcInterceptorType ifcInterceptorType = new IfcInterceptorType();
		if(this.GlobalId != null)
			ifcInterceptorType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcInterceptorType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcInterceptorType.setName(this.Name);
		if(this.Description != null)
			ifcInterceptorType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcInterceptorType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcInterceptorType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcInterceptorType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcInterceptorType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcInterceptorType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcInterceptorType.setPredefinedType(this.PredefinedType);
		return ifcInterceptorType;
	}
