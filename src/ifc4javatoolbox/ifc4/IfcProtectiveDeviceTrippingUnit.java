...
/**
 * This is a default implementation of the entity IfcProtectiveDeviceTrippingUnit<br><br>
 *<br><br>
 ...
 */
public class IfcProtectiveDeviceTrippingUnit extends IfcDistributionControlElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcProtectiveDeviceTrippingUnitTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcProtectiveDeviceTrippingUnit object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcProtectiveDeviceTrippingUnitTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcProtectiveDeviceTrippingUnit object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcProtectiveDeviceTrippingUnitTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcProtectiveDeviceTrippingUnitTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcProtectiveDeviceTrippingUnitTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcProtectiveDeviceTrippingUnit.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPROTECTIVEDEVICETRIPPINGUNIT(");
	...
	**/
	public Object clone()
	{
		IfcProtectiveDeviceTrippingUnit ifcProtectiveDeviceTrippingUnit = new IfcProtectiveDeviceTrippingUnit();
		if(this.GlobalId != null)
			ifcProtectiveDeviceTrippingUnit.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcProtectiveDeviceTrippingUnit.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcProtectiveDeviceTrippingUnit.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcProtectiveDeviceTrippingUnit.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcProtectiveDeviceTrippingUnit.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcProtectiveDeviceTrippingUnit.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcProtectiveDeviceTrippingUnit.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcProtectiveDeviceTrippingUnit.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcProtectiveDeviceTrippingUnit.setPredefinedType((IfcProtectiveDeviceTrippingUnitTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcProtectiveDeviceTrippingUnit ifcProtectiveDeviceTrippingUnit = new IfcProtectiveDeviceTrippingUnit();
		if(this.GlobalId != null)
			ifcProtectiveDeviceTrippingUnit.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcProtectiveDeviceTrippingUnit.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcProtectiveDeviceTrippingUnit.setName(this.Name);
		if(this.Description != null)
			ifcProtectiveDeviceTrippingUnit.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcProtectiveDeviceTrippingUnit.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcProtectiveDeviceTrippingUnit.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcProtectiveDeviceTrippingUnit.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcProtectiveDeviceTrippingUnit.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcProtectiveDeviceTrippingUnit.setPredefinedType(this.PredefinedType);
		return ifcProtectiveDeviceTrippingUnit;
	}
