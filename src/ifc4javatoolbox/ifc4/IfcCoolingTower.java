...
/**
 * This is a default implementation of the entity IfcCoolingTower<br><br>
 *<br><br>
 ...
 */
public class IfcCoolingTower extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcCoolingTowerTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcCoolingTower object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCoolingTowerTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcCoolingTower object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCoolingTowerTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcCoolingTowerTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCoolingTowerTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCoolingTower.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCOOLINGTOWER(");
	...
	**/
	public Object clone()
	{
		IfcCoolingTower ifcCoolingTower = new IfcCoolingTower();
		if(this.GlobalId != null)
			ifcCoolingTower.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCoolingTower.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCoolingTower.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCoolingTower.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcCoolingTower.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcCoolingTower.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcCoolingTower.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcCoolingTower.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcCoolingTower.setPredefinedType((IfcCoolingTowerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCoolingTower ifcCoolingTower = new IfcCoolingTower();
		if(this.GlobalId != null)
			ifcCoolingTower.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCoolingTower.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCoolingTower.setName(this.Name);
		if(this.Description != null)
			ifcCoolingTower.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcCoolingTower.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcCoolingTower.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcCoolingTower.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcCoolingTower.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcCoolingTower.setPredefinedType(this.PredefinedType);
		return ifcCoolingTower;
	}
