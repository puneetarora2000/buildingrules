...
/**
 * This is a default implementation of the entity IfcCrewResourceType<br><br>
 *<br><br>
 ...
 */
public class IfcCrewResourceType extends IfcConstructionResourceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","IfcIdentifier","IfcText","IfcLabel","LIST<IfcAppliedValue>","IfcPhysicalQuantity","IfcCrewResourceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcCrewResourceType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcCrewResourceTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcCrewResourceType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCrewResourceTypeEnum) parameters.get(11);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCrewResourceType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCREWRESOURCETYPE(");
	...
	**/
	...
	public Object clone()
	{
		IfcCrewResourceType ifcCrewResourceType = new IfcCrewResourceType();
		if(this.GlobalId != null)
			ifcCrewResourceType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCrewResourceType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCrewResourceType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCrewResourceType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcCrewResourceType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcCrewResourceType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.Identification != null)
			ifcCrewResourceType.setIdentification((IfcIdentifier)this.Identification.clone());
		if(this.LongDescription != null)
			ifcCrewResourceType.setLongDescription((IfcText)this.LongDescription.clone());
		if(this.ResourceType != null)
			ifcCrewResourceType.setResourceType((IfcLabel)this.ResourceType.clone());
		if(this.BaseCosts != null)
			ifcCrewResourceType.setBaseCosts((LIST<IfcAppliedValue>)this.BaseCosts.clone());
		if(this.BaseQuantity != null)
			ifcCrewResourceType.setBaseQuantity((IfcPhysicalQuantity)this.BaseQuantity.clone());
		if(this.PredefinedType != null)
			ifcCrewResourceType.setPredefinedType((IfcCrewResourceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCrewResourceType ifcCrewResourceType = new IfcCrewResourceType();
		if(this.GlobalId != null)
			ifcCrewResourceType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCrewResourceType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCrewResourceType.setName(this.Name);
		if(this.Description != null)
			ifcCrewResourceType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcCrewResourceType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcCrewResourceType.setHasPropertySets(this.HasPropertySets);
		if(this.Identification != null)
			ifcCrewResourceType.setIdentification(this.Identification);
		if(this.LongDescription != null)
			ifcCrewResourceType.setLongDescription(this.LongDescription);
		if(this.ResourceType != null)
			ifcCrewResourceType.setResourceType(this.ResourceType);
		if(this.BaseCosts != null)
			ifcCrewResourceType.setBaseCosts(this.BaseCosts);
		if(this.BaseQuantity != null)
			ifcCrewResourceType.setBaseQuantity(this.BaseQuantity);
		if(this.PredefinedType != null)
			ifcCrewResourceType.setPredefinedType(this.PredefinedType);
		return ifcCrewResourceType;
	}
