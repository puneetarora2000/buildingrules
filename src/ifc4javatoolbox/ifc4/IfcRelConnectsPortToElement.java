...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcPort","IfcDistributionElement"};
	...
	* @param RelatedElement DEMANDED parameter of type IfcDistributionElement - may not be null.
	**/
	...
	* @param RelatedElement DEMANDED parameter of type IfcDistributionElement - may not be null.
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcPort RelatingPort, IfcDistributionElement RelatedElement)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.RelatedElement = (IfcDistributionElement) parameters.get(5);
		resolveInverses();
	}
	...
	**/
	...
	private void resolveInverses()
	{
		...
		{
				if(RelatingPort.ContainedIn_Inverse == null)
				{
					RelatingPort.ContainedIn_Inverse = new SET<IfcRelConnectsPortToElement>();
				}
				RelatingPort.ContainedIn_Inverse.add(this);
		}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.RelatedElement != null)		stepString = stepString.concat(((RootInterface)this.RelatedElement).getStepParameter(IfcDistributionElement.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	* @return the value of RelatingPort
	...
	private void synchronizeInversesRemoveRelatingPort(IfcPort RelatingPort)
	{
		if(RelatingPort != null)
		{
				if(RelatingPort.ContainedIn_Inverse != null)
				{
					RelatingPort.ContainedIn_Inverse.remove(this);
				}
		}
	}
	...
	* @return the value of RelatedElement
	...
	private void synchronizeInversesAddRelatedElement(IfcDistributionElement RelatedElement)
	{
		if(RelatedElement != null)
		{
				if(RelatedElement.HasPorts_Inverse == null)
	...
	private void synchronizeInversesRemoveRelatedElement(IfcDistributionElement RelatedElement)
	{
		if(RelatedElement != null)
		{
				if(RelatedElement.HasPorts_Inverse != null)
	...
	**/
	public Object clone()
	{
		...
		if(this.RelatedElement != null)
			ifcRelConnectsPortToElement.setRelatedElement((IfcDistributionElement)this.RelatedElement.clone());
