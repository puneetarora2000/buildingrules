...
/**
 * This is a default implementation of the entity IfcSurfaceFeature<br><br>
 *<br><br>
 ...
 */
public class IfcSurfaceFeature extends IfcFeatureElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcSurfaceFeatureTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcSurfaceFeature object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSurfaceFeatureTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcSurfaceFeature object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSurfaceFeatureTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcSurfaceFeatureTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSurfaceFeatureTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSurfaceFeature.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSURFACEFEATURE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcSurfaceFeatureTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	public Object clone()
	{
		IfcSurfaceFeature ifcSurfaceFeature = new IfcSurfaceFeature();
		if(this.GlobalId != null)
			ifcSurfaceFeature.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSurfaceFeature.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSurfaceFeature.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSurfaceFeature.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcSurfaceFeature.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcSurfaceFeature.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcSurfaceFeature.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcSurfaceFeature.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcSurfaceFeature.setPredefinedType((IfcSurfaceFeatureTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcSurfaceFeature ifcSurfaceFeature = new IfcSurfaceFeature();
		if(this.GlobalId != null)
			ifcSurfaceFeature.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSurfaceFeature.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSurfaceFeature.setName(this.Name);
		if(this.Description != null)
			ifcSurfaceFeature.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcSurfaceFeature.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcSurfaceFeature.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcSurfaceFeature.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcSurfaceFeature.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcSurfaceFeature.setPredefinedType(this.PredefinedType);
		return ifcSurfaceFeature;
	}
