...
/**
 * This is a default implementation of the entity IfcFootingType<br><br>
 *<br><br>
 ...
 */
public class IfcFootingType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcFootingTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcFootingType object using the given parameters.
	*
	...
	**/
	...
	/**
	 * This method initializes the IfcFootingType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcFootingTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcFootingType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFOOTINGTYPE(");
	...
	**/
	...
	public Object clone()
	{
		IfcFootingType ifcFootingType = new IfcFootingType();
		if(this.GlobalId != null)
			ifcFootingType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFootingType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFootingType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFootingType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcFootingType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcFootingType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcFootingType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcFootingType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcFootingType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcFootingType.setPredefinedType((IfcFootingTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFootingType ifcFootingType = new IfcFootingType();
		if(this.GlobalId != null)
			ifcFootingType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFootingType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFootingType.setName(this.Name);
		if(this.Description != null)
			ifcFootingType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcFootingType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcFootingType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcFootingType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcFootingType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcFootingType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcFootingType.setPredefinedType(this.PredefinedType);
		return ifcFootingType;
	}
