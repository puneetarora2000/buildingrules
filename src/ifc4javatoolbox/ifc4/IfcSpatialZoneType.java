...
/**
 * This is a default implementation of the entity IfcSpatialZoneType<br><br>
 *<br><br>
 ...
 */
public class IfcSpatialZoneType extends IfcSpatialElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcSpatialZoneTypeEnum","IfcLabel"};
	...
	**/
	...
	/**
	* Constructs a new IfcSpatialZoneType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcSpatialZoneTypeEnum - may not be null.
	...
	**/
	...
	/**
	 * This method initializes the IfcSpatialZoneType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSpatialZoneTypeEnum) parameters.get(9);
		this.LongName = (IfcLabel) parameters.get(10);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSpatialZoneType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSPATIALZONETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcSpatialZoneTypeEnum.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
	...
	**/
	...
	public Object clone()
	{
		IfcSpatialZoneType ifcSpatialZoneType = new IfcSpatialZoneType();
		if(this.GlobalId != null)
			ifcSpatialZoneType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSpatialZoneType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSpatialZoneType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSpatialZoneType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcSpatialZoneType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcSpatialZoneType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcSpatialZoneType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcSpatialZoneType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcSpatialZoneType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcSpatialZoneType.setPredefinedType((IfcSpatialZoneTypeEnum)this.PredefinedType.clone());
		if(this.LongName != null)
			ifcSpatialZoneType.setLongName((IfcLabel)this.LongName.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcSpatialZoneType ifcSpatialZoneType = new IfcSpatialZoneType();
		if(this.GlobalId != null)
			ifcSpatialZoneType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSpatialZoneType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSpatialZoneType.setName(this.Name);
		if(this.Description != null)
			ifcSpatialZoneType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcSpatialZoneType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcSpatialZoneType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcSpatialZoneType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcSpatialZoneType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcSpatialZoneType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcSpatialZoneType.setPredefinedType(this.PredefinedType);
		if(this.LongName != null)
			ifcSpatialZoneType.setLongName(this.LongName);
		return ifcSpatialZoneType;
	}
