...
/**
 * This is a default implementation of the entity IfcElectricDistributionBoardType<br><br>
 *<br><br>
 ...
 */
public class IfcElectricDistributionBoardType extends IfcFlowControllerType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcElectricDistributionBoardTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcElectricDistributionBoardType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcElectricDistributionBoardTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcElectricDistributionBoardType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcElectricDistributionBoardTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcElectricDistributionBoardType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCELECTRICDISTRIBUTIONBOARDTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcElectricDistributionBoardTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcElectricDistributionBoardType ifcElectricDistributionBoardType = new IfcElectricDistributionBoardType();
		if(this.GlobalId != null)
			ifcElectricDistributionBoardType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcElectricDistributionBoardType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcElectricDistributionBoardType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcElectricDistributionBoardType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcElectricDistributionBoardType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcElectricDistributionBoardType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcElectricDistributionBoardType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcElectricDistributionBoardType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcElectricDistributionBoardType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcElectricDistributionBoardType.setPredefinedType((IfcElectricDistributionBoardTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcElectricDistributionBoardType ifcElectricDistributionBoardType = new IfcElectricDistributionBoardType();
		if(this.GlobalId != null)
			ifcElectricDistributionBoardType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcElectricDistributionBoardType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcElectricDistributionBoardType.setName(this.Name);
		if(this.Description != null)
			ifcElectricDistributionBoardType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcElectricDistributionBoardType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcElectricDistributionBoardType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcElectricDistributionBoardType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcElectricDistributionBoardType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcElectricDistributionBoardType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcElectricDistributionBoardType.setPredefinedType(this.PredefinedType);
		return ifcElectricDistributionBoardType;
	}
