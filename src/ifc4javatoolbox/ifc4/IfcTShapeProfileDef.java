...
public class IfcTShapeProfileDef extends IfcParameterizedProfileDef implements ClassInterface
{
	...
	* @param FlangeEdgeRadius OPTIONAL parameter of type IfcNonNegativeLengthMeasure
	* @param WebEdgeRadius OPTIONAL parameter of type IfcNonNegativeLengthMeasure
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.FlangeEdgeRadius = (IfcNonNegativeLengthMeasure) parameters.get(8);
		this.WebEdgeRadius = (IfcNonNegativeLengthMeasure) parameters.get(9);
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.FlangeEdgeRadius != null)		stepString = stepString.concat(((RootInterface)this.FlangeEdgeRadius).getStepParameter(IfcNonNegativeLengthMeasure.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
		if(getRedefinedDerivedAttributeTypes().contains("WebEdgeRadius")) stepString = stepString.concat("*,");
		else{
		if(this.WebEdgeRadius != null)		stepString = stepString.concat(((RootInterface)this.WebEdgeRadius).getStepParameter(IfcNonNegativeLengthMeasure.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
	...
	**/
	public Object clone()
	{
		...
		if(this.FilletRadius != null)
			ifcTShapeProfileDef.setFilletRadius((IfcNonNegativeLengthMeasure)this.FilletRadius.clone());
		if(this.FlangeEdgeRadius != null)
			ifcTShapeProfileDef.setFlangeEdgeRadius((IfcNonNegativeLengthMeasure)this.FlangeEdgeRadius.clone());
		if(this.WebEdgeRadius != null)
			ifcTShapeProfileDef.setWebEdgeRadius((IfcNonNegativeLengthMeasure)this.WebEdgeRadius.clone());
