 ...
 */
public class IfcMechanicalFastenerType extends IfcElementComponentType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcMechanicalFastenerTypeEnum","IfcPositiveLengthMeasure","IfcPositiveLengthMeasure"};
	...
	* @param PredefinedType DEMANDED parameter of type IfcMechanicalFastenerTypeEnum - may not be null.
	...
	**/
	...
	/**
	 * This method initializes the IfcMechanicalFastenerType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcMechanicalFastenerTypeEnum) parameters.get(9);
		this.NominalDiameter = (IfcPositiveLengthMeasure) parameters.get(10);
		this.NominalLength = (IfcPositiveLengthMeasure) parameters.get(11);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcMechanicalFastenerTypeEnum.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.ApplicableOccurrence != null)
			ifcMechanicalFastenerType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		...
		if(this.PredefinedType != null)
			ifcMechanicalFastenerType.setPredefinedType((IfcMechanicalFastenerTypeEnum)this.PredefinedType.clone());
		if(this.NominalDiameter != null)
			ifcMechanicalFastenerType.setNominalDiameter((IfcPositiveLengthMeasure)this.NominalDiameter.clone());
		if(this.NominalLength != null)
			ifcMechanicalFastenerType.setNominalLength((IfcPositiveLengthMeasure)this.NominalLength.clone());
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.PredefinedType != null)
			ifcMechanicalFastenerType.setPredefinedType(this.PredefinedType);
		if(this.NominalDiameter != null)
			ifcMechanicalFastenerType.setNominalDiameter(this.NominalDiameter);
		if(this.NominalLength != null)
			ifcMechanicalFastenerType.setNominalLength(this.NominalLength);
		return ifcMechanicalFastenerType;
	}
