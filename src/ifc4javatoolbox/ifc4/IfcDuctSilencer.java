...
/**
 * This is a default implementation of the entity IfcDuctSilencer<br><br>
 *<br><br>
 ...
 */
public class IfcDuctSilencer extends IfcFlowTreatmentDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcDuctSilencerTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcDuctSilencer object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcDuctSilencerTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcDuctSilencer object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcDuctSilencerTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcDuctSilencerTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcDuctSilencerTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcDuctSilencer.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCDUCTSILENCER(");
	...
	**/
	public Object clone()
	{
		IfcDuctSilencer ifcDuctSilencer = new IfcDuctSilencer();
		if(this.GlobalId != null)
			ifcDuctSilencer.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcDuctSilencer.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcDuctSilencer.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcDuctSilencer.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcDuctSilencer.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcDuctSilencer.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcDuctSilencer.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcDuctSilencer.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcDuctSilencer.setPredefinedType((IfcDuctSilencerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcDuctSilencer ifcDuctSilencer = new IfcDuctSilencer();
		if(this.GlobalId != null)
			ifcDuctSilencer.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcDuctSilencer.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcDuctSilencer.setName(this.Name);
		if(this.Description != null)
			ifcDuctSilencer.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcDuctSilencer.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcDuctSilencer.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcDuctSilencer.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcDuctSilencer.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcDuctSilencer.setPredefinedType(this.PredefinedType);
		return ifcDuctSilencer;
	}
