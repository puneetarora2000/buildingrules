 ...
 */
public abstract class IfcTimeSeries extends InternalAccessClass implements IfcObjectReferenceSelect, IfcMetricValueSelect, IfcResourceObjectSelect, ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcLabel","IfcText","IfcDateTime","IfcDateTime","IfcTimeSeriesDataTypeEnum","IfcDataOriginEnum","IfcLabel","IfcUnit"};
	...
	* @param Unit OPTIONAL parameter of type IfcUnit
	**/
	public void setParameters(IfcLabel Name, IfcText Description, IfcDateTime StartTime, IfcDateTime EndTime, IfcTimeSeriesDataTypeEnum TimeSeriesDataType, IfcDataOriginEnum DataOrigin, IfcLabel UserDefinedDataOrigin, IfcUnit Unit)
	{
		this.Name = Name;
		this.Description = Description;
		this.StartTime = StartTime;
