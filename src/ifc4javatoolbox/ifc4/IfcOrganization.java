 ...
 */
public class IfcOrganization extends InternalAccessClass implements IfcActorSelect, IfcObjectReferenceSelect, IfcResourceObjectSelect, ClassInterface
{
	...
	* @param Addresses OPTIONAL parameter of type LIST<IfcAddress>
	**/
	public void setParameters(IfcIdentifier Identification, IfcLabel Name, IfcText Description, LIST<IfcActorRole> Roles, LIST<IfcAddress> Addresses)
	{
		this.Identification = Identification;
		this.Name = Name;
		this.Description = Description;
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.Identification != null)
			ifcOrganization.setIdentification((IfcIdentifier)this.Identification.clone());
		if(this.Name != null)
	...
	**/
	public Object shallowCopy()
	{
		IfcOrganization ifcOrganization = new IfcOrganization();
		if(this.Identification != null)
			ifcOrganization.setIdentification(this.Identification);
		if(this.Name != null)
