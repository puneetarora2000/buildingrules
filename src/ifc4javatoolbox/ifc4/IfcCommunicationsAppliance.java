...
/**
 * This is a default implementation of the entity IfcCommunicationsAppliance<br><br>
 *<br><br>
 ...
 */
public class IfcCommunicationsAppliance extends IfcFlowTerminal implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcCommunicationsApplianceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcCommunicationsAppliance object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCommunicationsApplianceTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcCommunicationsAppliance object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCommunicationsApplianceTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcCommunicationsApplianceTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCommunicationsApplianceTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCommunicationsAppliance.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCOMMUNICATIONSAPPLIANCE(");
	...
	**/
	public Object clone()
	{
		IfcCommunicationsAppliance ifcCommunicationsAppliance = new IfcCommunicationsAppliance();
		if(this.GlobalId != null)
			ifcCommunicationsAppliance.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCommunicationsAppliance.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCommunicationsAppliance.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCommunicationsAppliance.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcCommunicationsAppliance.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcCommunicationsAppliance.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcCommunicationsAppliance.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcCommunicationsAppliance.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcCommunicationsAppliance.setPredefinedType((IfcCommunicationsApplianceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCommunicationsAppliance ifcCommunicationsAppliance = new IfcCommunicationsAppliance();
		if(this.GlobalId != null)
			ifcCommunicationsAppliance.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCommunicationsAppliance.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCommunicationsAppliance.setName(this.Name);
		if(this.Description != null)
			ifcCommunicationsAppliance.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcCommunicationsAppliance.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcCommunicationsAppliance.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcCommunicationsAppliance.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcCommunicationsAppliance.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcCommunicationsAppliance.setPredefinedType(this.PredefinedType);
		return ifcCommunicationsAppliance;
	}
