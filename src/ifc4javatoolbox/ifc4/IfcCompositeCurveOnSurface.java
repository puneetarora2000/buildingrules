...
/**
 * This is a default implementation of the entity IfcCompositeCurveOnSurface<br><br>
 *<br><br>
 ...
 */
public class IfcCompositeCurveOnSurface extends IfcCompositeCurve implements IfcCurveOnSurface, ClassInterface
{
	...
	**/
	...
	/**
	* Constructs a new IfcCompositeCurveOnSurface object using the given parameters.
	*
	...
	**/
	public IfcCompositeCurveOnSurface(LIST<IfcCompositeCurveSegment> Segments, LOGICAL SelfIntersect)
	{
	...
	**/
	...
	{
		return IfcCompositeCurveOnSurface.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCOMPOSITECURVEONSURFACE(");
	...
	**/
	...
	public Object clone()
	{
		IfcCompositeCurveOnSurface ifcCompositeCurveOnSurface = new IfcCompositeCurveOnSurface();
		if(this.Segments != null)
			ifcCompositeCurveOnSurface.setSegments((LIST<IfcCompositeCurveSegment>)this.Segments.clone());
		if(this.SelfIntersect != null)
			ifcCompositeCurveOnSurface.setSelfIntersect((LOGICAL)this.SelfIntersect.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCompositeCurveOnSurface ifcCompositeCurveOnSurface = new IfcCompositeCurveOnSurface();
		if(this.Segments != null)
			ifcCompositeCurveOnSurface.setSegments(this.Segments);
		if(this.SelfIntersect != null)
			ifcCompositeCurveOnSurface.setSelfIntersect(this.SelfIntersect);
		return ifcCompositeCurveOnSurface;
	}
