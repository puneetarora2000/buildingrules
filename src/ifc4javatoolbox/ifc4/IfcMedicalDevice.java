...
/**
 * This is a default implementation of the entity IfcMedicalDevice<br><br>
 *<br><br>
 ...
 */
public class IfcMedicalDevice extends IfcFlowTerminal implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcMedicalDeviceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcMedicalDevice object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcMedicalDeviceTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcMedicalDevice object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcMedicalDeviceTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcMedicalDeviceTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcMedicalDeviceTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcMedicalDevice.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCMEDICALDEVICE(");
	...
	**/
	public Object clone()
	{
		IfcMedicalDevice ifcMedicalDevice = new IfcMedicalDevice();
		if(this.GlobalId != null)
			ifcMedicalDevice.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcMedicalDevice.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcMedicalDevice.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcMedicalDevice.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcMedicalDevice.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcMedicalDevice.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcMedicalDevice.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcMedicalDevice.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcMedicalDevice.setPredefinedType((IfcMedicalDeviceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcMedicalDevice ifcMedicalDevice = new IfcMedicalDevice();
		if(this.GlobalId != null)
			ifcMedicalDevice.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcMedicalDevice.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcMedicalDevice.setName(this.Name);
		if(this.Description != null)
			ifcMedicalDevice.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcMedicalDevice.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcMedicalDevice.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcMedicalDevice.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcMedicalDevice.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcMedicalDevice.setPredefinedType(this.PredefinedType);
		return ifcMedicalDevice;
	}
