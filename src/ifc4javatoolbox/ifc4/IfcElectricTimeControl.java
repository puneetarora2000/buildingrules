...
/**
 * This is a default implementation of the entity IfcElectricTimeControl<br><br>
 *<br><br>
 ...
 */
public class IfcElectricTimeControl extends IfcFlowController implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcElectricTimeControlTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcElectricTimeControl object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcElectricTimeControlTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcElectricTimeControl object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcElectricTimeControlTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcElectricTimeControlTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcElectricTimeControlTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcElectricTimeControl.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCELECTRICTIMECONTROL(");
	...
	**/
	public Object clone()
	{
		IfcElectricTimeControl ifcElectricTimeControl = new IfcElectricTimeControl();
		if(this.GlobalId != null)
			ifcElectricTimeControl.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcElectricTimeControl.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcElectricTimeControl.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcElectricTimeControl.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcElectricTimeControl.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcElectricTimeControl.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcElectricTimeControl.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcElectricTimeControl.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcElectricTimeControl.setPredefinedType((IfcElectricTimeControlTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcElectricTimeControl ifcElectricTimeControl = new IfcElectricTimeControl();
		if(this.GlobalId != null)
			ifcElectricTimeControl.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcElectricTimeControl.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcElectricTimeControl.setName(this.Name);
		if(this.Description != null)
			ifcElectricTimeControl.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcElectricTimeControl.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcElectricTimeControl.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcElectricTimeControl.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcElectricTimeControl.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcElectricTimeControl.setPredefinedType(this.PredefinedType);
		return ifcElectricTimeControl;
	}
