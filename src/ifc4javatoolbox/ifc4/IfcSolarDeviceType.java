...
/**
 * This is a default implementation of the entity IfcSolarDeviceType<br><br>
 *<br><br>
 ...
 */
public class IfcSolarDeviceType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcSolarDeviceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcSolarDeviceType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcSolarDeviceTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcSolarDeviceType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSolarDeviceTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSolarDeviceType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSOLARDEVICETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcSolarDeviceTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcSolarDeviceType ifcSolarDeviceType = new IfcSolarDeviceType();
		if(this.GlobalId != null)
			ifcSolarDeviceType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSolarDeviceType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSolarDeviceType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSolarDeviceType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcSolarDeviceType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcSolarDeviceType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcSolarDeviceType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcSolarDeviceType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcSolarDeviceType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcSolarDeviceType.setPredefinedType((IfcSolarDeviceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcSolarDeviceType ifcSolarDeviceType = new IfcSolarDeviceType();
		if(this.GlobalId != null)
			ifcSolarDeviceType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSolarDeviceType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSolarDeviceType.setName(this.Name);
		if(this.Description != null)
			ifcSolarDeviceType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcSolarDeviceType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcSolarDeviceType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcSolarDeviceType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcSolarDeviceType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcSolarDeviceType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcSolarDeviceType.setPredefinedType(this.PredefinedType);
		return ifcSolarDeviceType;
	}
