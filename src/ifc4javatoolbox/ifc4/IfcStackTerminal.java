...
/**
 * This is a default implementation of the entity IfcStackTerminal<br><br>
 *<br><br>
 ...
 */
public class IfcStackTerminal extends IfcFlowTerminal implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcStackTerminalTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcStackTerminal object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcStackTerminalTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcStackTerminal object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcStackTerminalTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcStackTerminalTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcStackTerminalTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcStackTerminal.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSTACKTERMINAL(");
	...
	**/
	public Object clone()
	{
		IfcStackTerminal ifcStackTerminal = new IfcStackTerminal();
		if(this.GlobalId != null)
			ifcStackTerminal.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcStackTerminal.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcStackTerminal.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcStackTerminal.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcStackTerminal.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcStackTerminal.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcStackTerminal.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcStackTerminal.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcStackTerminal.setPredefinedType((IfcStackTerminalTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcStackTerminal ifcStackTerminal = new IfcStackTerminal();
		if(this.GlobalId != null)
			ifcStackTerminal.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcStackTerminal.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcStackTerminal.setName(this.Name);
		if(this.Description != null)
			ifcStackTerminal.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcStackTerminal.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcStackTerminal.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcStackTerminal.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcStackTerminal.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcStackTerminal.setPredefinedType(this.PredefinedType);
		return ifcStackTerminal;
	}
