...
/**
 * This is a default implementation of the entity IfcAdvancedBrepWithVoids<br><br>
 *<br><br>
 ...
 */
public class IfcAdvancedBrepWithVoids extends IfcAdvancedBrep implements ClassInterface
{
	...
	**/
	...
	/**
	* Constructs a new IfcAdvancedBrepWithVoids object using the given parameters.
	*
	...
	**/
	public IfcAdvancedBrepWithVoids(IfcClosedShell Outer, SET<IfcClosedShell> Voids)
	{
		this.Outer = Outer;
		this.Voids = Voids;
		resolveInverses();
	...
	/**
	 * This method initializes the IfcAdvancedBrepWithVoids object using the given parameters.
	*
	* @param Outer DEMANDED parameter of type IfcClosedShell - may not be null.
	* @param Voids DEMANDED parameter of type SET<IfcClosedShell> - may not be null.
	**/
	...
	**/
	...
	{
		return IfcAdvancedBrepWithVoids.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCADVANCEDBREPWITHVOIDS(");
	...
	**/
	...
	public Object clone()
	{
		IfcAdvancedBrepWithVoids ifcAdvancedBrepWithVoids = new IfcAdvancedBrepWithVoids();
		if(this.Outer != null)
			ifcAdvancedBrepWithVoids.setOuter((IfcClosedShell)this.Outer.clone());
		if(this.Voids != null)
			ifcAdvancedBrepWithVoids.setVoids((SET<IfcClosedShell>)this.Voids.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcAdvancedBrepWithVoids ifcAdvancedBrepWithVoids = new IfcAdvancedBrepWithVoids();
		if(this.Outer != null)
			ifcAdvancedBrepWithVoids.setOuter(this.Outer);
		if(this.Voids != null)
			ifcAdvancedBrepWithVoids.setVoids(this.Voids);
		return ifcAdvancedBrepWithVoids;
	}
