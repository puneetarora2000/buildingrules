...
/**
 * This is a default implementation of the entity IfcFlowInstrument<br><br>
 *<br><br>
 ...
 */
public class IfcFlowInstrument extends IfcDistributionControlElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcFlowInstrumentTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcFlowInstrument object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcFlowInstrumentTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcFlowInstrument object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcFlowInstrumentTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcFlowInstrumentTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcFlowInstrumentTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcFlowInstrument.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFLOWINSTRUMENT(");
	...
	**/
	public Object clone()
	{
		IfcFlowInstrument ifcFlowInstrument = new IfcFlowInstrument();
		if(this.GlobalId != null)
			ifcFlowInstrument.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFlowInstrument.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFlowInstrument.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFlowInstrument.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFlowInstrument.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFlowInstrument.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFlowInstrument.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFlowInstrument.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcFlowInstrument.setPredefinedType((IfcFlowInstrumentTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcFlowInstrument ifcFlowInstrument = new IfcFlowInstrument();
		if(this.GlobalId != null)
			ifcFlowInstrument.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFlowInstrument.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFlowInstrument.setName(this.Name);
		if(this.Description != null)
			ifcFlowInstrument.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFlowInstrument.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFlowInstrument.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFlowInstrument.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFlowInstrument.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcFlowInstrument.setPredefinedType(this.PredefinedType);
		return ifcFlowInstrument;
	}
