...
/**
 * This is a default implementation of the entity IfcBoiler<br><br>
 *<br><br>
 ...
 */
public class IfcBoiler extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcBoilerTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcBoiler object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcBoilerTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcBoiler object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcBoilerTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcBoilerTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcBoilerTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcBoiler.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCBOILER(");
	...
	**/
	public Object clone()
	{
		IfcBoiler ifcBoiler = new IfcBoiler();
		if(this.GlobalId != null)
			ifcBoiler.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcBoiler.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcBoiler.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcBoiler.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcBoiler.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcBoiler.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcBoiler.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcBoiler.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcBoiler.setPredefinedType((IfcBoilerTypeEnum)this.PredefinedType.clone());
		return ifcBoiler;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcBoiler ifcBoiler = new IfcBoiler();
		if(this.GlobalId != null)
			ifcBoiler.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcBoiler.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcBoiler.setName(this.Name);
		if(this.Description != null)
			ifcBoiler.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcBoiler.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcBoiler.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcBoiler.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcBoiler.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcBoiler.setPredefinedType(this.PredefinedType);
		return ifcBoiler;
	}
