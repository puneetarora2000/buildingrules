...
/**
 * This is a default implementation of the entity IfcChimney<br><br>
 *<br><br>
 ...
 */
public class IfcChimney extends IfcBuildingElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcChimneyTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcChimney object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcChimneyTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcChimney object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcChimneyTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcChimneyTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcChimneyTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcChimney.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCHIMNEY(");
	...
	**/
	public Object clone()
	{
		IfcChimney ifcChimney = new IfcChimney();
		if(this.GlobalId != null)
			ifcChimney.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcChimney.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcChimney.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcChimney.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcChimney.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcChimney.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcChimney.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcChimney.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcChimney.setPredefinedType((IfcChimneyTypeEnum)this.PredefinedType.clone());
		return ifcChimney;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcChimney ifcChimney = new IfcChimney();
		if(this.GlobalId != null)
			ifcChimney.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcChimney.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcChimney.setName(this.Name);
		if(this.Description != null)
			ifcChimney.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcChimney.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcChimney.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcChimney.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcChimney.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcChimney.setPredefinedType(this.PredefinedType);
		return ifcChimney;
	}
