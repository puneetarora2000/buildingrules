...
/**
 * This is a default implementation of the entity IfcBurner<br><br>
 *<br><br>
 ...
 */
public class IfcBurner extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcBurnerTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcBurner object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcBurnerTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcBurner object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcBurnerTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcBurnerTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcBurnerTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcBurner.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCBURNER(");
	...
	**/
	public Object clone()
	{
		IfcBurner ifcBurner = new IfcBurner();
		if(this.GlobalId != null)
			ifcBurner.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcBurner.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcBurner.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcBurner.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcBurner.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcBurner.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcBurner.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcBurner.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcBurner.setPredefinedType((IfcBurnerTypeEnum)this.PredefinedType.clone());
		return ifcBurner;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcBurner ifcBurner = new IfcBurner();
		if(this.GlobalId != null)
			ifcBurner.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcBurner.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcBurner.setName(this.Name);
		if(this.Description != null)
			ifcBurner.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcBurner.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcBurner.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcBurner.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcBurner.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcBurner.setPredefinedType(this.PredefinedType);
		return ifcBurner;
	}
