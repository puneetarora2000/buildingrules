...
/**
 * This is a default implementation of the entity IfcMemberStandardCase<br><br>
 *<br><br>
 ...
 */
public class IfcMemberStandardCase extends IfcMember implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcMemberTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcMemberStandardCase object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcMemberTypeEnum
	**/
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcMemberTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcMemberStandardCase.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCMEMBERSTANDARDCASE(");
	...
	**/
	public Object clone()
	{
		IfcMemberStandardCase ifcMemberStandardCase = new IfcMemberStandardCase();
		if(this.GlobalId != null)
			ifcMemberStandardCase.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcMemberStandardCase.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcMemberStandardCase.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcMemberStandardCase.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcMemberStandardCase.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcMemberStandardCase.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcMemberStandardCase.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcMemberStandardCase.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcMemberStandardCase.setPredefinedType((IfcMemberTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcMemberStandardCase ifcMemberStandardCase = new IfcMemberStandardCase();
		if(this.GlobalId != null)
			ifcMemberStandardCase.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcMemberStandardCase.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcMemberStandardCase.setName(this.Name);
		if(this.Description != null)
			ifcMemberStandardCase.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcMemberStandardCase.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcMemberStandardCase.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcMemberStandardCase.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcMemberStandardCase.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcMemberStandardCase.setPredefinedType(this.PredefinedType);
		return ifcMemberStandardCase;
	}
