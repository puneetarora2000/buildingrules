...
/**
 * This is a default implementation of the entity IfcTank<br><br>
 *<br><br>
 ...
 */
public class IfcTank extends IfcFlowStorageDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcTankTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcTank object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcTankTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcTank object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcTankTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcTankTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcTankTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcTank.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCTANK(");
	...
	**/
	public Object clone()
	{
		IfcTank ifcTank = new IfcTank();
		if(this.GlobalId != null)
			ifcTank.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcTank.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcTank.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcTank.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcTank.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcTank.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcTank.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcTank.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcTank.setPredefinedType((IfcTankTypeEnum)this.PredefinedType.clone());
		return ifcTank;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcTank ifcTank = new IfcTank();
		if(this.GlobalId != null)
			ifcTank.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcTank.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcTank.setName(this.Name);
		if(this.Description != null)
			ifcTank.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcTank.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcTank.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcTank.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcTank.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcTank.setPredefinedType(this.PredefinedType);
		return ifcTank;
	}
