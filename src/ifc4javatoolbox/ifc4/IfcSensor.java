...
/**
 * This is a default implementation of the entity IfcSensor<br><br>
 *<br><br>
 ...
 */
public class IfcSensor extends IfcDistributionControlElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcSensorTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcSensor object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSensorTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcSensor object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSensorTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcSensorTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSensorTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSensor.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSENSOR(");
	...
	**/
	public Object clone()
	{
		IfcSensor ifcSensor = new IfcSensor();
		if(this.GlobalId != null)
			ifcSensor.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSensor.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSensor.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSensor.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcSensor.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcSensor.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcSensor.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcSensor.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcSensor.setPredefinedType((IfcSensorTypeEnum)this.PredefinedType.clone());
		return ifcSensor;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcSensor ifcSensor = new IfcSensor();
		if(this.GlobalId != null)
			ifcSensor.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSensor.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSensor.setName(this.Name);
		if(this.Description != null)
			ifcSensor.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcSensor.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcSensor.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcSensor.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcSensor.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcSensor.setPredefinedType(this.PredefinedType);
		return ifcSensor;
	}
