...
/**
 * This is a default implementation of the entity IfcActuator<br><br>
 *<br><br>
 ...
 */
public class IfcActuator extends IfcDistributionControlElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcActuatorTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcActuator object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcActuatorTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcActuator object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcActuatorTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcActuatorTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcActuatorTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcActuator.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCACTUATOR(");
	...
	**/
	public Object clone()
	{
		IfcActuator ifcActuator = new IfcActuator();
		if(this.GlobalId != null)
			ifcActuator.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcActuator.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcActuator.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcActuator.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcActuator.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcActuator.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcActuator.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcActuator.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcActuator.setPredefinedType((IfcActuatorTypeEnum)this.PredefinedType.clone());
		return ifcActuator;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcActuator ifcActuator = new IfcActuator();
		if(this.GlobalId != null)
			ifcActuator.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcActuator.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcActuator.setName(this.Name);
		if(this.Description != null)
			ifcActuator.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcActuator.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcActuator.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcActuator.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcActuator.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcActuator.setPredefinedType(this.PredefinedType);
		return ifcActuator;
	}
