...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcProfileTypeEnum","IfcLabel","IfcAxis2Placement2D","IfcPositiveLengthMeasure","IfcPositiveLengthMeasure","IfcPositiveLengthMeasure","IfcPositiveLengthMeasure","IfcNonNegativeLengthMeasure"};
	...
	* @param InternalFilletRadius OPTIONAL parameter of type IfcNonNegativeLengthMeasure
	**/
	...
	* @param InternalFilletRadius OPTIONAL parameter of type IfcNonNegativeLengthMeasure
	**/
	public void setParameters(IfcProfileTypeEnum ProfileType, IfcLabel ProfileName, IfcAxis2Placement2D Position, IfcPositiveLengthMeasure Depth, IfcPositiveLengthMeasure Width, IfcPositiveLengthMeasure WallThickness, IfcPositiveLengthMeasure Girth, IfcNonNegativeLengthMeasure InternalFilletRadius)
	{
		this.ProfileType = ProfileType;
		this.ProfileName = ProfileName;
		this.Position = Position;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.InternalFilletRadius = (IfcNonNegativeLengthMeasure) parameters.get(7);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.InternalFilletRadius != null)		stepString = stepString.concat(((RootInterface)this.InternalFilletRadius).getStepParameter(IfcNonNegativeLengthMeasure.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	public Object clone()
	{
		...
		if(this.InternalFilletRadius != null)
			ifcCShapeProfileDef.setInternalFilletRadius((IfcNonNegativeLengthMeasure)this.InternalFilletRadius.clone());
