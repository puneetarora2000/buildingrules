...
/**
 * This is a default implementation of the entity IfcPileType<br><br>
 *<br><br>
 ...
 */
public class IfcPileType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcPileTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcPileType object using the given parameters.
	*
	...
	**/
	public IfcPileType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcIdentifier ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcPileTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcPileType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcPileTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcPileType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPILETYPE(");
	...
	**/
	...
	public Object clone()
	{
		IfcPileType ifcPileType = new IfcPileType();
		if(this.GlobalId != null)
			ifcPileType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcPileType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcPileType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcPileType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcPileType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcPileType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcPileType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcPileType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcPileType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcPileType.setPredefinedType((IfcPileTypeEnum)this.PredefinedType.clone());
		return ifcPileType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcPileType ifcPileType = new IfcPileType();
		if(this.GlobalId != null)
			ifcPileType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcPileType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcPileType.setName(this.Name);
		if(this.Description != null)
			ifcPileType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcPileType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcPileType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcPileType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcPileType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcPileType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcPileType.setPredefinedType(this.PredefinedType);
		return ifcPileType;
	}
