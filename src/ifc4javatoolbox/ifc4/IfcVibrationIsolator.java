...
/**
 * This is a default implementation of the entity IfcVibrationIsolator<br><br>
 *<br><br>
 ...
 */
public class IfcVibrationIsolator extends IfcElementComponent implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcVibrationIsolatorTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcVibrationIsolator object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcVibrationIsolatorTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcVibrationIsolator object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcVibrationIsolatorTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcVibrationIsolatorTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcVibrationIsolatorTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcVibrationIsolator.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCVIBRATIONISOLATOR(");
	...
	**/
	public Object clone()
	{
		IfcVibrationIsolator ifcVibrationIsolator = new IfcVibrationIsolator();
		if(this.GlobalId != null)
			ifcVibrationIsolator.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcVibrationIsolator.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcVibrationIsolator.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcVibrationIsolator.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcVibrationIsolator.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcVibrationIsolator.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcVibrationIsolator.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcVibrationIsolator.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcVibrationIsolator.setPredefinedType((IfcVibrationIsolatorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcVibrationIsolator ifcVibrationIsolator = new IfcVibrationIsolator();
		if(this.GlobalId != null)
			ifcVibrationIsolator.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcVibrationIsolator.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcVibrationIsolator.setName(this.Name);
		if(this.Description != null)
			ifcVibrationIsolator.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcVibrationIsolator.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcVibrationIsolator.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcVibrationIsolator.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcVibrationIsolator.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcVibrationIsolator.setPredefinedType(this.PredefinedType);
		return ifcVibrationIsolator;
	}
