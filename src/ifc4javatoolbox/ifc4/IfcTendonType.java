...
/**
 * This is a default implementation of the entity IfcTendonType<br><br>
 *<br><br>
 ...
 */
public class IfcTendonType extends IfcReinforcingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcTendonTypeEnum","IfcPositiveLengthMeasure","IfcAreaMeasure","IfcPositiveLengthMeasure"};
	...
	/** SheethDiameter is an OPTIONAL attribute**/
	protected IfcPositiveLengthMeasure SheethDiameter;
	/**
	...
	**/
	...
	/**
	* Constructs a new IfcTendonType object using the given parameters.
	*
	...
	**/
	public IfcTendonType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcIdentifier ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcTendonTypeEnum PredefinedType, IfcPositiveLengthMeasure NominalDiameter, IfcAreaMeasure CrossSectionArea, IfcPositiveLengthMeasure SheethDiameter)
	{
		...
		this.SheethDiameter = SheethDiameter;
		resolveInverses();
	}

	/**
	 * This method initializes the IfcTendonType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.SheethDiameter = (IfcPositiveLengthMeasure) parameters.get(12);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcTendonType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCTENDONTYPE(");
		...
		if(getRedefinedDerivedAttributeTypes().contains("SheethDiameter")) stepString = stepString.concat("*);");
		else{
		if(this.SheethDiameter != null)		stepString = stepString.concat(((RootInterface)this.SheethDiameter).getStepParameter(IfcPositiveLengthMeasure.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	* @return the value of CrossSectionArea
	...
	/**
	* This method sets the SheethDiameter attribute to the given value.
	*
	* @param SheethDiameter DEMANDED value to set - may not be null
	**/
	public void setSheethDiameter(IfcPositiveLengthMeasure SheethDiameter)
	{
		this.SheethDiameter = SheethDiameter;
		fireChangeEvent();
	}
	...
	/**
	* This method returns the value of the SheethDiameter attribute.
	*
	* @return the value of SheethDiameter
	/**/
	public IfcPositiveLengthMeasure getSheethDiameter()
	{
		return this.SheethDiameter;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcTendonType ifcTendonType = new IfcTendonType();
		if(this.GlobalId != null)
			ifcTendonType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcTendonType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcTendonType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcTendonType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcTendonType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcTendonType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcTendonType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcTendonType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcTendonType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcTendonType.setPredefinedType((IfcTendonTypeEnum)this.PredefinedType.clone());
		if(this.NominalDiameter != null)
			ifcTendonType.setNominalDiameter((IfcPositiveLengthMeasure)this.NominalDiameter.clone());
		if(this.CrossSectionArea != null)
			ifcTendonType.setCrossSectionArea((IfcAreaMeasure)this.CrossSectionArea.clone());
		if(this.SheethDiameter != null)
			ifcTendonType.setSheethDiameter((IfcPositiveLengthMeasure)this.SheethDiameter.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcTendonType ifcTendonType = new IfcTendonType();
		if(this.GlobalId != null)
			ifcTendonType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcTendonType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcTendonType.setName(this.Name);
		if(this.Description != null)
			ifcTendonType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcTendonType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcTendonType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcTendonType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcTendonType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcTendonType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcTendonType.setPredefinedType(this.PredefinedType);
		if(this.NominalDiameter != null)
			ifcTendonType.setNominalDiameter(this.NominalDiameter);
		if(this.CrossSectionArea != null)
			ifcTendonType.setCrossSectionArea(this.CrossSectionArea);
		if(this.SheethDiameter != null)
			ifcTendonType.setSheethDiameter(this.SheethDiameter);
		return ifcTendonType;
	}
