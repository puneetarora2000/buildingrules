...
/**
 * This is a default implementation of the entity IfcFilter<br><br>
 *<br><br>
 ...
 */
public class IfcFilter extends IfcFlowTreatmentDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcFilterTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcFilter object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcFilterTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcFilter object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcFilterTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcFilterTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcFilterTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcFilter.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFILTER(");
	...
	**/
	public Object clone()
	{
		IfcFilter ifcFilter = new IfcFilter();
		if(this.GlobalId != null)
			ifcFilter.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFilter.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFilter.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFilter.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFilter.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFilter.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFilter.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFilter.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcFilter.setPredefinedType((IfcFilterTypeEnum)this.PredefinedType.clone());
		return ifcFilter;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcFilter ifcFilter = new IfcFilter();
		if(this.GlobalId != null)
			ifcFilter.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFilter.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFilter.setName(this.Name);
		if(this.Description != null)
			ifcFilter.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFilter.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFilter.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFilter.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFilter.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcFilter.setPredefinedType(this.PredefinedType);
		return ifcFilter;
	}
