...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcProfileTypeEnum","IfcLabel","IfcAxis2Placement2D","IfcPositiveLengthMeasure","IfcPositiveLengthMeasure","IfcPositiveLengthMeasure","IfcPositiveLengthMeasure","IfcNonNegativeLengthMeasure","IfcNonNegativeLengthMeasure","IfcPlaneAngleMeasure"};
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public Object clone()
	{
		...
		if(this.FilletRadius != null)
			ifcIShapeProfileDef.setFilletRadius((IfcNonNegativeLengthMeasure)this.FilletRadius.clone());
		if(this.FlangeEdgeRadius != null)
			ifcIShapeProfileDef.setFlangeEdgeRadius((IfcNonNegativeLengthMeasure)this.FlangeEdgeRadius.clone());
		if(this.FlangeSlope != null)
			ifcIShapeProfileDef.setFlangeSlope((IfcPlaneAngleMeasure)this.FlangeSlope.clone());
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.FlangeEdgeRadius != null)
			ifcIShapeProfileDef.setFlangeEdgeRadius(this.FlangeEdgeRadius);
		if(this.FlangeSlope != null)
			ifcIShapeProfileDef.setFlangeSlope(this.FlangeSlope);
		return ifcIShapeProfileDef;
	}
