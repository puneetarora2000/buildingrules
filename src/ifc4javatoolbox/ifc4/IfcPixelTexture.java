...
{
	private static final String[] nonInverseAttributes = new String[]{"BOOLEAN","BOOLEAN","IfcIdentifier","IfcCartesianTransformationOperator2D","LIST<IfcIdentifier>","IfcInteger","IfcInteger","IfcInteger","LIST<BINARY>"};
	...
	**/
	public IfcPixelTexture(BOOLEAN RepeatS, BOOLEAN RepeatT, IfcIdentifier Mode, IfcCartesianTransformationOperator2D TextureTransform, LIST<IfcIdentifier> Parameter, IfcInteger Width, IfcInteger Height, IfcInteger ColourComponents, LIST<BINARY> Pixel)
	{
	...
	* @param Pixel DEMANDED parameter of type LIST<BINARY> - may not be null.
	**/
	public void setParameters(BOOLEAN RepeatS, BOOLEAN RepeatT, IfcIdentifier Mode, IfcCartesianTransformationOperator2D TextureTransform, LIST<IfcIdentifier> Parameter, IfcInteger Width, IfcInteger Height, IfcInteger ColourComponents, LIST<BINARY> Pixel)
	{
		this.RepeatS = RepeatS;
		this.RepeatT = RepeatT;
		this.Mode = Mode;
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.Width = (IfcInteger) parameters.get(5);
		this.Height = (IfcInteger) parameters.get(6);
		this.ColourComponents = (IfcInteger) parameters.get(7);
		this.Pixel = (LIST<BINARY>) parameters.get(8);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.Mode != null)
			ifcPixelTexture.setMode((IfcIdentifier)this.Mode.clone());
		...
		if(this.Parameter != null)
			ifcPixelTexture.setParameter((LIST<IfcIdentifier>)this.Parameter.clone());
		if(this.Width != null)
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.Mode != null)
			ifcPixelTexture.setMode(this.Mode);
		if(this.TextureTransform != null)
			ifcPixelTexture.setTextureTransform(this.TextureTransform);
		if(this.Parameter != null)
			ifcPixelTexture.setParameter(this.Parameter);
		if(this.Width != null)
