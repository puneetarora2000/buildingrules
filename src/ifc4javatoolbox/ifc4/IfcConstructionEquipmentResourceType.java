...
/**
 * This is a default implementation of the entity IfcConstructionEquipmentResourceType<br><br>
 *<br><br>
 ...
 */
public class IfcConstructionEquipmentResourceType extends IfcConstructionResourceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","IfcIdentifier","IfcText","IfcLabel","LIST<IfcAppliedValue>","IfcPhysicalQuantity","IfcConstructionEquipmentResourceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcConstructionEquipmentResourceType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcConstructionEquipmentResourceTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcConstructionEquipmentResourceType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcConstructionEquipmentResourceTypeEnum) parameters.get(11);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcConstructionEquipmentResourceType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCONSTRUCTIONEQUIPMENTRESOURCETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcConstructionEquipmentResourceTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcConstructionEquipmentResourceType ifcConstructionEquipmentResourceType = new IfcConstructionEquipmentResourceType();
		if(this.GlobalId != null)
			ifcConstructionEquipmentResourceType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcConstructionEquipmentResourceType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcConstructionEquipmentResourceType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcConstructionEquipmentResourceType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcConstructionEquipmentResourceType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcConstructionEquipmentResourceType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.Identification != null)
			ifcConstructionEquipmentResourceType.setIdentification((IfcIdentifier)this.Identification.clone());
		if(this.LongDescription != null)
			ifcConstructionEquipmentResourceType.setLongDescription((IfcText)this.LongDescription.clone());
		if(this.ResourceType != null)
			ifcConstructionEquipmentResourceType.setResourceType((IfcLabel)this.ResourceType.clone());
		if(this.BaseCosts != null)
			ifcConstructionEquipmentResourceType.setBaseCosts((LIST<IfcAppliedValue>)this.BaseCosts.clone());
		if(this.BaseQuantity != null)
			ifcConstructionEquipmentResourceType.setBaseQuantity((IfcPhysicalQuantity)this.BaseQuantity.clone());
		if(this.PredefinedType != null)
			ifcConstructionEquipmentResourceType.setPredefinedType((IfcConstructionEquipmentResourceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcConstructionEquipmentResourceType ifcConstructionEquipmentResourceType = new IfcConstructionEquipmentResourceType();
		if(this.GlobalId != null)
			ifcConstructionEquipmentResourceType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcConstructionEquipmentResourceType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcConstructionEquipmentResourceType.setName(this.Name);
		if(this.Description != null)
			ifcConstructionEquipmentResourceType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcConstructionEquipmentResourceType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcConstructionEquipmentResourceType.setHasPropertySets(this.HasPropertySets);
		if(this.Identification != null)
			ifcConstructionEquipmentResourceType.setIdentification(this.Identification);
		if(this.LongDescription != null)
			ifcConstructionEquipmentResourceType.setLongDescription(this.LongDescription);
		if(this.ResourceType != null)
			ifcConstructionEquipmentResourceType.setResourceType(this.ResourceType);
		if(this.BaseCosts != null)
			ifcConstructionEquipmentResourceType.setBaseCosts(this.BaseCosts);
		if(this.BaseQuantity != null)
			ifcConstructionEquipmentResourceType.setBaseQuantity(this.BaseQuantity);
		if(this.PredefinedType != null)
			ifcConstructionEquipmentResourceType.setPredefinedType(this.PredefinedType);
		return ifcConstructionEquipmentResourceType;
	}
