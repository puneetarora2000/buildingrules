...
/**
 * This is a default implementation of the entity IfcProtectiveDevice<br><br>
 *<br><br>
 ...
 */
public class IfcProtectiveDevice extends IfcFlowController implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcProtectiveDeviceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcProtectiveDevice object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcProtectiveDeviceTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcProtectiveDevice object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcProtectiveDeviceTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcProtectiveDeviceTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcProtectiveDeviceTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcProtectiveDevice.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPROTECTIVEDEVICE(");
	...
	**/
	public Object clone()
	{
		IfcProtectiveDevice ifcProtectiveDevice = new IfcProtectiveDevice();
		if(this.GlobalId != null)
			ifcProtectiveDevice.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcProtectiveDevice.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcProtectiveDevice.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcProtectiveDevice.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcProtectiveDevice.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcProtectiveDevice.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcProtectiveDevice.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcProtectiveDevice.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcProtectiveDevice.setPredefinedType((IfcProtectiveDeviceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcProtectiveDevice ifcProtectiveDevice = new IfcProtectiveDevice();
		if(this.GlobalId != null)
			ifcProtectiveDevice.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcProtectiveDevice.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcProtectiveDevice.setName(this.Name);
		if(this.Description != null)
			ifcProtectiveDevice.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcProtectiveDevice.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcProtectiveDevice.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcProtectiveDevice.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcProtectiveDevice.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcProtectiveDevice.setPredefinedType(this.PredefinedType);
		return ifcProtectiveDevice;
	}
