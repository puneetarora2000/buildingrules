...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcDateTime","LIST<IfcValue>"};
	...
	*
	* @param TimeStamp DEMANDED parameter of type IfcDateTime - may not be null.
	...
	* @param ListValues DEMANDED parameter of type LIST<IfcValue> - may not be null.
	**/
	public void setParameters(IfcDateTime TimeStamp, LIST<IfcValue> ListValues)
	{
		this.TimeStamp = TimeStamp;
		this.ListValues = ListValues;
		resolveInverses();
	...
	**/
	...
	{
		this.TimeStamp = (IfcDateTime) parameters.get(0);
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.TimeStamp != null)		stepString = stepString.concat(((RootInterface)this.TimeStamp).getStepParameter(IfcDateTime.class.isInterface())+",");
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.TimeStamp != null)
			ifcIrregularTimeSeriesValue.setTimeStamp((IfcDateTime)this.TimeStamp.clone());
		if(this.ListValues != null)
