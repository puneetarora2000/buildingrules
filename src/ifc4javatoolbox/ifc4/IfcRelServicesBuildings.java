...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcSystem","SET<IfcSpatialElement>"};
	...
	protected SET<IfcSpatialElement> RelatedBuildings;
	/**
	...
	* @param RelatedBuildings DEMANDED parameter of type SET<IfcSpatialElement> - may not be null.
	**/
	public IfcRelServicesBuildings(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcSystem RelatingSystem, SET<IfcSpatialElement> RelatedBuildings)
	{
	...
	* @param RelatedBuildings DEMANDED parameter of type SET<IfcSpatialElement> - may not be null.
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcSystem RelatingSystem, SET<IfcSpatialElement> RelatedBuildings)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.RelatedBuildings = (SET<IfcSpatialElement>) parameters.get(5);
		resolveInverses();
	}
	...
	**/
	...
	private void resolveInverses()
	{
		...
		{
			for(IfcSpatialElement RelatedBuildings$ : RelatedBuildings)
			{
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.RelatedBuildings != null)		stepString = stepString.concat(((RootInterface)this.RelatedBuildings).getStepParameter(IfcSpatialElement.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	public void setRelatedBuildings(SET<IfcSpatialElement> RelatedBuildings)
	{
	...
	**/
	public SET<IfcSpatialElement> getRelatedBuildings()
	{
		if(this.RelatedBuildings != null)
			return new SET<IfcSpatialElement>(this.RelatedBuildings);
		return null;
	}

	/**
	* This method adds an IfcSpatialElement object to the RelatedBuildings set.
	* @param RelatedBuildings element to be appended to this set.
	**/
	public void addRelatedBuildings(IfcSpatialElement RelatedBuildings)
	{
		if(this.RelatedBuildings == null)
			this.RelatedBuildings = new SET<IfcSpatialElement>();
	...
	/**
	* This method adds a collection of IfcSpatialElement objects to the RelatedBuildings set.
	* @param RelatedBuildings collection containing elements to be added to this set.
	**/
	public void addAllRelatedBuildings(java.util.Collection<IfcSpatialElement> RelatedBuildings)
	{
		if(this.RelatedBuildings == null)
			this.RelatedBuildings = new SET<IfcSpatialElement>();
	...
	**/
	...
	/**
	* This method removes an IfcSpatialElement object from the RelatedBuildings set.
	* @param RelatedBuildings element to be removed from this set.
	**/
	public void removeRelatedBuildings(IfcSpatialElement RelatedBuildings)
	{
		if(this.RelatedBuildings != null)
		{
	...
	/**
	* This method removes a collection of IfcSpatialElement objects from the RelatedBuildings set.
	* @param RelatedBuildings collection containing elements to be removed from this set.
	**/
	public void removeAllRelatedBuildings(java.util.Collection<IfcSpatialElement> RelatedBuildings)
	{
		if(this.RelatedBuildings != null)
		{
	...
	private void synchronizeInversesAddRelatedBuildings(IfcSpatialElement RelatedBuildings)
	{
		if(RelatedBuildings != null)
		{
				if(RelatedBuildings.ServicedBySystems_Inverse == null)
	...
	private void synchronizeInversesAddRelatedBuildings(java.util.Collection<IfcSpatialElement> RelatedBuildings)
	{
		if(RelatedBuildings != null)
		{
			for(IfcSpatialElement RelatedBuildings$ : RelatedBuildings)
	...
	private void synchronizeInversesRemoveRelatedBuildings(IfcSpatialElement RelatedBuildings)
	{
		if(RelatedBuildings != null)
		{
				if(RelatedBuildings.ServicedBySystems_Inverse != null)
	...
	private void synchronizeInversesRemoveRelatedBuildings(java.util.Collection<IfcSpatialElement> RelatedBuildings)
	{
		if(RelatedBuildings != null)
		{
			for(IfcSpatialElement RelatedBuildings$ : RelatedBuildings)
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.RelatedBuildings != null)
			ifcRelServicesBuildings.setRelatedBuildings((SET<IfcSpatialElement>)this.RelatedBuildings.clone());
