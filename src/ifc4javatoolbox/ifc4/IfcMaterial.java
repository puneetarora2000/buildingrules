 ...
 */
public class IfcMaterial extends IfcMaterialDefinition implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcLabel","IfcText","IfcLabel"};
	...
	protected SET<IfcMaterialRelationship> IsRelatedWith_Inverse;
	protected SET<IfcMaterialRelationship> RelatesTo_Inverse;
	/**
	...
	* @param Category OPTIONAL parameter of type IfcLabel
	**/
	public void setParameters(IfcLabel Name, IfcText Description, IfcLabel Category)
	{
		this.Name = Name;
		this.Description = Description;
		this.Category = Category;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.Category = (IfcLabel) parameters.get(2);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public SET<IfcMaterialRelationship> getIsRelatedWith_Inverse()
	{
		if(this.IsRelatedWith_Inverse != null)
			return new SET<IfcMaterialRelationship>(this.IsRelatedWith_Inverse);
		return null;
	}

	/**
	* This method returns a copy of the set of the RelatesTo_Inverse attribute.
	*
	* @return a copy of the RelatesTo_Inverse set
	**/
	public SET<IfcMaterialRelationship> getRelatesTo_Inverse()
	{
		if(this.RelatesTo_Inverse != null)
			return new SET<IfcMaterialRelationship>(this.RelatesTo_Inverse);
		return null;
	}
	...
	**/
	public Object clone()
	{
		...
		if(this.Description != null)
			ifcMaterial.setDescription((IfcText)this.Description.clone());
		if(this.Category != null)
			ifcMaterial.setCategory((IfcLabel)this.Category.clone());
		return ifcMaterial;
	}
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.Description != null)
			ifcMaterial.setDescription(this.Description);
		if(this.Category != null)
			ifcMaterial.setCategory(this.Category);
		return ifcMaterial;
	}
