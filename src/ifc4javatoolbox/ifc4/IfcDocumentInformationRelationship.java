 ...
 */
public class IfcDocumentInformationRelationship extends IfcResourceLevelRelationship implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcLabel","IfcText","IfcDocumentInformation","SET<IfcDocumentInformation>","IfcLabel"};
	...
	**/
	public IfcDocumentInformationRelationship(IfcLabel Name, IfcText Description, IfcDocumentInformation RelatingDocument, SET<IfcDocumentInformation> RelatedDocuments, IfcLabel RelationshipType)
	{
		this.Name = Name;
	...
	* @param RelationshipType OPTIONAL parameter of type IfcLabel
	**/
	public void setParameters(IfcLabel Name, IfcText Description, IfcDocumentInformation RelatingDocument, SET<IfcDocumentInformation> RelatedDocuments, IfcLabel RelationshipType)
	{
		this.Name = Name;
		this.Description = Description;
		this.RelatingDocument = RelatingDocument;
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.RelatingDocument = (IfcDocumentInformation) parameters.get(2);
		this.RelatedDocuments = (SET<IfcDocumentInformation>) parameters.get(3);
		this.RelationshipType = (IfcLabel) parameters.get(4);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.Name != null)
			ifcDocumentInformationRelationship.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcDocumentInformationRelationship.setDescription((IfcText)this.Description.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcDocumentInformationRelationship ifcDocumentInformationRelationship = new IfcDocumentInformationRelationship();
		if(this.Name != null)
			ifcDocumentInformationRelationship.setName(this.Name);
		if(this.Description != null)
			ifcDocumentInformationRelationship.setDescription(this.Description);
		if(this.RelatingDocument != null)
