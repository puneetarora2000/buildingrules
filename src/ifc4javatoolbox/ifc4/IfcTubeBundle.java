...
/**
 * This is a default implementation of the entity IfcTubeBundle<br><br>
 *<br><br>
 ...
 */
public class IfcTubeBundle extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcTubeBundleTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcTubeBundle object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcTubeBundleTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcTubeBundle object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcTubeBundleTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcTubeBundleTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcTubeBundleTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcTubeBundle.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCTUBEBUNDLE(");
	...
	**/
	public Object clone()
	{
		IfcTubeBundle ifcTubeBundle = new IfcTubeBundle();
		if(this.GlobalId != null)
			ifcTubeBundle.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcTubeBundle.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcTubeBundle.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcTubeBundle.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcTubeBundle.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcTubeBundle.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcTubeBundle.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcTubeBundle.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcTubeBundle.setPredefinedType((IfcTubeBundleTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcTubeBundle ifcTubeBundle = new IfcTubeBundle();
		if(this.GlobalId != null)
			ifcTubeBundle.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcTubeBundle.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcTubeBundle.setName(this.Name);
		if(this.Description != null)
			ifcTubeBundle.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcTubeBundle.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcTubeBundle.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcTubeBundle.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcTubeBundle.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcTubeBundle.setPredefinedType(this.PredefinedType);
		return ifcTubeBundle;
	}
