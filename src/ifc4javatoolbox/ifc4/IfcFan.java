...
/**
 * This is a default implementation of the entity IfcFan<br><br>
 *<br><br>
 ...
 */
public class IfcFan extends IfcFlowMovingDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcFanTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcFan object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcFanTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcFan object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcFanTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcFanTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcFanTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcFan.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCFAN(");
	...
	**/
	public Object clone()
	{
		IfcFan ifcFan = new IfcFan();
		if(this.GlobalId != null)
			ifcFan.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcFan.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcFan.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcFan.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcFan.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcFan.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcFan.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcFan.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcFan.setPredefinedType((IfcFanTypeEnum)this.PredefinedType.clone());
		return ifcFan;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcFan ifcFan = new IfcFan();
		if(this.GlobalId != null)
			ifcFan.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcFan.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcFan.setName(this.Name);
		if(this.Description != null)
			ifcFan.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcFan.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcFan.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcFan.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcFan.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcFan.setPredefinedType(this.PredefinedType);
		return ifcFan;
	}
