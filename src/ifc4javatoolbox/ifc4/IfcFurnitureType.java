...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcAssemblyPlaceEnum","IfcFurnitureTypeEnum"};
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcFurnitureTypeEnum) parameters.get(10);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.ApplicableOccurrence != null)
			ifcFurnitureType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		...
		if(this.PredefinedType != null)
			ifcFurnitureType.setPredefinedType((IfcFurnitureTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.PredefinedType != null)
			ifcFurnitureType.setPredefinedType(this.PredefinedType);
		return ifcFurnitureType;
	}
