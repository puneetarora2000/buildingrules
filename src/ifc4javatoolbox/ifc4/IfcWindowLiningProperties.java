 ...
 */
public class IfcWindowLiningProperties extends IfcPreDefinedPropertySet implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcPositiveLengthMeasure","IfcNonNegativeLengthMeasure","IfcNonNegativeLengthMeasure","IfcNonNegativeLengthMeasure","IfcNormalisedRatioMeasure","IfcNormalisedRatioMeasure","IfcNormalisedRatioMeasure","IfcNormalisedRatioMeasure","IfcShapeAspect","IfcLengthMeasure","IfcLengthMeasure","IfcLengthMeasure"};
	...
	* @param MullionThickness OPTIONAL parameter of type IfcNonNegativeLengthMeasure
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.TransomThickness = (IfcNonNegativeLengthMeasure) parameters.get(6);
		this.MullionThickness = (IfcNonNegativeLengthMeasure) parameters.get(7);
		...
		this.LiningOffset = (IfcLengthMeasure) parameters.get(13);
		this.LiningToPanelOffsetX = (IfcLengthMeasure) parameters.get(14);
		this.LiningToPanelOffsetY = (IfcLengthMeasure) parameters.get(15);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.MullionThickness != null)		stepString = stepString.concat(((RootInterface)this.MullionThickness).getStepParameter(IfcNonNegativeLengthMeasure.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
	...
	**/
	public Object clone()
	{
		...
		if(this.LiningThickness != null)
			ifcWindowLiningProperties.setLiningThickness((IfcNonNegativeLengthMeasure)this.LiningThickness.clone());
		if(this.TransomThickness != null)
			ifcWindowLiningProperties.setTransomThickness((IfcNonNegativeLengthMeasure)this.TransomThickness.clone());
		if(this.MullionThickness != null)
			ifcWindowLiningProperties.setMullionThickness((IfcNonNegativeLengthMeasure)this.MullionThickness.clone());
		...
		if(this.LiningOffset != null)
			ifcWindowLiningProperties.setLiningOffset((IfcLengthMeasure)this.LiningOffset.clone());
		if(this.LiningToPanelOffsetX != null)
			ifcWindowLiningProperties.setLiningToPanelOffsetX((IfcLengthMeasure)this.LiningToPanelOffsetX.clone());
		if(this.LiningToPanelOffsetY != null)
			ifcWindowLiningProperties.setLiningToPanelOffsetY((IfcLengthMeasure)this.LiningToPanelOffsetY.clone());
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.LiningOffset != null)
			ifcWindowLiningProperties.setLiningOffset(this.LiningOffset);
		if(this.LiningToPanelOffsetX != null)
			ifcWindowLiningProperties.setLiningToPanelOffsetX(this.LiningToPanelOffsetX);
		if(this.LiningToPanelOffsetY != null)
			ifcWindowLiningProperties.setLiningToPanelOffsetY(this.LiningToPanelOffsetY);
		return ifcWindowLiningProperties;
	}
