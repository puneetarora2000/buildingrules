...
/**
 * This is a default implementation of the entity IfcElectricMotor<br><br>
 *<br><br>
 ...
 */
public class IfcElectricMotor extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcElectricMotorTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcElectricMotor object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcElectricMotorTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcElectricMotor object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcElectricMotorTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcElectricMotorTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcElectricMotorTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcElectricMotor.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCELECTRICMOTOR(");
	...
	**/
	public Object clone()
	{
		IfcElectricMotor ifcElectricMotor = new IfcElectricMotor();
		if(this.GlobalId != null)
			ifcElectricMotor.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcElectricMotor.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcElectricMotor.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcElectricMotor.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcElectricMotor.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcElectricMotor.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcElectricMotor.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcElectricMotor.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcElectricMotor.setPredefinedType((IfcElectricMotorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcElectricMotor ifcElectricMotor = new IfcElectricMotor();
		if(this.GlobalId != null)
			ifcElectricMotor.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcElectricMotor.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcElectricMotor.setName(this.Name);
		if(this.Description != null)
			ifcElectricMotor.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcElectricMotor.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcElectricMotor.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcElectricMotor.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcElectricMotor.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcElectricMotor.setPredefinedType(this.PredefinedType);
		return ifcElectricMotor;
	}
