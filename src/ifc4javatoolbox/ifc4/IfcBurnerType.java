...
/**
 * This is a default implementation of the entity IfcBurnerType<br><br>
 *<br><br>
 ...
 */
public class IfcBurnerType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcBurnerTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcBurnerType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcBurnerTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcBurnerType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcBurnerTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcBurnerType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCBURNERTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcBurnerTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcBurnerType ifcBurnerType = new IfcBurnerType();
		if(this.GlobalId != null)
			ifcBurnerType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcBurnerType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcBurnerType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcBurnerType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcBurnerType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcBurnerType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcBurnerType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcBurnerType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcBurnerType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcBurnerType.setPredefinedType((IfcBurnerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcBurnerType ifcBurnerType = new IfcBurnerType();
		if(this.GlobalId != null)
			ifcBurnerType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcBurnerType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcBurnerType.setName(this.Name);
		if(this.Description != null)
			ifcBurnerType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcBurnerType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcBurnerType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcBurnerType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcBurnerType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcBurnerType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcBurnerType.setPredefinedType(this.PredefinedType);
		return ifcBurnerType;
	}
