...
/**
 * This is a default implementation of the entity IfcShadingDevice<br><br>
 *<br><br>
 ...
 */
public class IfcShadingDevice extends IfcBuildingElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcShadingDeviceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcShadingDevice object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcShadingDeviceTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcShadingDevice object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcShadingDeviceTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcShadingDeviceTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcShadingDeviceTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcShadingDevice.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSHADINGDEVICE(");
	...
	**/
	public Object clone()
	{
		IfcShadingDevice ifcShadingDevice = new IfcShadingDevice();
		if(this.GlobalId != null)
			ifcShadingDevice.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcShadingDevice.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcShadingDevice.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcShadingDevice.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcShadingDevice.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcShadingDevice.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcShadingDevice.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcShadingDevice.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcShadingDevice.setPredefinedType((IfcShadingDeviceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcShadingDevice ifcShadingDevice = new IfcShadingDevice();
		if(this.GlobalId != null)
			ifcShadingDevice.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcShadingDevice.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcShadingDevice.setName(this.Name);
		if(this.Description != null)
			ifcShadingDevice.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcShadingDevice.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcShadingDevice.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcShadingDevice.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcShadingDevice.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcShadingDevice.setPredefinedType(this.PredefinedType);
		return ifcShadingDevice;
	}
