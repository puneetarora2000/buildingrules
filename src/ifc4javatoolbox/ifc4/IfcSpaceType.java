...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcSpaceTypeEnum","IfcLabel"};
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.ApplicableOccurrence != null)
			ifcSpaceType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		...
		if(this.LongName != null)
			ifcSpaceType.setLongName((IfcLabel)this.LongName.clone());
		return ifcSpaceType;
	}
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.LongName != null)
			ifcSpaceType.setLongName(this.LongName);
		return ifcSpaceType;
	}
