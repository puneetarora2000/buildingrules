	...
	**/
	public Object clone()
	{
		...
		if(this.FilletRadius != null)
			ifcUShapeProfileDef.setFilletRadius((IfcNonNegativeLengthMeasure)this.FilletRadius.clone());
		if(this.EdgeRadius != null)
			ifcUShapeProfileDef.setEdgeRadius((IfcNonNegativeLengthMeasure)this.EdgeRadius.clone());
