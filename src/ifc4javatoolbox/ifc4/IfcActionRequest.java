...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcIdentifier","IfcActionRequestTypeEnum","IfcLabel","IfcText"};
	...
	* @param PredefinedType OPTIONAL parameter of type IfcActionRequestTypeEnum
	...
	* @param LongDescription OPTIONAL parameter of type IfcText
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcIdentifier Identification, IfcActionRequestTypeEnum PredefinedType, IfcLabel Status, IfcText LongDescription)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcActionRequestTypeEnum) parameters.get(6);
		this.Status = (IfcLabel) parameters.get(7);
		this.LongDescription = (IfcText) parameters.get(8);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcActionRequestTypeEnum.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
	...
	**/
	public Object clone()
	{
		...
		if(this.Identification != null)
			ifcActionRequest.setIdentification((IfcIdentifier)this.Identification.clone());
		if(this.PredefinedType != null)
			ifcActionRequest.setPredefinedType((IfcActionRequestTypeEnum)this.PredefinedType.clone());
		if(this.Status != null)
			ifcActionRequest.setStatus((IfcLabel)this.Status.clone());
		if(this.LongDescription != null)
			ifcActionRequest.setLongDescription((IfcText)this.LongDescription.clone());
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.Identification != null)
			ifcActionRequest.setIdentification(this.Identification);
		if(this.PredefinedType != null)
			ifcActionRequest.setPredefinedType(this.PredefinedType);
		if(this.Status != null)
			ifcActionRequest.setStatus(this.Status);
		if(this.LongDescription != null)
			ifcActionRequest.setLongDescription(this.LongDescription);
		return ifcActionRequest;
	}
