 ...
 * Constructs a new IfcCoilTypeEnum enumeration object using the given parameter.
	...
	* The String must be one of: "DXCOOLINGCOIL", "ELECTRICHEATINGCOIL", "GASHEATINGCOIL", "HYDRONICCOIL", "STEAMHEATINGCOIL", "WATERCOOLINGCOIL", "WATERHEATINGCOIL", "USERDEFINED", "NOTDEFINED".
	*
	* @param value the value to set
	*/
