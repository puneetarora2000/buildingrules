...
/**
 * This is a default implementation of the entity IfcEvaporativeCooler<br><br>
 *<br><br>
 ...
 */
public class IfcEvaporativeCooler extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcEvaporativeCoolerTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcEvaporativeCooler object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcEvaporativeCoolerTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcEvaporativeCooler object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcEvaporativeCoolerTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcEvaporativeCoolerTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcEvaporativeCoolerTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcEvaporativeCooler.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCEVAPORATIVECOOLER(");
	...
	**/
	public Object clone()
	{
		IfcEvaporativeCooler ifcEvaporativeCooler = new IfcEvaporativeCooler();
		if(this.GlobalId != null)
			ifcEvaporativeCooler.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcEvaporativeCooler.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcEvaporativeCooler.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcEvaporativeCooler.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcEvaporativeCooler.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcEvaporativeCooler.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcEvaporativeCooler.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcEvaporativeCooler.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcEvaporativeCooler.setPredefinedType((IfcEvaporativeCoolerTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcEvaporativeCooler ifcEvaporativeCooler = new IfcEvaporativeCooler();
		if(this.GlobalId != null)
			ifcEvaporativeCooler.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcEvaporativeCooler.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcEvaporativeCooler.setName(this.Name);
		if(this.Description != null)
			ifcEvaporativeCooler.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcEvaporativeCooler.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcEvaporativeCooler.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcEvaporativeCooler.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcEvaporativeCooler.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcEvaporativeCooler.setPredefinedType(this.PredefinedType);
		return ifcEvaporativeCooler;
	}
