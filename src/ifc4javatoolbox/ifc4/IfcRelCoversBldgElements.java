...
public class IfcRelCoversBldgElements extends IfcRelConnects implements ClassInterface
{
	...
	**/
	...
	private void resolveInverses()
	{
		...
		{
				if(RelatingBuildingElement instanceof IfcBuildingElement)
				{
				if(((IfcBuildingElement)RelatingBuildingElement).HasCoverings_Inverse == null)
				{
					((IfcBuildingElement)RelatingBuildingElement).HasCoverings_Inverse = new SET<IfcRelCoversBldgElements>();
				}
				((IfcBuildingElement)RelatingBuildingElement).HasCoverings_Inverse.add(this);
				}
		}
		if(RelatedCoverings != null)
		{
			...
			{
				if(RelatedCoverings$.CoversElements_Inverse == null)
				{
					RelatedCoverings$.CoversElements_Inverse = new SET<IfcRelCoversBldgElements>();
				}
				RelatedCoverings$.CoversElements_Inverse.add(this);
			}
		}
	}
	...
	* @return the value of RelatingBuildingElement
	...
	private void synchronizeInversesRemoveRelatingBuildingElement(IfcElement RelatingBuildingElement)
	{
		if(RelatingBuildingElement != null)
		{
				...
				if(((IfcBuildingElement)RelatingBuildingElement).HasCoverings_Inverse != null)
				{
				((IfcBuildingElement)RelatingBuildingElement).HasCoverings_Inverse.remove(this);
				}
				}
		}
	}
	...
	**/
	...
	private void synchronizeInversesRemoveRelatedCoverings(IfcCovering RelatedCoverings)
	{
		if(RelatedCoverings != null)
		{
				if(RelatedCoverings.CoversElements_Inverse != null)
				{
					RelatedCoverings.CoversElements_Inverse.remove(this);
				}
		}
	}
