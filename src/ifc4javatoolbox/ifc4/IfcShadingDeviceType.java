...
/**
 * This is a default implementation of the entity IfcShadingDeviceType<br><br>
 *<br><br>
 ...
 */
public class IfcShadingDeviceType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcShadingDeviceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcShadingDeviceType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcShadingDeviceTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcShadingDeviceType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcShadingDeviceTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcShadingDeviceType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSHADINGDEVICETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcShadingDeviceTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcShadingDeviceType ifcShadingDeviceType = new IfcShadingDeviceType();
		if(this.GlobalId != null)
			ifcShadingDeviceType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcShadingDeviceType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcShadingDeviceType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcShadingDeviceType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcShadingDeviceType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcShadingDeviceType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcShadingDeviceType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcShadingDeviceType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcShadingDeviceType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcShadingDeviceType.setPredefinedType((IfcShadingDeviceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcShadingDeviceType ifcShadingDeviceType = new IfcShadingDeviceType();
		if(this.GlobalId != null)
			ifcShadingDeviceType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcShadingDeviceType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcShadingDeviceType.setName(this.Name);
		if(this.Description != null)
			ifcShadingDeviceType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcShadingDeviceType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcShadingDeviceType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcShadingDeviceType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcShadingDeviceType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcShadingDeviceType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcShadingDeviceType.setPredefinedType(this.PredefinedType);
		return ifcShadingDeviceType;
	}
