...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcLabel","IfcText","IfcConstraintEnum","IfcLabel","IfcActorSelect","IfcDateTime","IfcLabel","IfcBenchmarkEnum","IfcLabel","IfcMetricValueSelect","IfcReference"};
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.ReferencePath = (IfcReference) parameters.get(10);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public Object clone()
	{
		...
		if(this.CreationTime != null)
			ifcMetric.setCreationTime((IfcDateTime)this.CreationTime.clone());
		...
		if(this.ReferencePath != null)
			ifcMetric.setReferencePath((IfcReference)this.ReferencePath.clone());
		return ifcMetric;
	}
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.ReferencePath != null)
			ifcMetric.setReferencePath(this.ReferencePath);
		return ifcMetric;
	}
