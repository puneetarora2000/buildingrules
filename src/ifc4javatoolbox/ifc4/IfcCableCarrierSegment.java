...
/**
 * This is a default implementation of the entity IfcCableCarrierSegment<br><br>
 *<br><br>
 ...
 */
public class IfcCableCarrierSegment extends IfcFlowSegment implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcCableCarrierSegmentTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcCableCarrierSegment object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCableCarrierSegmentTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcCableCarrierSegment object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcCableCarrierSegmentTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcCableCarrierSegmentTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcCableCarrierSegmentTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcCableCarrierSegment.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCABLECARRIERSEGMENT(");
	...
	**/
	public Object clone()
	{
		IfcCableCarrierSegment ifcCableCarrierSegment = new IfcCableCarrierSegment();
		if(this.GlobalId != null)
			ifcCableCarrierSegment.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCableCarrierSegment.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCableCarrierSegment.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCableCarrierSegment.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcCableCarrierSegment.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcCableCarrierSegment.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcCableCarrierSegment.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcCableCarrierSegment.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcCableCarrierSegment.setPredefinedType((IfcCableCarrierSegmentTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCableCarrierSegment ifcCableCarrierSegment = new IfcCableCarrierSegment();
		if(this.GlobalId != null)
			ifcCableCarrierSegment.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCableCarrierSegment.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCableCarrierSegment.setName(this.Name);
		if(this.Description != null)
			ifcCableCarrierSegment.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcCableCarrierSegment.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcCableCarrierSegment.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcCableCarrierSegment.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcCableCarrierSegment.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcCableCarrierSegment.setPredefinedType(this.PredefinedType);
		return ifcCableCarrierSegment;
	}
