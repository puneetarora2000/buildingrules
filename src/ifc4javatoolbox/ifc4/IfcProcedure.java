...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcIdentifier","IfcText","IfcProcedureTypeEnum"};
	...
	* @param PredefinedType OPTIONAL parameter of type IfcProcedureTypeEnum
	**/
	...
	* @param PredefinedType OPTIONAL parameter of type IfcProcedureTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcIdentifier Identification, IfcText LongDescription, IfcProcedureTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcProcedureTypeEnum) parameters.get(7);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public Object clone()
	{
		...
		if(this.Identification != null)
			ifcProcedure.setIdentification((IfcIdentifier)this.Identification.clone());
		if(this.LongDescription != null)
			ifcProcedure.setLongDescription((IfcText)this.LongDescription.clone());
		if(this.PredefinedType != null)
			ifcProcedure.setPredefinedType((IfcProcedureTypeEnum)this.PredefinedType.clone());
		return ifcProcedure;
	}
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.Identification != null)
			ifcProcedure.setIdentification(this.Identification);
		if(this.LongDescription != null)
			ifcProcedure.setLongDescription(this.LongDescription);
		if(this.PredefinedType != null)
			ifcProcedure.setPredefinedType(this.PredefinedType);
		return ifcProcedure;
	}
