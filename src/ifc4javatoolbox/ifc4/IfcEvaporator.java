...
/**
 * This is a default implementation of the entity IfcEvaporator<br><br>
 *<br><br>
 ...
 */
public class IfcEvaporator extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcEvaporatorTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcEvaporator object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcEvaporatorTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcEvaporator object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcEvaporatorTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcEvaporatorTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcEvaporatorTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcEvaporator.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCEVAPORATOR(");
	...
	**/
	public Object clone()
	{
		IfcEvaporator ifcEvaporator = new IfcEvaporator();
		if(this.GlobalId != null)
			ifcEvaporator.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcEvaporator.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcEvaporator.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcEvaporator.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcEvaporator.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcEvaporator.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcEvaporator.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcEvaporator.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcEvaporator.setPredefinedType((IfcEvaporatorTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcEvaporator ifcEvaporator = new IfcEvaporator();
		if(this.GlobalId != null)
			ifcEvaporator.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcEvaporator.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcEvaporator.setName(this.Name);
		if(this.Description != null)
			ifcEvaporator.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcEvaporator.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcEvaporator.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcEvaporator.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcEvaporator.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcEvaporator.setPredefinedType(this.PredefinedType);
		return ifcEvaporator;
	}
