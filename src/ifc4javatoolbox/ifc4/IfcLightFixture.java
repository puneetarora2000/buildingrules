...
/**
 * This is a default implementation of the entity IfcLightFixture<br><br>
 *<br><br>
 ...
 */
public class IfcLightFixture extends IfcFlowTerminal implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcLightFixtureTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcLightFixture object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcLightFixtureTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcLightFixture object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcLightFixtureTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcLightFixtureTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcLightFixtureTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcLightFixture.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCLIGHTFIXTURE(");
	...
	**/
	public Object clone()
	{
		IfcLightFixture ifcLightFixture = new IfcLightFixture();
		if(this.GlobalId != null)
			ifcLightFixture.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcLightFixture.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcLightFixture.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcLightFixture.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcLightFixture.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcLightFixture.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcLightFixture.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcLightFixture.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcLightFixture.setPredefinedType((IfcLightFixtureTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcLightFixture ifcLightFixture = new IfcLightFixture();
		if(this.GlobalId != null)
			ifcLightFixture.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcLightFixture.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcLightFixture.setName(this.Name);
		if(this.Description != null)
			ifcLightFixture.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcLightFixture.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcLightFixture.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcLightFixture.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcLightFixture.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcLightFixture.setPredefinedType(this.PredefinedType);
		return ifcLightFixture;
	}
