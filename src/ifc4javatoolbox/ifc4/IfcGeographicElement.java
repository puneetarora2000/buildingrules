...
/**
 * This is a default implementation of the entity IfcGeographicElement<br><br>
 *<br><br>
 ...
 */
public class IfcGeographicElement extends IfcElement implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcGeographicElementTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcGeographicElement object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcGeographicElementTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcGeographicElement object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcGeographicElementTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcGeographicElementTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcGeographicElementTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcGeographicElement.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCGEOGRAPHICELEMENT(");
	...
	**/
	public Object clone()
	{
		...
		if(this.GlobalId != null)
			ifcGeographicElement.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcGeographicElement.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcGeographicElement.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcGeographicElement.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcGeographicElement.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcGeographicElement.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcGeographicElement.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcGeographicElement.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcGeographicElement.setPredefinedType((IfcGeographicElementTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcGeographicElement ifcGeographicElement = new IfcGeographicElement();
		if(this.GlobalId != null)
			ifcGeographicElement.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcGeographicElement.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcGeographicElement.setName(this.Name);
		if(this.Description != null)
			ifcGeographicElement.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcGeographicElement.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcGeographicElement.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcGeographicElement.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcGeographicElement.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcGeographicElement.setPredefinedType(this.PredefinedType);
		return ifcGeographicElement;
	}
