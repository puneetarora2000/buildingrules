...
/**
 * This is a default implementation of the entity IfcDuctFitting<br><br>
 *<br><br>
 ...
 */
public class IfcDuctFitting extends IfcFlowFitting implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcDuctFittingTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcDuctFitting object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcDuctFittingTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcDuctFitting object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcDuctFittingTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcDuctFittingTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcDuctFittingTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcDuctFitting.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCDUCTFITTING(");
	...
	**/
	public Object clone()
	{
		IfcDuctFitting ifcDuctFitting = new IfcDuctFitting();
		if(this.GlobalId != null)
			ifcDuctFitting.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcDuctFitting.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcDuctFitting.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcDuctFitting.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcDuctFitting.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcDuctFitting.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcDuctFitting.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcDuctFitting.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcDuctFitting.setPredefinedType((IfcDuctFittingTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcDuctFitting ifcDuctFitting = new IfcDuctFitting();
		if(this.GlobalId != null)
			ifcDuctFitting.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcDuctFitting.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcDuctFitting.setName(this.Name);
		if(this.Description != null)
			ifcDuctFitting.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcDuctFitting.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcDuctFitting.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcDuctFitting.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcDuctFitting.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcDuctFitting.setPredefinedType(this.PredefinedType);
		return ifcDuctFitting;
	}
