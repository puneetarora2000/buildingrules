...
/**
 * This is a default implementation of the entity IfcBoundaryCurve<br><br>
 *<br><br>
 ...
 */
public class IfcBoundaryCurve extends IfcCompositeCurveOnSurface implements ClassInterface
{
	...
	**/
	...
	/**
	* Constructs a new IfcBoundaryCurve object using the given parameters.
	*
	...
	**/
	public IfcBoundaryCurve(LIST<IfcCompositeCurveSegment> Segments, LOGICAL SelfIntersect)
	{
	...
	**/
	...
	{
		return IfcBoundaryCurve.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCBOUNDARYCURVE(");
	...
	**/
	...
	public Object clone()
	{
		IfcBoundaryCurve ifcBoundaryCurve = new IfcBoundaryCurve();
		if(this.Segments != null)
			ifcBoundaryCurve.setSegments((LIST<IfcCompositeCurveSegment>)this.Segments.clone());
		if(this.SelfIntersect != null)
			ifcBoundaryCurve.setSelfIntersect((LOGICAL)this.SelfIntersect.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcBoundaryCurve ifcBoundaryCurve = new IfcBoundaryCurve();
		if(this.Segments != null)
			ifcBoundaryCurve.setSegments(this.Segments);
		if(this.SelfIntersect != null)
			ifcBoundaryCurve.setSelfIntersect(this.SelfIntersect);
		return ifcBoundaryCurve;
	}
