...
/**
 * This is a default implementation of the entity IfcSpaceHeater<br><br>
 *<br><br>
 ...
 */
public class IfcSpaceHeater extends IfcFlowTerminal implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcSpaceHeaterTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcSpaceHeater object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSpaceHeaterTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcSpaceHeater object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSpaceHeaterTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcSpaceHeaterTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSpaceHeaterTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcSpaceHeater.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCSPACEHEATER(");
	...
	**/
	public Object clone()
	{
		IfcSpaceHeater ifcSpaceHeater = new IfcSpaceHeater();
		if(this.GlobalId != null)
			ifcSpaceHeater.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcSpaceHeater.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcSpaceHeater.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcSpaceHeater.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcSpaceHeater.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcSpaceHeater.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcSpaceHeater.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcSpaceHeater.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcSpaceHeater.setPredefinedType((IfcSpaceHeaterTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcSpaceHeater ifcSpaceHeater = new IfcSpaceHeater();
		if(this.GlobalId != null)
			ifcSpaceHeater.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcSpaceHeater.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcSpaceHeater.setName(this.Name);
		if(this.Description != null)
			ifcSpaceHeater.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcSpaceHeater.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcSpaceHeater.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcSpaceHeater.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcSpaceHeater.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcSpaceHeater.setPredefinedType(this.PredefinedType);
		return ifcSpaceHeater;
	}
