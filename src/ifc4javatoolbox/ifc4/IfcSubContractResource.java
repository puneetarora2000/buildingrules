...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcIdentifier","IfcText","IfcResourceTime","LIST<IfcAppliedValue>","IfcPhysicalQuantity","IfcSubContractResourceTypeEnum"};
	...
	* @param PredefinedType OPTIONAL parameter of type IfcSubContractResourceTypeEnum
	**/
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcSubContractResourceTypeEnum) parameters.get(10);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.Identification != null)
			ifcSubContractResource.setIdentification((IfcIdentifier)this.Identification.clone());
		if(this.LongDescription != null)
			ifcSubContractResource.setLongDescription((IfcText)this.LongDescription.clone());
		if(this.Usage != null)
			ifcSubContractResource.setUsage((IfcResourceTime)this.Usage.clone());
		if(this.BaseCosts != null)
			ifcSubContractResource.setBaseCosts((LIST<IfcAppliedValue>)this.BaseCosts.clone());
		if(this.BaseQuantity != null)
			ifcSubContractResource.setBaseQuantity((IfcPhysicalQuantity)this.BaseQuantity.clone());
		if(this.PredefinedType != null)
			ifcSubContractResource.setPredefinedType((IfcSubContractResourceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.Identification != null)
			ifcSubContractResource.setIdentification(this.Identification);
		if(this.LongDescription != null)
			ifcSubContractResource.setLongDescription(this.LongDescription);
		if(this.Usage != null)
			ifcSubContractResource.setUsage(this.Usage);
		if(this.BaseCosts != null)
			ifcSubContractResource.setBaseCosts(this.BaseCosts);
		if(this.BaseQuantity != null)
			ifcSubContractResource.setBaseQuantity(this.BaseQuantity);
		if(this.PredefinedType != null)
			ifcSubContractResource.setPredefinedType(this.PredefinedType);
		return ifcSubContractResource;
	}
