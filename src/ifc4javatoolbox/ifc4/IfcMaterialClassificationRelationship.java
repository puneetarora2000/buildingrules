...
{
	private static final String[] nonInverseAttributes = new String[]{"SET<IfcClassificationSelect>","IfcMaterial"};
	private java.util.ArrayList<CloneableObject> stepParameter = null;
	private java.util.HashSet<ObjectChangeListener> listenerList = null;
	protected int stepLineNumber;
	/** MaterialClassifications is an DEMANDED attribute - may not be null**/
	protected SET<IfcClassificationSelect> MaterialClassifications;
	...
	*
	* @param MaterialClassifications DEMANDED parameter of type SET<IfcClassificationSelect> - may not be null.
	* @param ClassifiedMaterial DEMANDED parameter of type IfcMaterial - may not be null.
	**/
	public IfcMaterialClassificationRelationship(SET<IfcClassificationSelect> MaterialClassifications, IfcMaterial ClassifiedMaterial)
	{
	...
	* @param ClassifiedMaterial DEMANDED parameter of type IfcMaterial - may not be null.
	**/
	public void setParameters(SET<IfcClassificationSelect> MaterialClassifications, IfcMaterial ClassifiedMaterial)
	{
		this.MaterialClassifications = MaterialClassifications;
		this.ClassifiedMaterial = ClassifiedMaterial;
		resolveInverses();
	...
	**/
	...
	{
		this.MaterialClassifications = (SET<IfcClassificationSelect>) parameters.get(0);
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.MaterialClassifications != null)		stepString = stepString.concat(((RootInterface)this.MaterialClassifications).getStepParameter(IfcClassificationSelect.class.isInterface())+",");
	...
	**/
	public void setMaterialClassifications(SET<IfcClassificationSelect> MaterialClassifications)
	{
		this.MaterialClassifications = MaterialClassifications;
		fireChangeEvent();
	}
	...
	**/
	public SET<IfcClassificationSelect> getMaterialClassifications()
	{
		if(this.MaterialClassifications != null)
			return new SET<IfcClassificationSelect>(this.MaterialClassifications);
		return null;
	}

	/**
	* This method adds an IfcClassificationSelect object to the MaterialClassifications set.
	* @param MaterialClassifications element to be appended to this set.
	**/
	public void addMaterialClassifications(IfcClassificationSelect MaterialClassifications)
	{
		if(this.MaterialClassifications == null)
			this.MaterialClassifications = new SET<IfcClassificationSelect>();
		this.MaterialClassifications.add(MaterialClassifications);
		fireChangeEvent();
	}

	/**
	* This method adds a collection of IfcClassificationSelect objects to the MaterialClassifications set.
	* @param MaterialClassifications collection containing elements to be added to this set.
	**/
	public void addAllMaterialClassifications(java.util.Collection<IfcClassificationSelect> MaterialClassifications)
	{
		if(this.MaterialClassifications == null)
			this.MaterialClassifications = new SET<IfcClassificationSelect>();
	...
	**/
	...
	/**
	* This method removes an IfcClassificationSelect object from the MaterialClassifications set.
	* @param MaterialClassifications element to be removed from this set.
	**/
	public void removeMaterialClassifications(IfcClassificationSelect MaterialClassifications)
	{
		if(this.MaterialClassifications != null)
		{
	...
	/**
	* This method removes a collection of IfcClassificationSelect objects from the MaterialClassifications set.
	* @param MaterialClassifications collection containing elements to be removed from this set.
	**/
	public void removeAllMaterialClassifications(java.util.Collection<IfcClassificationSelect> MaterialClassifications)
	{
		if(this.MaterialClassifications != null)
		{
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.MaterialClassifications != null)
			ifcMaterialClassificationRelationship.setMaterialClassifications((SET<IfcClassificationSelect>)this.MaterialClassifications.clone());
