...
/**
 * This is a default implementation of the entity IfcElectricAppliance<br><br>
 *<br><br>
 ...
 */
public class IfcElectricAppliance extends IfcFlowTerminal implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcElectricApplianceTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcElectricAppliance object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcElectricApplianceTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcElectricAppliance object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcElectricApplianceTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcElectricApplianceTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcElectricApplianceTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcElectricAppliance.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCELECTRICAPPLIANCE(");
	...
	**/
	public Object clone()
	{
		IfcElectricAppliance ifcElectricAppliance = new IfcElectricAppliance();
		if(this.GlobalId != null)
			ifcElectricAppliance.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcElectricAppliance.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcElectricAppliance.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcElectricAppliance.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcElectricAppliance.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcElectricAppliance.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcElectricAppliance.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcElectricAppliance.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcElectricAppliance.setPredefinedType((IfcElectricApplianceTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcElectricAppliance ifcElectricAppliance = new IfcElectricAppliance();
		if(this.GlobalId != null)
			ifcElectricAppliance.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcElectricAppliance.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcElectricAppliance.setName(this.Name);
		if(this.Description != null)
			ifcElectricAppliance.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcElectricAppliance.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcElectricAppliance.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcElectricAppliance.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcElectricAppliance.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcElectricAppliance.setPredefinedType(this.PredefinedType);
		return ifcElectricAppliance;
	}
