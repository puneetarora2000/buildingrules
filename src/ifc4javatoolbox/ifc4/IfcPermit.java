...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcIdentifier","IfcPermitTypeEnum","IfcLabel","IfcText"};
	...
	* @param PredefinedType OPTIONAL parameter of type IfcPermitTypeEnum
	...
	* @param LongDescription OPTIONAL parameter of type IfcText
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcIdentifier Identification, IfcPermitTypeEnum PredefinedType, IfcLabel Status, IfcText LongDescription)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcPermitTypeEnum) parameters.get(6);
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcPermitTypeEnum.class.isInterface())+",");
		else		stepString = stepString.concat("$,");
		}
	...
	**/
	public Object clone()
	{
		...
		if(this.Identification != null)
			ifcPermit.setIdentification((IfcIdentifier)this.Identification.clone());
		if(this.PredefinedType != null)
			ifcPermit.setPredefinedType((IfcPermitTypeEnum)this.PredefinedType.clone());
		if(this.Status != null)
			ifcPermit.setStatus((IfcLabel)this.Status.clone());
		if(this.LongDescription != null)
			ifcPermit.setLongDescription((IfcText)this.LongDescription.clone());
		return ifcPermit;
	}
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.Identification != null)
			ifcPermit.setIdentification(this.Identification);
		if(this.PredefinedType != null)
			ifcPermit.setPredefinedType(this.PredefinedType);
		if(this.Status != null)
			ifcPermit.setStatus(this.Status);
		if(this.LongDescription != null)
			ifcPermit.setLongDescription(this.LongDescription);
		return ifcPermit;
	}
