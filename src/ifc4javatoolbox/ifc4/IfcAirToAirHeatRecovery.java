...
/**
 * This is a default implementation of the entity IfcAirToAirHeatRecovery<br><br>
 *<br><br>
 ...
 */
public class IfcAirToAirHeatRecovery extends IfcEnergyConversionDevice implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcAirToAirHeatRecoveryTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcAirToAirHeatRecovery object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcAirToAirHeatRecoveryTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcAirToAirHeatRecovery object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcAirToAirHeatRecoveryTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcAirToAirHeatRecoveryTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcAirToAirHeatRecoveryTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcAirToAirHeatRecovery.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCAIRTOAIRHEATRECOVERY(");
	...
	**/
	public Object clone()
	{
		IfcAirToAirHeatRecovery ifcAirToAirHeatRecovery = new IfcAirToAirHeatRecovery();
		if(this.GlobalId != null)
			ifcAirToAirHeatRecovery.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcAirToAirHeatRecovery.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcAirToAirHeatRecovery.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcAirToAirHeatRecovery.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcAirToAirHeatRecovery.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcAirToAirHeatRecovery.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcAirToAirHeatRecovery.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcAirToAirHeatRecovery.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcAirToAirHeatRecovery.setPredefinedType((IfcAirToAirHeatRecoveryTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcAirToAirHeatRecovery ifcAirToAirHeatRecovery = new IfcAirToAirHeatRecovery();
		if(this.GlobalId != null)
			ifcAirToAirHeatRecovery.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcAirToAirHeatRecovery.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcAirToAirHeatRecovery.setName(this.Name);
		if(this.Description != null)
			ifcAirToAirHeatRecovery.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcAirToAirHeatRecovery.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcAirToAirHeatRecovery.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcAirToAirHeatRecovery.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcAirToAirHeatRecovery.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcAirToAirHeatRecovery.setPredefinedType(this.PredefinedType);
		return ifcAirToAirHeatRecovery;
	}
