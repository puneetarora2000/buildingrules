...
/**
 * This is a default implementation of the entity IfcCivilElementType<br><br>
 *<br><br>
 ...
 */
public class IfcCivilElementType extends IfcElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel"};
	...
	**/
	...
	/**
	* Constructs a new IfcCivilElementType object using the given parameters.
	*
	...
	**/
	public IfcCivilElementType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcIdentifier ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType)
	{
	...
	**/
	...
	{
		return IfcCivilElementType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCCIVILELEMENTTYPE(");
	...
	**/
	...
	public Object clone()
	{
		IfcCivilElementType ifcCivilElementType = new IfcCivilElementType();
		if(this.GlobalId != null)
			ifcCivilElementType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcCivilElementType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcCivilElementType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcCivilElementType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcCivilElementType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcCivilElementType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcCivilElementType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcCivilElementType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcCivilElementType.setElementType((IfcLabel)this.ElementType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcCivilElementType ifcCivilElementType = new IfcCivilElementType();
		if(this.GlobalId != null)
			ifcCivilElementType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcCivilElementType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcCivilElementType.setName(this.Name);
		if(this.Description != null)
			ifcCivilElementType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcCivilElementType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcCivilElementType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcCivilElementType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcCivilElementType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcCivilElementType.setElementType(this.ElementType);
		return ifcCivilElementType;
	}
