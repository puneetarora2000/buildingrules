...
/**
 * This is a default implementation of the entity IfcEngineType<br><br>
 *<br><br>
 ...
 */
public class IfcEngineType extends IfcEnergyConversionDeviceType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcEngineTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcEngineType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcEngineTypeEnum - may not be null.
	**/
	...
	/**
	 * This method initializes the IfcEngineType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcEngineTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcEngineType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCENGINETYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcEngineTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcEngineType ifcEngineType = new IfcEngineType();
		if(this.GlobalId != null)
			ifcEngineType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcEngineType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcEngineType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcEngineType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcEngineType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcEngineType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcEngineType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcEngineType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcEngineType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcEngineType.setPredefinedType((IfcEngineTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcEngineType ifcEngineType = new IfcEngineType();
		if(this.GlobalId != null)
			ifcEngineType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcEngineType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcEngineType.setName(this.Name);
		if(this.Description != null)
			ifcEngineType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcEngineType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcEngineType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcEngineType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcEngineType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcEngineType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcEngineType.setPredefinedType(this.PredefinedType);
		return ifcEngineType;
	}
