...
/**
 * This is a default implementation of the entity IfcDamper<br><br>
 *<br><br>
 ...
 */
public class IfcDamper extends IfcFlowController implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcDamperTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcDamper object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcDamperTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcDamper object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcDamperTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcDamperTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcDamperTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcDamper.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCDAMPER(");
	...
	**/
	public Object clone()
	{
		IfcDamper ifcDamper = new IfcDamper();
		if(this.GlobalId != null)
			ifcDamper.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcDamper.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcDamper.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcDamper.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcDamper.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcDamper.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcDamper.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcDamper.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcDamper.setPredefinedType((IfcDamperTypeEnum)this.PredefinedType.clone());
		return ifcDamper;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcDamper ifcDamper = new IfcDamper();
		if(this.GlobalId != null)
			ifcDamper.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcDamper.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcDamper.setName(this.Name);
		if(this.Description != null)
			ifcDamper.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcDamper.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcDamper.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcDamper.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcDamper.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcDamper.setPredefinedType(this.PredefinedType);
		return ifcDamper;
	}
