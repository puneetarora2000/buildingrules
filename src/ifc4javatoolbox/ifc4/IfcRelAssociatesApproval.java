...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","SET<IfcDefinitionSelect>","IfcApproval"};
	...
	**/
	public IfcRelAssociatesApproval(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, SET<IfcDefinitionSelect> RelatedObjects, IfcApproval RelatingApproval)
	{
	...
	* @param RelatingApproval DEMANDED parameter of type IfcApproval - may not be null.
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, SET<IfcDefinitionSelect> RelatedObjects, IfcApproval RelatingApproval)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	...
	private void resolveInverses()
	{
		...
		{
				if(RelatingApproval.ApprovedObjects_Inverse == null)
				{
					RelatingApproval.ApprovedObjects_Inverse = new SET<IfcRelAssociatesApproval>();
				}
				RelatingApproval.ApprovedObjects_Inverse.add(this);
		}
	}
	...
	* @return the value of RelatingApproval
	...
	private void synchronizeInversesRemoveRelatingApproval(IfcApproval RelatingApproval)
	{
		if(RelatingApproval != null)
		{
				if(RelatingApproval.ApprovedObjects_Inverse != null)
				{
					RelatingApproval.ApprovedObjects_Inverse.remove(this);
				}
		}
	}
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.RelatedObjects != null)
			ifcRelAssociatesApproval.setRelatedObjects((SET<IfcDefinitionSelect>)this.RelatedObjects.clone());
