...
/**
 * This is a default implementation of the entity IfcLamp<br><br>
 *<br><br>
 ...
 */
public class IfcLamp extends IfcFlowTerminal implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcLampTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcLamp object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcLampTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcLamp object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcLampTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcLampTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcLampTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcLamp.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCLAMP(");
	...
	**/
	public Object clone()
	{
		IfcLamp ifcLamp = new IfcLamp();
		if(this.GlobalId != null)
			ifcLamp.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcLamp.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcLamp.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcLamp.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcLamp.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcLamp.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcLamp.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcLamp.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcLamp.setPredefinedType((IfcLampTypeEnum)this.PredefinedType.clone());
		return ifcLamp;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcLamp ifcLamp = new IfcLamp();
		if(this.GlobalId != null)
			ifcLamp.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcLamp.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcLamp.setName(this.Name);
		if(this.Description != null)
			ifcLamp.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcLamp.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcLamp.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcLamp.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcLamp.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcLamp.setPredefinedType(this.PredefinedType);
		return ifcLamp;
	}
