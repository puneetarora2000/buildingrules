...
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcAnalysisModelTypeEnum","IfcAxis2Placement3D","SET<IfcStructuralLoadGroup>","SET<IfcStructuralResultGroup>","IfcObjectPlacement"};
	...
	/** SharedPlacement is an OPTIONAL attribute**/
	...
	* @param SharedPlacement OPTIONAL parameter of type IfcObjectPlacement
	**/
	public IfcStructuralAnalysisModel(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcAnalysisModelTypeEnum PredefinedType, IfcAxis2Placement3D OrientationOf2DPlane, SET<IfcStructuralLoadGroup> LoadedBy, SET<IfcStructuralResultGroup> HasResults, IfcObjectPlacement SharedPlacement)
	{
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.SharedPlacement = (IfcObjectPlacement) parameters.get(9);
		resolveInverses();
	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		if(getRedefinedDerivedAttributeTypes().contains("SharedPlacement")) stepString = stepString.concat("*);");
		else{
		if(this.SharedPlacement != null)		stepString = stepString.concat(((RootInterface)this.SharedPlacement).getStepParameter(IfcObjectPlacement.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	/**
	* This method sets the SharedPlacement attribute to the given value.
	*
	* @param SharedPlacement DEMANDED value to set - may not be null
	**/
	...
	/**
	* This method returns the value of the SharedPlacement attribute.
	*
	* @return the value of SharedPlacement
	/**/
	...
	**/
	...
	public Object clone()
	{
		...
		if(this.SharedPlacement != null)
			ifcStructuralAnalysisModel.setSharedPlacement((IfcObjectPlacement)this.SharedPlacement.clone());
	...
	**/
	public Object shallowCopy()
	{
		...
		if(this.SharedPlacement != null)
			ifcStructuralAnalysisModel.setSharedPlacement(this.SharedPlacement);
		return ifcStructuralAnalysisModel;
	}
