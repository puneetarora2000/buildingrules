...
/**
 * This is a default implementation of the entity IfcRampType<br><br>
 *<br><br>
 ...
 */
public class IfcRampType extends IfcBuildingElementType implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcIdentifier","SET<IfcPropertySetDefinition>","LIST<IfcRepresentationMap>","IfcLabel","IfcLabel","IfcRampTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcRampType object using the given parameters.
	*
	...
	* @param PredefinedType DEMANDED parameter of type IfcRampTypeEnum - may not be null.
	**/
	public IfcRampType(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcIdentifier ApplicableOccurrence, SET<IfcPropertySetDefinition> HasPropertySets, LIST<IfcRepresentationMap> RepresentationMaps, IfcLabel Tag, IfcLabel ElementType, IfcRampTypeEnum PredefinedType)
	{
	...
	/**
	 * This method initializes the IfcRampType object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	**/
	...
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcRampTypeEnum) parameters.get(9);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcRampType.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCRAMPTYPE(");
		...
		if(this.PredefinedType != null)		stepString = stepString.concat(((RootInterface)this.PredefinedType).getStepParameter(IfcRampTypeEnum.class.isInterface())+");");
		else		stepString = stepString.concat("$);");
		}
		return stepString;
	}
	...
	**/
	...
	public Object clone()
	{
		IfcRampType ifcRampType = new IfcRampType();
		if(this.GlobalId != null)
			ifcRampType.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcRampType.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcRampType.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcRampType.setDescription((IfcText)this.Description.clone());
		if(this.ApplicableOccurrence != null)
			ifcRampType.setApplicableOccurrence((IfcIdentifier)this.ApplicableOccurrence.clone());
		if(this.HasPropertySets != null)
			ifcRampType.setHasPropertySets((SET<IfcPropertySetDefinition>)this.HasPropertySets.clone());
		if(this.RepresentationMaps != null)
			ifcRampType.setRepresentationMaps((LIST<IfcRepresentationMap>)this.RepresentationMaps.clone());
		if(this.Tag != null)
			ifcRampType.setTag((IfcLabel)this.Tag.clone());
		if(this.ElementType != null)
			ifcRampType.setElementType((IfcLabel)this.ElementType.clone());
		if(this.PredefinedType != null)
			ifcRampType.setPredefinedType((IfcRampTypeEnum)this.PredefinedType.clone());
		return ifcRampType;
	}
	...
	**/
	public Object shallowCopy()
	{
		IfcRampType ifcRampType = new IfcRampType();
		if(this.GlobalId != null)
			ifcRampType.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcRampType.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcRampType.setName(this.Name);
		if(this.Description != null)
			ifcRampType.setDescription(this.Description);
		if(this.ApplicableOccurrence != null)
			ifcRampType.setApplicableOccurrence(this.ApplicableOccurrence);
		if(this.HasPropertySets != null)
			ifcRampType.setHasPropertySets(this.HasPropertySets);
		if(this.RepresentationMaps != null)
			ifcRampType.setRepresentationMaps(this.RepresentationMaps);
		if(this.Tag != null)
			ifcRampType.setTag(this.Tag);
		if(this.ElementType != null)
			ifcRampType.setElementType(this.ElementType);
		if(this.PredefinedType != null)
			ifcRampType.setPredefinedType(this.PredefinedType);
		return ifcRampType;
	}
