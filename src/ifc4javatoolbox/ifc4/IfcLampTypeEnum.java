 ...
 * Constructs a new IfcLampTypeEnum enumeration object using the given parameter.
	...
	* The String must be one of: "COMPACTFLUORESCENT", "FLUORESCENT", "HALOGEN", "HIGHPRESSUREMERCURY", "HIGHPRESSURESODIUM", "LED", "METALHALIDE", "OLED", "TUNGSTENFILAMENT", "USERDEFINED", "NOTDEFINED".
	*
	* @param value the value to set
	*/
