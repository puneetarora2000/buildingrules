...
/**
 * This is a default implementation of the entity IfcPipeFitting<br><br>
 *<br><br>
 ...
 */
public class IfcPipeFitting extends IfcFlowFitting implements ClassInterface
{
	private static final String[] nonInverseAttributes = new String[]{"IfcGloballyUniqueId","IfcOwnerHistory","IfcLabel","IfcText","IfcLabel","IfcObjectPlacement","IfcProductRepresentation","IfcIdentifier","IfcPipeFittingTypeEnum"};
	...
	**/
	...
	/**
	* Constructs a new IfcPipeFitting object using the given parameters.
	*
	...
	* @param PredefinedType OPTIONAL parameter of type IfcPipeFittingTypeEnum
	**/
	...
	/**
	 * This method initializes the IfcPipeFitting object using the given parameters.
	*
	* @param GlobalId DEMANDED parameter of type IfcGloballyUniqueId - may not be null.
	* @param OwnerHistory OPTIONAL parameter of type IfcOwnerHistory
	* @param Name OPTIONAL parameter of type IfcLabel
	...
	* @param PredefinedType OPTIONAL parameter of type IfcPipeFittingTypeEnum
	**/
	public void setParameters(IfcGloballyUniqueId GlobalId, IfcOwnerHistory OwnerHistory, IfcLabel Name, IfcText Description, IfcLabel ObjectType, IfcObjectPlacement ObjectPlacement, IfcProductRepresentation Representation, IfcIdentifier Tag, IfcPipeFittingTypeEnum PredefinedType)
	{
		this.GlobalId = GlobalId;
		this.OwnerHistory = OwnerHistory;
		this.Name = Name;
	...
	**/
	void initialize(java.util.ArrayList<CloneableObject> parameters)
	{
		...
		this.PredefinedType = (IfcPipeFittingTypeEnum) parameters.get(8);
		resolveInverses();
	}
	...
	**/
	...
	{
		return IfcPipeFitting.nonInverseAttributes;	}
 ...
 * This method returns the object IFC  STEP representation. This method is called by the IfcModel object to write IFC STEP files.
	...
	**/
	public String getStepLine()
	{
		...
		stepString = stepString.concat("IFCPIPEFITTING(");
	...
	**/
	public Object clone()
	{
		IfcPipeFitting ifcPipeFitting = new IfcPipeFitting();
		if(this.GlobalId != null)
			ifcPipeFitting.setGlobalId((IfcGloballyUniqueId)this.GlobalId.clone());
		if(this.OwnerHistory != null)
			ifcPipeFitting.setOwnerHistory((IfcOwnerHistory)this.OwnerHistory.clone());
		if(this.Name != null)
			ifcPipeFitting.setName((IfcLabel)this.Name.clone());
		if(this.Description != null)
			ifcPipeFitting.setDescription((IfcText)this.Description.clone());
		if(this.ObjectType != null)
			ifcPipeFitting.setObjectType((IfcLabel)this.ObjectType.clone());
		if(this.ObjectPlacement != null)
			ifcPipeFitting.setObjectPlacement((IfcObjectPlacement)this.ObjectPlacement.clone());
		if(this.Representation != null)
			ifcPipeFitting.setRepresentation((IfcProductRepresentation)this.Representation.clone());
		if(this.Tag != null)
			ifcPipeFitting.setTag((IfcIdentifier)this.Tag.clone());
		if(this.PredefinedType != null)
			ifcPipeFitting.setPredefinedType((IfcPipeFittingTypeEnum)this.PredefinedType.clone());
	...
	**/
	public Object shallowCopy()
	{
		IfcPipeFitting ifcPipeFitting = new IfcPipeFitting();
		if(this.GlobalId != null)
			ifcPipeFitting.setGlobalId(this.GlobalId);
		if(this.OwnerHistory != null)
			ifcPipeFitting.setOwnerHistory(this.OwnerHistory);
		if(this.Name != null)
			ifcPipeFitting.setName(this.Name);
		if(this.Description != null)
			ifcPipeFitting.setDescription(this.Description);
		if(this.ObjectType != null)
			ifcPipeFitting.setObjectType(this.ObjectType);
		if(this.ObjectPlacement != null)
			ifcPipeFitting.setObjectPlacement(this.ObjectPlacement);
		if(this.Representation != null)
			ifcPipeFitting.setRepresentation(this.Representation);
		if(this.Tag != null)
			ifcPipeFitting.setTag(this.Tag);
		if(this.PredefinedType != null)
			ifcPipeFitting.setPredefinedType(this.PredefinedType);
		return ifcPipeFitting;
	}
