...
import ifc4javatoolbox.ifc4.IfcChangeActionEnum.IfcChangeActionEnum_internal;
...
import ifc4javatoolbox.ifc4.IfcRepresentationContext;
import ifc4javatoolbox.ifc4.IfcRoot;
import ifc4javatoolbox.ifc4.IfcSIUnit;
import ifc4javatoolbox.ifc4.IfcSIUnitName;
import ifc4javatoolbox.ifc4.IfcSIUnitName.IfcSIUnitName_internal;
...
import ifc4javatoolbox.ifc4.IfcUnitEnum.IfcUnitEnum_internal;
...
public class IfcModel
{
	...
	private void writeStepFileHeader(OutputStream outputStream, String filePath) throws IOException
	{
		...
		file_Name.setpreprocessorVersion(new STRING("IFC Tools Project - IFC4 Java Toolbox", true)); //name of the toolbox used to create the IFC file 
		if(file_Name.getoriginatingSystem() == null)
		{
			file_Name.setoriginatingSystem(new STRING("IFC4 Java Toolbox 2.0", true)); //name of the application (including built number)
		}
